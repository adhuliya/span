...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("  -i, --initial       do not convert tabs after non blanks\n  -t, --tabs=NUMBER   have tabs NUMBER characters apart, not 8\n"),stdout);



      fputs_unlocked (gettext ("  -t, --tabs=LIST     use comma separated list of explicit tab positions\n"),stdout);
          ...
          if (convert)
            {
              ...
              convert &= convert_entire_line || !! ((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISblank);
            }
  ...
  while ((c = getopt_long (argc, argv, shortopts, longopts, ((void*)0))) != -1)
    {
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "expand", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
