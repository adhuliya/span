...
{
  {"all", 0, ((void*)0), 'a'},
  {"kernel-name", 0, ((void*)0), 's'},
  {"sysname", 0, ((void*)0), 's'},
  {"nodename", 0, ((void*)0), 'n'},
  {"kernel-release", 0, ((void*)0), 'r'},
  {"release", 0, ((void*)0), 'r'},
  {"kernel-version", 0, ((void*)0), 'v'},
  {"machine", 0, ((void*)0), 'm'},
  {"processor", 0, ((void*)0), 'p'},
  {"hardware-platform", 0, ((void*)0), 'i'},
  {"operating-system", 0, ((void*)0), 'o'},
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      if (uname_mode == 1)
        {
          fputs_unlocked (gettext ("Print certain system information.  With no OPTION, same as -s.\n\n  -a, --all                print all information, in the following order,\n                             except omit -p and -i if unknown:\n  -s, --kernel-name        print the kernel name\n  -n, --nodename           print the network node hostname\n  -r, --kernel-release     print the kernel release\n"),stdout);
# 133 "uname.c"
          fputs_unlocked (gettext ("  -v, --kernel-version     print the kernel version\n  -m, --machine            print the machine hardware name\n  -p, --processor          print the processor type or \"unknown\"\n  -i, --hardware-platform  print the hardware platform or \"unknown\"\n  -o, --operating-system   print the operating system\n"),stdout);
      ...
      emit_ancillary_info ((uname_mode == 1 ? "uname" : "arch"));
    }
  exit (status);
}
  ...
  if (uname_mode == 2)
    {
      while ((c = getopt_long (argc, argv, "",
                               arch_long_options, ((void*)0))) != -1)
        {
          switch (c)
            {
            case GETOPT_HELP_CHAR: usage (0); break;;

            case GETOPT_VERSION_CHAR: version_etc (stdout, (uname_mode == 1 ? "uname" : "arch"), "GNU coreutils", Version, "David MacKenzie", "Karel Zak", (char *) ((void*)0)); exit (0); break;;
  ...
  else
    {
      while ((c = getopt_long (argc, argv, "asnrvmpio",
                               uname_long_options, ((void*)0))) != -1)
        {
          switch (c)
            {
            case 'a':
              toprint = (2147483647 *2U +1U);
              break;
            ...
            case GETOPT_VERSION_CHAR: version_etc (stdout, (uname_mode == 1 ? "uname" : "arch"), "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
...
# 340 "uname.c"
      if (! (toprint == (2147483647 *2U +1U) && element == unknown))
