...
list_entries_users (size_t n, const STRUCT_UTMP *this)
{
  ...
  while (n--)
    {
      if ((((this)->ut_user)[0] && (((this)->ut_type == (7)) || (0 && ((this)->ut_tv.tv_sec) != 0))))
        {
          char *trimmed_name;
...
main (int argc, char **argv)
{
  ...
  parse_long_options (argc, argv, "users", "GNU coreutils", Version,
                      usage, ("Joseph Arceneaux"), ("David MacKenzie"), (char const *) ((void*)0));
  ...
  switch (argc - optind)
    {
    case 0:
      users ("/var/run/utmp", READ_UTMP_CHECK_PIDS);
      break;
