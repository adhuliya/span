...
main (int argc, char **argv)
{
  ...
  parse_long_options (argc, argv, "getlimits", "GNU coreutils", "8.24",
                      usage, proper_name_utf8 ("Padraig Brady", "P\303\241draig Brady"), (char const *) ((void*)0));
# 148 "getlimits.c"
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 127); printf ("CHAR""_MAX=%s\n", limit + 1); printf ("CHAR""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-127 -1)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-127 -1)); printf ("CHAR""_MIN=%s\n", limit + 1); printf ("CHAR""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 127); printf ("SCHAR""_MAX=%s\n", limit + 1); printf ("SCHAR""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-127 -1)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-127 -1)); printf ("SCHAR""_MIN=%s\n", limit + 1); printf ("SCHAR""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (127*2 +1)); printf ("UCHAR""_MAX=%s\n", limit + 1); printf ("UCHAR""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("UCHAR""_MIN=%s\n", limit + 1); printf ("UCHAR""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 32767); printf ("SHRT""_MAX=%s\n", limit + 1); printf ("SHRT""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-32767 -1)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-32767 -1)); printf ("SHRT""_MIN=%s\n", limit + 1); printf ("SHRT""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 2147483647); printf ("INT""_MAX=%s\n", limit + 1); printf ("INT""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-2147483647 -1)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-2147483647 -1)); printf ("INT""_MIN=%s\n", limit + 1); printf ("INT""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (2147483647 *2U +1U)); printf ("UINT""_MAX=%s\n", limit + 1); printf ("UINT""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("UINT""_MIN=%s\n", limit + 1); printf ("UINT""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 9223372036854775807L); printf ("LONG""_MAX=%s\n", limit + 1); printf ("LONG""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-9223372036854775807L -1L)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-9223372036854775807L -1L)); printf ("LONG""_MIN=%s\n", limit + 1); printf ("LONG""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (9223372036854775807L *2UL+1UL)); printf ("ULONG""_MAX=%s\n", limit + 1); printf ("ULONG""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("ULONG""_MIN=%s\n", limit + 1); printf ("ULONG""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (18446744073709551615UL)); printf ("SIZE""_MAX=%s\n", limit + 1); printf ("SIZE""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("SIZE""_MIN=%s\n", limit + 1); printf ("SIZE""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) 9223372036854775807L); printf ("SSIZE""_MAX=%s\n", limit + 1); printf ("SSIZE""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (((ssize_t) (! (! ((ssize_t) 0 < (ssize_t) -1)) ? (ssize_t) 0 : ((ssize_t) ~ (ssize_t) 0 < (ssize_t) -1) ? ~ (ssize_t) 0 : ~ ((ssize_t) (! (! ((ssize_t) 0 < (ssize_t) -1)) ? (ssize_t) -1 : ((((ssize_t) 1 << (sizeof (ssize_t) * 8 - 2)) - 1) * 2 + 1)))))) { sprintf (limit + 1, "%""l" "d", (intmax_t) ((ssize_t) (! (! ((ssize_t) 0 < (ssize_t) -1)) ? (ssize_t) 0 : ((ssize_t) ~ (ssize_t) 0 < (ssize_t) -1) ? ~ (ssize_t) 0 : ~ ((ssize_t) (! (! ((ssize_t) 0 < (ssize_t) -1)) ? (ssize_t) -1 : ((((ssize_t) 1 << (sizeof (ssize_t) * 8 - 2)) - 1) * 2 + 1)))))); printf ("SSIZE""_MIN=%s\n", limit + 1); printf ("SSIZE""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1)))); printf ("TIME_T""_MAX=%s\n", limit + 1); printf ("TIME_T""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) 0 : ((time_t) ~ (time_t) 0 < (time_t) -1) ? ~ (time_t) 0 : ~ ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1)))))) { sprintf (limit + 1, "%""l" "d", (intmax_t) ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) 0 : ((time_t) ~ (time_t) 0 < (time_t) -1) ? ~ (time_t) 0 : ~ ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1)))))); printf ("TIME_T""_MIN=%s\n", limit + 1); printf ("TIME_T""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) ((uid_t) (! (! ((uid_t) 0 < (uid_t) -1)) ? (uid_t) -1 : ((((uid_t) 1 << (sizeof (uid_t) * 8 - 2)) - 1) * 2 + 1)))); printf ("UID_T""_MAX=%s\n", limit + 1); printf ("UID_T""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("UID_T""_MIN=%s\n", limit + 1); printf ("UID_T""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) ((gid_t) (! (! ((gid_t) 0 < (gid_t) -1)) ? (gid_t) -1 : ((((gid_t) 1 << (sizeof (gid_t) * 8 - 2)) - 1) * 2 + 1)))); printf ("GID_T""_MAX=%s\n", limit + 1); printf ("GID_T""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("GID_T""_MIN=%s\n", limit + 1); printf ("GID_T""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) ((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) -1 : ((((pid_t) 1 << (sizeof (pid_t) * 8 - 2)) - 1) * 2 + 1)))); printf ("PID_T""_MAX=%s\n", limit + 1); printf ("PID_T""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) 0 : ((pid_t) ~ (pid_t) 0 < (pid_t) -1) ? ~ (pid_t) 0 : ~ ((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) -1 : ((((pid_t) 1 << (sizeof (pid_t) * 8 - 2)) - 1) * 2 + 1)))))) { sprintf (limit + 1, "%""l" "d", (intmax_t) ((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) 0 : ((pid_t) ~ (pid_t) 0 < (pid_t) -1) ? ~ (pid_t) 0 : ~ ((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) -1 : ((((pid_t) 1 << (sizeof (pid_t) * 8 - 2)) - 1) * 2 + 1)))))); printf ("PID_T""_MIN=%s\n", limit + 1); printf ("PID_T""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << (sizeof (off_t) * 8 - 2)) - 1) * 2 + 1)))); printf ("OFF_T""_MAX=%s\n", limit + 1); printf ("OFF_T""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) 0 : ((off_t) ~ (off_t) 0 < (off_t) -1) ? ~ (off_t) 0 : ~ ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << (sizeof (off_t) * 8 - 2)) - 1) * 2 + 1)))))) { sprintf (limit + 1, "%""l" "d", (intmax_t) ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) 0 : ((off_t) ~ (off_t) 0 < (off_t) -1) ? ~ (off_t) 0 : ~ ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << (sizeof (off_t) * 8 - 2)) - 1) * 2 + 1)))))); printf ("OFF_T""_MIN=%s\n", limit + 1); printf ("OFF_T""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (9223372036854775807L)); printf ("INTMAX""_MAX=%s\n", limit + 1); printf ("INTMAX""_OFLOW=%s\n", decimal_absval_add_one (limit)); if ((-9223372036854775807L -1)) { sprintf (limit + 1, "%""l" "d", (intmax_t) (-9223372036854775807L -1)); printf ("INTMAX""_MIN=%s\n", limit + 1); printf ("INTMAX""_UFLOW=%s\n", decimal_absval_add_one (limit)); };
  sprintf (limit + 1, "%""l" "u", (uintmax_t) (18446744073709551615UL)); printf ("UINTMAX""_MAX=%s\n", limit + 1); printf ("UINTMAX""_OFLOW=%s\n", decimal_absval_add_one (limit)); if (0) { sprintf (limit + 1, "%""l" "d", (intmax_t) 0); printf ("UINTMAX""_MIN=%s\n", limit + 1); printf ("UINTMAX""_UFLOW=%s\n", decimal_absval_add_one (limit)); };


  printf ("FLT""_MIN="); print_FLT (1.17549435e-38F); printf ("FLT""_MAX="); print_FLT (3.40282347e+38F);;
  printf ("DBL""_MIN="); print_DBL (2.2250738585072014e-308); printf ("DBL""_MAX="); print_DBL (1.7976931348623157e+308);;
  printf ("LDBL""_MIN="); print_LDBL (3.36210314311209350626e-4932L); printf ("LDBL""_MAX="); print_LDBL (1.18973149535723176502e+4932L);;
