...
extern int _gl_cxxalias_dummy;
# 1512 "../lib/stdio.h" 3
extern int rpl_vfprintf (FILE *fp, const char *format, va_list args) __attribute__ ((__format__ (__printf__, 2, 0))) __attribute__ ((__nonnull__ (1, 2)));
...
extern int _gl_cxxalias_dummy;
# 1567 "../lib/stdio.h" 3
extern int rpl_vprintf (const char *format, va_list args) __attribute__ ((__format__ (__printf__, 1, 0))) __attribute__ ((__nonnull__ (1)));
...
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/limits.h" 1 3 4
# 21 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/limits.h" 3 4
...
# 22 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/limits.h" 2 3 4
...
extern int (*_gl_verify_function2 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (unsigned_long_long_int) * 8 / 3 <= 99) ? 1 : -1; }))];
...
extern int (*_gl_verify_function3 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (unsigned_long_long_int) < (sizeof (bytes_to_hex_digits) / sizeof *(bytes_to_hex_digits))) ? 1 : -1; }))];


extern int (*_gl_verify_function4 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof bytes_to_oct_digits == sizeof bytes_to_signed_dec_digits) ? 1 : -1; }))];
extern int (*_gl_verify_function5 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof bytes_to_oct_digits == sizeof bytes_to_unsigned_dec_digits) ? 1 : -1; }))];
extern int (*_gl_verify_function6 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof bytes_to_oct_digits == sizeof bytes_to_hex_digits) ? 1 : -1; }))];
...
extern int (*_gl_verify_function7 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: ((sizeof (width_bytes) / sizeof *(width_bytes)) == N_SIZE_SPECS) ? 1 : -1; }))];
                   ...
                   struct tspec *tspec)
{
  ...
  ((void) sizeof ((tspec != ((void*)0)) ? 1 : 0), __extension__ ({ if (tspec != ((void*)0)) ; else __assert_fail ("tspec != NULL", "od.c", 645, __extension__ __PRETTY_FUNCTION__); }));
  ...
  switch (*s)
    ...
    case 'x':
      ...
      ((void) sizeof ((strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED) ? 1 : 0), __extension__ ({ if (strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED) ; else __assert_fail ("strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED", "od.c", 744, __extension__ __PRETTY_FUNCTION__); }));
  ...
  do
    {
      ...
      if ((strcmp (input_filename, "-") == 0))
      ...
      else
        {
          ...
          if (in_stream == ((void*)0))
            {
              error (0, (*__errno_location ()), "%s", input_filename);
              ok = 0;
            }
        }
    }
  ...
  if (in_stream != ((void*)0))
    {
      if (ferror_unlocked (in_stream))
        {
          error (0, in_errno, gettext ("%s: read error"), input_filename);
...
{
  const char *s_orig = s;
  ((void) sizeof ((s != ((void*)0)) ? 1 : 0), __extension__ ({ if (s != ((void*)0)) ; else __assert_fail ("s != NULL", "od.c", 984, __extension__ __PRETTY_FUNCTION__); }));
  ...
  while (*s != '\0')
    {
      ...
      if (n_specs_allocated <= n_specs)
        spec = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(spec) != 1) ? 1 : -1; })), x2nrealloc (spec, &n_specs_allocated, sizeof *(spec)));

      if (! decode_one_format (s_orig, s, &next, &spec[n_specs]))
        return 0;

      ((void) sizeof ((s != next) ? 1 : 0), __extension__ ({ if (s != next) ; else __assert_fail ("s != next", "od.c", 996, __extension__ __PRETTY_FUNCTION__); }));
      s = next;
      ++n_specs;
    }
...
# 1034 "od.c"
      if (fstat (fileno (in_stream), &file_stats) == 0)
        {
          ...
          if (usable_st_size (&file_stats)
              && ((0 < (file_stats).st_blksize && (file_stats).st_blksize <= ((size_t)-1) / 8 + 1) ? (file_stats).st_blksize : 512) < file_stats.st_size)
            {
  ...
  if (n_skip != 0)
    error (1, 0, gettext ("cannot skip past end of combined input"));
...
read_block (size_t n, char *block, size_t *n_bytes_in_buffer)
{
  ...
  ((void) sizeof ((0 < n && n <= bytes_per_block) ? 1 : 0), __extension__ ({ if (0 < n && n <= bytes_per_block) ; else __assert_fail ("0 < n && n <= bytes_per_block", "od.c", 1290, __extension__ __PRETTY_FUNCTION__); }));
      ...
      while (1)
        {
          ...
          if (n_bytes_read < bytes_per_block)
            break;
          ((void) sizeof ((n_bytes_read == bytes_per_block) ? 1 : 0), __extension__ ({ if (n_bytes_read == bytes_per_block) ; else __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1401, __extension__ __PRETTY_FUNCTION__); }));
      ...
      while (1)
        {
          ...
          if (n_bytes_read < bytes_per_block)
            break;
          ((void) sizeof ((n_bytes_read == bytes_per_block) ? 1 : 0), __extension__ ({ if (n_bytes_read == bytes_per_block) ; else __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1415, __extension__ __PRETTY_FUNCTION__); }));
          write_block (current_offset, n_bytes_read,
                       block[!idx], block[idx]);
          current_offset += n_bytes_read;
          idx = !idx;
      ...
      while (!limit_bytes_to_format || address < end_offset)
        {
          if (i == bufsize)
            {
              buf = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(buf) == 1) ? 1 : -1; })), x2realloc (buf, &bufsize));
            }
          ok &= read_char (&c);
          address++;
          if (c < 0)
      ...
      switch (c)
        ...
        case 'A':
          ...
          switch (optarg[0])
            ...
            default:
              error (1, 0,
                     gettext ("invalid output address radix '%c'; it must be one character from [doxn]"),
          ...
          if (optarg == ((void*)0))
          ...
          else
            {
              ...
              if ((18446744073709551615UL) < tmp)
                error (1, 0, gettext ("%s is too large"), optarg);
        ...
        case ENDIAN_OPTION:
          switch (((endian_types) [__xargmatch_internal ("--endian", optarg, endian_args, (char const *) (endian_types), sizeof *(endian_types), argmatch_die)]))
            {
              case endian_big:
                  input_swap = ! 0;
                  break;
...
# 1740 "od.c"
  ...
  if (flag_dump_strings && n_specs > 0)
    error (1, 0,
           gettext ("no type may be specified when dumping strings"));
  ...
  if (limit_bytes_to_format)
    {
      ...
      if (end_offset < n_bytes_to_skip)
        error (1, 0, gettext ("skip-bytes + read-bytes is too large"));
    }
