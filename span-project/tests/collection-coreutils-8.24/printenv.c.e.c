...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (gettext ("Usage: %s [OPTION]... [VARIABLE]...\nPrint the values of the specified environment VARIABLE(s).\nIf no VARIABLE is specified, print name and value pairs for them all.\n\n"),
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, "+iu:0", longopts, ((void*)0))) != -1)
    {
      switch (optc)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "printenv", "GNU coreutils", Version, ("David MacKenzie"), ("Richard Mlynarik"), (char *) ((void*)0)); exit (0); break;;
        default:
  ...
  if (optind >= argc)
    {
      for (env = environ; *env != ((void*)0); ++env)
