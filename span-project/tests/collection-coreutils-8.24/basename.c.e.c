...
static void
perform_basename (const char *string, const char *suffix, _Bool use_nuls)
{
...
main (int argc, char **argv)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "basename", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
  ...
  if (multiple_names)
    ...
    perform_basename (argv[optind],
                      optind + 2 == argc ? argv[optind + 1] : ((void*)0), use_nuls);
