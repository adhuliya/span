  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "dirname", "GNU coreutils", Version, ("David MacKenzie"), ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;
  ...
  for (; optind < argc; optind++)
    {
      ...
      fwrite_unlocked (result,1,len,stdout);
