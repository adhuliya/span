...
{
  {"all", 0, ((void*)0), ALL_OPTION},
  {"ignore", 1, ((void*)0), IGNORE_OPTION},
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("Print the number of processing units available to the current process,\nwhich may be less than the number of online processors\n\n"),stdout);




      fputs_unlocked (gettext ("     --all       print the number of installed processors\n     --ignore=N  if possible, exclude N processing units\n"),stdout);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "nproc", "GNU coreutils", Version, ("Giuseppe Scrivano"), (char *) ((void*)0)); exit (0); break;;
        ...
        case IGNORE_OPTION:
          ignore = xdectoumax (optarg, 0, (9223372036854775807L *2UL+1UL), "", gettext ("invalid number"),0);
          break;
