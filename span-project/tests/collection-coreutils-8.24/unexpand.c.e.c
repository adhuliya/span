...
enum
{
  CONVERT_FIRST_ONLY_OPTION = 127 + 1
};
...
static struct option const longopts[] =
{
  {"tabs", 1, ((void*)0), 't'},
  {"all", 0, ((void*)0), 'a'},
  {"first-only", 0, ((void*)0), CONVERT_FIRST_ONLY_OPTION},
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("  -a, --all        convert all blanks, instead of just initial blanks\n      --first-only  convert only leading sequences of blanks (overrides -a)\n  -t, --tabs=N     have tabs N characters apart instead of 8 (enables -a)\n  -t, --tabs=LIST  use comma separated LIST of tab positions (enables -a)\n"),stdout);
...
add_tab_stop (uintmax_t tabval)
{
  ...
  if (first_free_tab == n_tabs_allocated)
    tab_list = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(tab_list) != 1) ? 1 : -1; })), x2nrealloc (tab_list, &n_tabs_allocated, sizeof *(tab_list)));
  tab_list[first_free_tab++] = tabval;

  if (max_column_width < column_width)
    {
      if ((18446744073709551615UL) < column_width)
        error (1, 0, gettext ("tabs are too far apart"));
  ...
  for (; *stops; stops++)
    {
      if (*stops == ',' || ((*__ctype_b_loc ())[(int) ((to_uchar (*stops)))] & (unsigned short int) _ISblank))
      ...
      else if (((unsigned int) (*stops) - '0' <= 9))
        {
          ...
          if (!( (void) (&(tabval) == (uintmax_t *) ((void*)0)), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (! (! ((uintmax_t) 0 < (uintmax_t) -1))) ? 1 : -1; })), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (tabval) == sizeof (uintmax_t)) ? 1 : -1; })), (((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (*stops - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (*stops - '0')), 1)) ))
            {
  ...
  if (fp)
    {
      if (ferror_unlocked (fp))
        {
          error (0, (*__errno_location ()), "%s", prev_file);
          exit_status = 1;
        }
  ...
  while (1)
    {
      ...
      _Bool one_blank_before_tab_stop = 0;
      ...
      do
        {
          ...
          if (convert)
            {
              _Bool blank = !! ((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISblank);
              ...
              if (pending)
                {
                  if (pending > 1 && one_blank_before_tab_stop)
                    pending_blank[0] = '\t';
                  if (fwrite_unlocked (pending_blank,1,pending,stdout) != pending)
...
main (int argc, char **argv)
{
  ...
  while ((c = getopt_long (argc, argv, ",0123456789at:", longopts, ((void*)0)))
         != -1)
    {
      switch (c)
        {
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "unexpand", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          if (!have_tabval)
            {
              tabval = 0;
          ...
          if (!( (void) (&(tabval) == (uintmax_t *) ((void*)0)), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (! (! ((uintmax_t) 0 < (uintmax_t) -1))) ? 1 : -1; })), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (tabval) == sizeof (uintmax_t)) ? 1 : -1; })), (((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (c - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (c - '0')), 1)) ))
