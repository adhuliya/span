      ...
      if (((unsigned int) (c) - '0' <= 9))
        {
          ...
          if (n_digits + 1 >= n_alloc)
            column_count_string
              = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(column_count_string) == 1) ? 1 : -1; })), x2realloc (column_count_string, &n_alloc));
...
init_header (char const *filename, int desc)
{
  ...
  if (tm == ((void*)0))
    {
      buf = xmalloc ((((((sizeof (long int) * 8 - (! ((__typeof__ (long int)) 0 < (__typeof__ (long int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (long int)) 0 < (__typeof__ (long int)) -1))) + 1)
                     + (((10)>((((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1)))?(10):((((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1))));
  ...
  if (buff_current >= buff_allocated)
    {
      ...
      buff = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(buff) == 1) ? 1 : -1; })), x2realloc (buff, &buff_allocated));
    }
  buff[buff_current++] = c;
}
