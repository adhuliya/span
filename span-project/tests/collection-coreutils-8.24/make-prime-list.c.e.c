...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "make-prime-list.c" 2
# 20 "make-prime-list.c"
# 1 "../lib/config.h" 1
# 21 "make-prime-list.c" 2
...
typedef int error_t;
# 29 "make-prime-list.c" 2
# 45 "make-prime-list.c"
...
static wide_uint __attribute__ ((__const__))
binvert (wide_uint a)
{
