...
# 46 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stddef.h" 3
...
extern int _gl_cxxalias_dummy;
# 33 "stat.c" 2
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stdalign.h" 1 3
# 34 "stat.c" 2
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
# 35 "stat.c" 2
...
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
# 25 "../lib/file-type.h" 2
# 1 "../lib/sys/stat.h" 1
# 26 "../lib/sys/stat.h" 3
# 26 "../lib/file-type.h" 2

char const *file_type (struct stat const *) __attribute__ ((__pure__));
# 64 "stat.c" 2
# 1 "../lib/filemode.h" 1
# 21 "../lib/filemode.h"
# 1 "../lib/sys/types.h" 1
...
size_t nstrftime (char *, size_t, char const *, struct tm const *,
                  int __utc, int __ns);
# 73 "stat.c" 2
# 1 "./find-mount-point.h" 1
# 17 "./find-mount-point.h"
extern char *find_mount_point (char const *, struct stat const *);
# 74 "stat.c" 2
# 1 "../lib/xvasprintf.h" 1
# 46 "../lib/xvasprintf.h"
...
static struct option const long_options[] =
{
  ...
  {"file-system", 0, ((void*)0), 'f'},
  {"format", 1, ((void*)0), 'c'},
  {"printf", 1, ((void*)0), PRINTF_OPTION},
  {"terse", 0, ((void*)0), 't'},
...
static char const * __attribute__ ((__warn_unused_result__))
...
static char * __attribute__ ((__warn_unused_result__))
...
{
  static char str[((((((((sizeof (intmax_t) * 8 - (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) + 1))>((((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1 + sizeof "-MM-DD HH:MM:SS.NNNNNNNNN +ZZZZ")))?((((((sizeof (intmax_t) * 8 - (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) + 1)):((((((sizeof (int) * 8 - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1 + sizeof "-MM-DD HH:MM:SS.NNNNNNNNN +ZZZZ")))];
...
out_epoch_sec (char *pformat, size_t prefix_len,
               struct stat const *statbuf __attribute__ ((__unused__)),
               struct timespec arg)
{
  ...
  if (dot)
    {
      ...
      if (((unsigned int) (dot[1]) - '0' <= 9))
        {
          long int lprec = strtol (dot + 1, ((void*)0), 10);
          precision = (lprec <= 2147483647 ? lprec : 2147483647);
        }
      else
        {
          precision = 9;
      ...
      if (precision && ((unsigned int) (dot[-1]) - '0' <= 9))
        {
          ...
          *dot = '\0';
          ...
          long int lwidth = strtol (p, ((void*)0), 10);
          width = (lwidth <= 2147483647 ? lwidth : 2147483647);
          if (1 < width)
            {
              p += (*p == '0');
...
static _Bool __attribute__ ((__warn_unused_result__))
out_file_context (char *pformat, size_t prefix_len, char const *filename)
{
  ...
  if ((follow_links
    ...
    {
      error (0, (*__errno_location ()), gettext ("failed to get security context of %s"),
             quote (filename));
      scontext = ((void*)0);
      fail = 1;
    }
    ...
    case 'i':
      {
        ...
        extern int (*_gl_verify_function2 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (_Alignof (struct statfs) % _Alignof (fsid_word) == 0) ? 1 : -1; }))];
        extern int (*_gl_verify_function3 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (__builtin_offsetof(struct statfs, f_fsid) % _Alignof (fsid_word) == 0) ? 1 : -1; }))];
        extern int (*_gl_verify_function4 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof statfsbuf->f_fsid % _Alignof (fsid_word) == 0) ? 1 : -1; }))];
...
{
  char const * bind_mount = ((void*)0);

  static struct mount_entry *mount_list;
  static _Bool tried_mount_list = 0;
  if (!tried_mount_list)
    {
      if (!(mount_list = read_file_system_list (0)))
                 ...
                 const struct stat *statp)
{
  ...
  char const *np = "?", *bp = ((void*)0);
  char *mp = ((void*)0);
  _Bool fail = 1;



  if (follow_links || !((((statp->st_mode)) & 0170000) == (0120000)))
    {
      char *resolved = canonicalize_file_name (filename);
      if (!resolved)
        {
          error (0, (*__errno_location ()), gettext ("failed to canonicalize %s"), quote (filename));
            ...
            int fd, char const *filename, void const *data)
{
  ...
  switch (m)
    ...
    case 'N':
      ...
      if (((((statbuf->st_mode)) & 0170000) == (0120000)))
        {
    ...
    case 'i':
      ...
      break;
    case 'a':
      out_uint_o (pformat, prefix_len, statbuf->st_mode & (04000 | 02000 | 01000 | (0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)));
      break;
    case 'A':
...
# 1042 "stat.c"
 gnu_dev_minor (statbuf->st_rdev));
    ...
    case 's':
      ...
      break;
    case 'B':
      out_uint (pformat, prefix_len, 512);
      break;
    case 'b':
      out_uint (pformat, prefix_len, ((*statbuf).st_blocks));
      break;
    case 'o':
      out_uint (pformat, prefix_len, ((0 < (*statbuf).st_blksize && (*statbuf).st_blksize <= ((size_t)-1) / 8 + 1) ? (*statbuf).st_blksize : 512));
      break;
    case 'w':
      {
...
print_it (char const *format, int fd, char const *filename,
          _Bool (*print_func) (char *, size_t, unsigned int,
  ...
  enum
    {
      MAX_ADDITIONAL_BYTES =
        ((((sizeof "l" "d")>((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))))?(sizeof "l" "d"):((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))))
  ...
  for (b = format; *b; b++)
    {
      switch (*b)
                ...
                if (0 < len)
                  {
                    dest[len + 1] = *fmt_char;
                    dest[len + 2] = '\0';
                    error (1, 0, gettext ("%s: invalid directive"),
                           quotearg_colon (dest));
                  }
                putchar_unlocked ('%');
                break;
        ...
        case '\\':
          ...
          else if (*b == 'x' && ((*__ctype_b_loc ())[(int) ((to_uchar (b[1])))] & (unsigned short int) _ISxdigit))
            {
              int esc_value = ((b[1]) >= 'a' && (b[1]) <= 'f' ? (b[1]) - 'a' + 10 : (b[1]) >= 'A' && (b[1]) <= 'F' ? (b[1]) - 'A' + 10 : (b[1]) - '0');


              ++b;
              if (((*__ctype_b_loc ())[(int) ((to_uchar (b[1])))] & (unsigned short int) _ISxdigit))
                {
                  ++b;
...
do_statfs (char const *filename, char const *format)
{
  ...
  if ((strcmp (filename, "-") == 0))
    {
      error (0, 0, gettext ("using %s to denote standard input does not work" " in file system mode"), quote (filename));
  ...
  if (statfs (filename, &statfsbuf) != 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot read file system information for %s"),
             quote (filename));
      return 0;
    }
  ...
  if (0 <= fd)
    {
      if (fstat (fd, &statbuf) != 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot stat standard input"));
          return 0;
        }
    }
    ...
    {
      error (0, (*__errno_location ()), gettext ("cannot stat %s"), quote (filename));
      return 0;
    }

  if (((((statbuf.st_mode)) & 0170000) == (0060000)) || ((((statbuf.st_mode)) & 0170000) == (0020000)))
    format = format2;

  _Bool fail = print_it (format, fd, filename, print_stat, &statbuf);
  return ! fail;
}
...
static char *
default_format (_Bool fs, _Bool terse, _Bool device)
{
  char *format;
  if (fs)
    {
          ...
          if (device)
            {
              ...
              format = xasprintf ("%s%s", format, gettext ("" "Device: %Dh/%dd\tInode: %-10i  Links: %-5h Device type: %t,%T\n"));
          ...
          else
            {
              ...
              format = xasprintf ("%s%s", format, gettext ("" "Device: %Dh/%dd\tInode: %-10i  Links: %h\n"));
...
# 1445 "stat.c"
      fputs_unlocked (gettext ("  %d   device number in decimal\n  %D   device number in hex\n  %f   raw mode in hex\n  %F   file type\n  %g   group ID of owner\n  %G   group name of owner\n"),stdout);
  ...
  while ((c = getopt_long (argc, argv, "c:fLt", long_options, ((void*)0))) != -1)
    {
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "stat", "GNU coreutils", Version, ("Michael Meskes"), (char *) ((void*)0)); exit (0); break;;
