      ...
      if ((strcmp (fnamptr[files_open], "-") == 0))
      ...
      else
        {
          ...
          if (fileptr[files_open] == ((void*)0))
            error (1, (*__errno_location ()), "%s", fnamptr[files_open]);
              ...
              if (fileptr[i])
                {
                  ...
                  if (fileptr[i] == stdin)
                    ...
                    {
                      error (0, (*__errno_location ()), "%s", fnamptr[i]);
                      ok = 0;
                    }
  ...
  for (; nfiles; nfiles--, fnamptr++)
    {
      ...
      if (is_stdin)
      ...
      else
        {
          ...
          if (fileptr == ((void*)0))
            {
              error (0, (*__errno_location ()), "%s", *fnamptr);
              ok = 0;
              continue;
            }
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, "d:s", longopts, ((void*)0))) != -1)
    {
      switch (optc)
        {
        case 'd':
  ...
  if (collapse_escapes (delim_arg))
    {
      ...
      error (1, 0,
             gettext ("delimiter list ends with an unescaped backslash: %s"),
