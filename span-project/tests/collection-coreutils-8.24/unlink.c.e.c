...
main (int argc, char **argv)
{
  ...
  parse_long_options (argc, argv, "unlink", "GNU coreutils", Version,
                      usage, ("Michael Stone"), (char const *) ((void*)0));
  ...
  if (unlink (argv[optind]) != 0)
    error (1, (*__errno_location ()), gettext ("cannot unlink %s"), quote (argv[optind]));
