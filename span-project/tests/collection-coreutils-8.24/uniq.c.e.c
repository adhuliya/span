...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
     ...
     fputs_unlocked (gettext ("  -D, --all-repeated[=METHOD]  print all duplicate lines;\n                          groups can be delimited with an empty line;\n                          METHOD={none(default),prepend,separate}\n"),stdout);
...
size_opt (char const *opt, char const *msgid)
{
  ...
  switch (xstrtoul (opt, ((void*)0), 10, &size, ""))
    {
    case LONGINT_OK:
...
find_field (struct linebuffer const *line)
{
  ...
  for (count = 0; count < skip_fields && i < size; count++)
    {
      while (i < size && ((*__ctype_b_loc ())[(int) ((to_uchar (lp[i])))] & (unsigned short int) _ISblank))
        i++;
      while (i < size && !((*__ctype_b_loc ())[(int) ((to_uchar (lp[i])))] & (unsigned short int) _ISblank))
        i++;
    }
      ...
      if (optc == -1
        ...
        case 1:
          {
            ...
            if (optarg[0] == '+'
                ...
                && xstrtoul (optarg, ((void*)0), 10, &size, "") == LONGINT_OK
        ...
        case '9':
          {
            ...
            if (!( (void) (&(skip_fields) == (size_t *) ((void*)0)), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (! (! ((size_t) 0 < (size_t) -1))) ? 1 : -1; })), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (skip_fields) == sizeof (size_t)) ? 1 : -1; })), (((size_t) -1 / 10 < (skip_fields) || (size_t) ((skip_fields) * 10 + (optc - '0')) < (skip_fields)) ? 0 : (((skip_fields) = (skip_fields) * 10 + (optc - '0')), 1)) ))
        ...
        case 'D':
          ...
          if (optarg == ((void*)0))
            ...
            delimit_groups = ((delimit_method_map) [__xargmatch_internal ("--all-repeated", optarg, delimit_method_string, (char const *) (delimit_method_map), sizeof *(delimit_method_map), argmatch_die)]);
        ...
        case GROUP_OPTION:
          if (optarg == ((void*)0))
            ...
            grouping = ((grouping_method_map) [__xargmatch_internal ("--group", optarg, grouping_method_string, (char const *) (grouping_method_map), sizeof *(grouping_method_map), argmatch_die)]);
