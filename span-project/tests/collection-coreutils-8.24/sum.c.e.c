  ...
  if (status != 0)
  ...
  else
    {
      printf (gettext ("Usage: %s [OPTION]... [FILE]...\n"),
              ...
              program_name);
      fputs_unlocked (gettext ("Print checksum and block counts for each FILE.\n"),stdout);
...
main (int argc, char **argv)
{
  ...
  int optc;
  int files_given;
  _Bool (*sum_func) (const char *, int) = bsd_sum_file;
  ...
  while ((optc = getopt_long (argc, argv, "rs", longopts, ((void*)0))) != -1)
    {
      switch (optc)
        {
        case 'r':
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "sum", "GNU coreutils", Version, ("Kayvan Aghaiepour"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
