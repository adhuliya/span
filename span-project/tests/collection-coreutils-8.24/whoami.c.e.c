...
main (int argc, char **argv)
{
  ...
  parse_long_options (argc, argv, "whoami", "GNU coreutils", Version,
                      usage, ("Richard Mlynarik"), (char const *) ((void*)0));
  ...
  if (!pw)
    error (1, (*__errno_location ()), gettext ("cannot find name for user ID %lu"),
