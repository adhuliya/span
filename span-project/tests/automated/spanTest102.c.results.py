...
TestActionAndResult(
  ...
  results = {
        ...
        "f:main":
          constructs.Func(
            ...
            instrSeq = [
                ...
                instr.CondI(expr.VarE("v:main:3if", Info(Loc(17,8))), "2IfTrue", "2IfFalse", Info(Loc(17,8))),
    ...
    "ir.names.1": ("f:main",
        types.Int32,
        {"v:main:1if", "v:main:3if", 'v:main:tmp', 'v:main:2t',
          'v:main:4t', 'v:main:a',
          "v:main:argc", "v:main:n1.val", "v:main:n2.val"}),
...
TestActionAndResult(
  ...
  results = {
    "analysis.results": {
      "EvenOddA": {
        "f:main": {
          17: dfv.NodeDfvL( # return 4t # (which is n2.val)
            dfvIn= evenodd.OverallL(None, val={
              "v:main:n1.val": evenodd.ComponentL(None, val=False),
              "v:main:n2.val": evenodd.ComponentL(None, val=False),
              ...
              "v:main:3if": evenodd.ComponentL(None, bot=True),
              "v:main:2t": evenodd.ComponentL(None, bot=True),
              "v:main:4t": evenodd.ComponentL(None, val=False),
              "v:main:a": evenodd.ComponentL(None, bot=True),
