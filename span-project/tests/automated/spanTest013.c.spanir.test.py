    ...
    "f:main":
      constructs.Func(
        ...
        instrSeq = [
            ...
            instr.AssignI(expr.VarE("v:main:a", Info(Loc(3,3))), expr.BinaryE(expr.VarE("v:main:a", Info(Loc(3,7))), op.BO_MOD, expr.LitE(2, Info(Loc(3,11))), Info(Loc(3,7))), Info(Loc(3,3))),
            instr.ReturnI(expr.VarE("v:main:a", Info(Loc(4,10))), Info(Loc(4,3))),
        ], # instrSeq end.
      ), # f:main() end. 
