...
# 20 "../lib/selinux/selinux.h" 3
# 31 "../lib/selinux/selinux.h" 3
# 1 "../lib/sys/types.h" 1 3
# 21 "../lib/sys/types.h" 3
# 32 "../lib/selinux/selinux.h" 2 3
...
extern _Bool set_process_security_ctx (char const *src_name,
                                      char const *dst_name,
                                      mode_t mode, _Bool new_dst,
                                      const struct cp_options *x);

extern _Bool set_file_security_ctx (char const *dst_name, _Bool process_local,
...
_Bool chown_failure_ok (struct cp_options const *) __attribute__ ((__pure__));
...
# 37 "install.c" 2
# 1 "../lib/mkancesdirs.h" 1
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stddef.h" 1 3
# 2 "../lib/mkancesdirs.h" 2
...
struct savewd;
_Bool make_dir_parents (char *dir,
                       struct savewd *wd,
                       ...
                       uid_t owner,
                       gid_t group,
                       _Bool preserve_existing);
# 39 "install.c" 2
# 1 "../lib/modechange.h" 1
# 23 "../lib/modechange.h"
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
# 24 "../lib/modechange.h" 2

struct mode_change *mode_compile (const char *);
struct mode_change *mode_create_from_ref (const char *);
mode_t mode_adjust (mode_t, _Bool, mode_t, struct mode_change const *,
                    mode_t *);
# 40 "install.c" 2
# 1 "./prog-fprintf.h" 1
# 20 "./prog-fprintf.h"
...
# 39 "./selinux.h"
static inline _Bool
restorecon (char const *path, _Bool recurse, _Bool preserve)
{ (*__errno_location ()) = 95; return 0; }
...
static _Bool use_default_selinux_context = 1;
# 74 "install.c"
...
static mode_t mode = ((0400|0200|0100) | (0400 >> 3) | (0100 >> 3) | ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3));


static mode_t dir_mode = ((0400|0200|0100) | (0400 >> 3) | (0100 >> 3) | ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3));





static mode_t dir_mode_bits = (04000 | 02000 | 01000 | (0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3));


static _Bool copy_only_if_needed;


static _Bool strip_files;


static _Bool dir_arg;
...
static struct option const long_options[] =
{
  ...
  {"owner", 1, ((void*)0), 'o'},
  {"preserve-timestamps", 0, ((void*)0), 'p'},
  {"preserve-context", 0, ((void*)0), PRESERVE_CONTEXT_OPTION},
  {"strip", 0, ((void*)0), 's'},
  {"strip-program", 1, ((void*)0), STRIP_PROGRAM_OPTION},
  {"suffix", 1, ((void*)0), 'S'},
...
{
  mode_t mask = ((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) | 0170000;
  return !! (input & ~ mask);
}
           ...
           const struct cp_options *x)
{
  ...
  if (!((((src_sb.st_mode)) & 0170000) == (0100000)) || !((((dest_sb.st_mode)) & 0170000) == (0100000))
      || extra_mode (src_sb.st_mode) || extra_mode (dest_sb.st_mode))
    return 1;

  if (src_sb.st_size != dest_sb.st_size
      || (dest_sb.st_mode & (04000 | 02000 | 01000 | (0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3))) != mode)
    return 1;
  ...
  if (owner_id == (uid_t) -1)
    {
      (*__errno_location ()) = 0;
      uid_t ruid = getuid ();
      if ((ruid == (uid_t) -1 && (*__errno_location ())) || dest_sb.st_uid != ruid)
        return 1;
    }
  ...
  if (group_id == (uid_t) -1)
    {
      (*__errno_location ()) = 0;
      gid_t rgid = getgid ();
      if ((rgid == (uid_t) -1 && (*__errno_location ())) || dest_sb.st_gid != rgid)
        return 1;
    }
  ...
  if (selinux_enabled && x->preserve_security_context)
    {
      char *file_scontext = ((void*)0);
      char *to_scontext = ((void*)0);
      _Bool scontext_match;
      ...
      scontext_match = (strcmp (file_scontext, to_scontext) == 0);
  ...
  src_fd = open (src_name, 00 | 0);
  if (src_fd < 0)
    return 1;

  dest_fd = open (dest_name, 00 | 0);
  if (dest_fd < 0)
    {
      close (src_fd);
      return 1;
...
target_directory_operand (char const *file)
{
  ...
  _Bool looks_like_a_dir = (blen == 0 || ((b[blen - 1]) == '/'));
  struct stat st;
  int err = (stat (file, &st) == 0 ? 0 : (*__errno_location ()));
  _Bool is_a_dir = !err && ((((st.st_mode)) & 0170000) == (0040000));
  if (err && err != 2)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, err, gettext (\"failed to access %s\"), quotearg_style (shell_escape_always_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, err, gettext ("failed to access %s"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, err, gettext ("failed to access %s"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (is_a_dir < looks_like_a_dir)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, err, gettext (\"target %s is not a directory\"), quotearg_style (shell_escape_always_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, err, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, err, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
announce_mkdir (char const *dir, void *options)
{
  ...
  if (x->verbose)
    prog_fprintf (stdout, gettext ("creating directory %s"), quotearg_style (shell_escape_always_quoting_style, dir));
}
...
{
  struct cp_options const *x = options;
  if (x->set_security_context && defaultcon (component, 0040000) < 0
      && ! ignorable_ctx_err ((*__errno_location ())))
    error (0, (*__errno_location ()), gettext ("failed to set default creation context for %s"),
           quotearg_style (shell_escape_always_quoting_style, dir));

  int r = mkdir (component, ((0400|0200|0100) | (0400 >> 3) | (0100 >> 3) | ((0400 >> 3) >> 3) | ((0100 >> 3) >> 3)));
  if (r == 0)
...
process_dir (char *dir, struct savewd *wd, void *options)
{
  ...
  if (ret == 0 && x->set_security_context)
    {
      if (! restorecon (last_component (dir), 0, 0)
          && ! ignorable_ctx_err ((*__errno_location ())))
        error (0, (*__errno_location ()), gettext ("failed to restore context for %s"),
               quotearg_style (shell_escape_always_quoting_style, dir));
    }
...
copy_file (const char *from, const char *to, const struct cp_options *x)
{
  ...
  return copy (from, to, 0, x, &copy_into_self, ((void*)0));
}
...
# 508 "install.c"
  if (! (owner_id == (uid_t) -1 && group_id == (gid_t) -1)
    ...
    error (0, (*__errno_location ()), gettext ("cannot change ownership of %s"), quotearg_style (shell_escape_always_quoting_style, name));
  else if (chmod (name, mode) != 0)
    error (0, (*__errno_location ()), gettext ("cannot change permissions of %s"), quotearg_style (shell_escape_always_quoting_style, name));
  else
    ok = 1;
...
change_timestamps (struct stat const *src_sb, char const *dest)
{
  ...
  if (utimens (dest, timespec))
    {
      error (0, (*__errno_location ()), gettext ("cannot set timestamps for %s"), quotearg_style (shell_escape_always_quoting_style, dest));
      return 0;
    }
  return 1;
}
...
strip (char const *name)
{
  ...
  switch (pid)
    ...
    case -1:
      ...
      break;
    case 0:
      execlp (strip_program, strip_program, name, ((void*)0));
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot run %s\"), quotearg_style (shell_escape_always_quoting_style, strip_program)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot run %s"), quotearg_style (shell_escape_always_quoting_style, strip_program)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot run %s"), quotearg_style (shell_escape_always_quoting_style, strip_program)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    default:
      if (waitpid (pid, &status, 0) < 0)
        error (0, (*__errno_location ()), gettext ("waiting for strip"));
      else if (! (((status) & 0x7f) == 0) || (((status) & 0xff00) >> 8))
  ...
  if (owner_name)
    {
      ...
      if (pw == ((void*)0))
        {
          uintmax_t tmp;
          if (xstrtoumax (owner_name, ((void*)0), 0, &tmp, "") != LONGINT_OK
              || ((uid_t) (! (! ((uid_t) 0 < (uid_t) -1)) ? (uid_t) -1 : ((((uid_t) 1 << ((sizeof (uid_t) * 8) - 2)) - 1) * 2 + 1))) < tmp)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid user %s\"), quote (owner_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid user %s"), quote (owner_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid user %s"), quote (owner_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (group_name)
    {
      ...
      if (gr == ((void*)0))
        {
          uintmax_t tmp;
          if (xstrtoumax (group_name, ((void*)0), 0, &tmp, "") != LONGINT_OK
              || ((gid_t) (! (! ((gid_t) 0 < (gid_t) -1)) ? (gid_t) -1 : ((((gid_t) 1 << ((sizeof (gid_t) * 8) - 2)) - 1) * 2 + 1))) < tmp)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid group %s\"), quote (group_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid group %s"), quote (group_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid group %s"), quote (group_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
# 657 "install.c"
      fputs_unlocked (gettext ("  -D                  create all leading components of DEST except the last,\n                        or all components of --target-directory,\n                        then copy SOURCE to DEST\n  -g, --group=GROUP   set group ownership, instead of process' current group\n  -m, --mode=MODE     set permission mode (as in chmod), instead of rwxr-xr-x\n  -o, --owner=OWNER   set ownership (super-user only)\n"),stdout);
      ...
      fputs_unlocked (gettext ("  -p, --preserve-timestamps   apply access/modification times of SOURCE files\n                        to corresponding destination files\n  -s, --strip         strip symbol tables\n      --strip-program=PROGRAM  program used to strip binaries\n  -S, --suffix=SUFFIX  override the usual backup suffix\n  -t, --target-directory=DIRECTORY  copy all SOURCE arguments into DIRECTORY\n  -T, --no-target-directory  treat DEST as a normal file\n  -v, --verbose       print the name of each directory as it is created\n"),stdout);
# 675 "install.c"
      fputs_unlocked (gettext ("      --preserve-context  preserve SELinux security context\n  -Z                      set SELinux security context of destination\n                            file and each created directory to default type\n      --context[=CTX]     like -Z, or if CTX is specified then set the\n                            SELinux or SMACK security context to CTX\n"),stdout);
                      ...
                      const struct cp_options *x)
{
  ...
  if (x->preserve_timestamps && stat (from, &from_sb) != 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot stat %s"), quotearg_style (shell_escape_always_quoting_style, from));
      return 0;
    }
  ...
  if (strip_files)
    if (! strip (to))
      {
        if (unlink (to) != 0)
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot unlink %s\"), quotearg_style (shell_escape_always_quoting_style, to)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot unlink %s"), quotearg_style (shell_escape_always_quoting_style, to)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot unlink %s"), quotearg_style (shell_escape_always_quoting_style, to)), ((0) ? (void) 0 : __builtin_unreachable ()))));
        return 0;
      }
                     ...
                     _Bool save_always)
{
  ...
  if (mkancesdirs (to, &wd, make_ancestor, x) == -1)
    {
      error (0, (*__errno_location ()), gettext ("cannot create directory %s"), quotearg_style (shell_escape_always_quoting_style, to));
      status = 1;
    }
...
install_file_in_file_parents (char const *from, char *to,
                              const struct cp_options *x)
{
  return (mkancesdirs_safe_wd (from, to, (struct cp_options *)x, 0)
...
install_file_in_dir (const char *from, const char *to_dir,
                     const struct cp_options *x, _Bool mkdir_and_install)
{
  const char *from_base = last_component (from);
  char *to = file_name_concat (to_dir, from_base, ((void*)0));
  _Bool ret = 1;

  if (mkdir_and_install)
    ret = mkancesdirs_safe_wd (from, to, (struct cp_options *)x, 1);
...
main (int argc, char **argv)
{
  int optc;
  int exit_status = 0;
  const char *specified_mode = ((void*)0);
  _Bool make_backups = 0;
  char const *backup_suffix = ((void*)0);
  char *version_control_string = ((void*)0);
  _Bool mkdir_and_install = 0;
  struct cp_options x;
  char const *target_directory = ((void*)0);
  _Bool no_target_directory = 0;
  int n_files;
  char **file;
  _Bool strip_program_specified = 0;
                              ...
                              ((void*)0))) != -1)
    {
      switch (optc)
        ...
        case PRESERVE_CONTEXT_OPTION:
          if (! selinux_enabled)
            {
              error (0, 0, gettext ("WARNING: ignoring --preserve-context; " "this kernel is not SELinux-enabled"));
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "install", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
        }
    }
  ...
  if (dir_arg && strip_files)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"the strip option may not be used when installing a directory\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("the strip option may not be used when installing a directory")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("the strip option may not be used when installing a directory")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  if (dir_arg && target_directory)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"target directory not allowed when installing a directory\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("target directory not allowed when installing a directory")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("target directory not allowed when installing a directory")), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (target_directory)
    {
      struct stat st;
      _Bool stat_success = stat (target_directory, &st) == 0 ? 1 : 0;
      if (! mkdir_and_install && ! stat_success)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to access %s\"), quotearg_style (shell_escape_always_quoting_style, target_directory)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to access %s"), quotearg_style (shell_escape_always_quoting_style, target_directory)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to access %s"), quotearg_style (shell_escape_always_quoting_style, target_directory)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (stat_success && ! ((((st.st_mode)) & 0170000) == (0040000)))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"target %s is not a directory\"), quotearg_style (shell_escape_always_quoting_style, target_directory)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, target_directory)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, target_directory)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (x.preserve_security_context && (x.set_security_context || scontext))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot set target context and preserve it\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot set target context and preserve it")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot set target context and preserve it")), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (scontext && setfscreatecon (se_const (scontext)) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set default file creation context to %s\"), quote (scontext)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set default file creation context to %s"), quote (scontext)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set default file creation context to %s"), quote (scontext)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (no_target_directory)
    {
      if (target_directory)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine --target-directory (-t) \" \"and --no-target-directory (-T)\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot combine --target-directory (-t) " "and --no-target-directory (-T)")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot combine --target-directory (-t) " "and --no-target-directory (-T)")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  else if (! (dir_arg || target_directory))
    {
      if (2 <= n_files && target_directory_operand (file[n_files - 1]))
        ...
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"target %s is not a directory\"), quotearg_style (shell_escape_always_quoting_style, file[n_files - 1])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, file[n_files - 1])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("target %s is not a directory"), quotearg_style (shell_escape_always_quoting_style, file[n_files - 1])), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (specified_mode)
    {
      ...
      if (!change)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid mode %s\"), quote (specified_mode)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid mode %s"), quote (specified_mode)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid mode %s"), quote (specified_mode)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      mode = mode_adjust (0, 0, 0, change, ((void*)0));
      dir_mode = mode_adjust (0, 1, 0, change, &dir_mode_bits);
      free (change);
    }

  if (strip_program_specified && !strip_files)
    error (0, 0, gettext ("WARNING: ignoring --strip-program option as -s option was " "not specified"));


  if (copy_only_if_needed && x.preserve_timestamps)
    {
      error (0, 0, gettext ("options --compare (-C) and --preserve-timestamps are " "mutually exclusive"));
  ...
  if (copy_only_if_needed && strip_files)
    {
      error (0, 0, gettext ("options --compare (-C) and --strip are mutually " "exclusive"));

      usage (1);
    }

  if (copy_only_if_needed && extra_mode (mode))
    error (0, 0, gettext ("the --compare (-C) option is ignored when you" " specify a mode with non-permission bits"));
