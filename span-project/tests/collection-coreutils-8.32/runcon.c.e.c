...
# 53 "../lib/selinux/context.h"
typedef int context_t;
inline context_t context_new (char const *s __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return 0; }
inline char *context_str (context_t con __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return (void *) 0; }
inline void context_free (context_t c __attribute__ ((__unused__))) {}

inline int context_user_set (context_t sc __attribute__ ((__unused__)),
                                        char const *s __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return -1; }
inline int context_role_set (context_t sc __attribute__ ((__unused__)),
                                        char const *s __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return -1; }
inline int context_range_set (context_t sc __attribute__ ((__unused__)),
                                         char const *s __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return -1; }
inline int context_type_set (context_t sc __attribute__ ((__unused__)),
                                        char const *s __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return -1; }
inline char *context_type_get (context_t sc __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return (void *) 0; }
inline char *context_range_get (context_t sc __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return (void *) 0; }
inline char *context_role_get (context_t sc __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return (void *) 0; }
inline char *context_user_get (context_t sc __attribute__ ((__unused__)))
  { (*__errno_location ()) = 95; return (void *) 0; }
# 48 "runcon.c" 2
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
...
main (int argc, char **argv)
{
  ...
  char *type = ((void*)0);
  char *context = ((void*)0);
  char *cur_context = ((void*)0);
  char *file_context = ((void*)0);
  char *new_context = ((void*)0);
  _Bool compute_trans = 0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'r':
          if (role)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple roles\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple roles")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple roles")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          role = optarg;
          break;
        case 't':
          if (type)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple types\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple types")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple types")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          type = optarg;
          break;
        case 'u':
          if (user)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple users\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple users")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple users")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          user = optarg;
          break;
        case 'l':
          if (range)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple levelranges\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple levelranges")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple levelranges")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          range = optarg;
          break;
        case 'c':
          compute_trans = 1;
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "runcon", "GNU coreutils", Version, ("Russell Coker"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
          break;
        }
  ...
  if (argc - optind == 0)
    {
      if (getcon (&cur_context) < 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to get current context\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to get current context")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to get current context")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (0 != 1)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s may be used only on a SELinux kernel\"), program_name), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s may be used only on a SELinux kernel"), program_name), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s may be used only on a SELinux kernel"), program_name), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (context)
    {
      ...
      if (!con)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to create security context: %s\"), quote (context)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to create security context: %s"), quote (context)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to create security context: %s"), quote (context)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  else
    {
      ...
      if (compute_trans)
        {
          ...
          if (getfilecon (argv[optind], &file_context) == -1)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to get security context of %s\"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to get security context of %s"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to get security context of %s"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          if (security_compute_create (cur_context, file_context,
                                       ...
                                       &new_context) != 0)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to compute a new context\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to compute a new context")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to compute a new context")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (!con)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to create security context: %s\"), quote (cur_context)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to create security context: %s"), quote (cur_context)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to create security context: %s"), quote (cur_context)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (user && context_user_set (con, user))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set new user: %s\"), quote (user)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set new user: %s"), quote (user)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set new user: %s"), quote (user)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (type && context_type_set (con, type))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set new type: %s\"), quote (type)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set new type: %s"), quote (type)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set new type: %s"), quote (type)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (range && context_range_set (con, range))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set new range: %s\"), quote (range)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set new range: %s"), quote (range)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set new range: %s"), quote (range)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (role && context_role_set (con, role))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set new role: %s\"), quote (role)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set new role: %s"), quote (role)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set new role: %s"), quote (role)), ((0) ? (void) 0 : __builtin_unreachable ()))));

    }

  if (security_check_context (context_str (con)) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"invalid context: %s\"), quote (context_str (con))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("invalid context: %s"), quote (context_str (con))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("invalid context: %s"), quote (context_str (con))), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (setexeccon (context_str (con)) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"unable to set security context %s\"), quote (context_str (con))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("unable to set security context %s"), quote (context_str (con))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("unable to set security context %s"), quote (context_str (con))), ((0) ? (void) 0 : __builtin_unreachable ()))));
