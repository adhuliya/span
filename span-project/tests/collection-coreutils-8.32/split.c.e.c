...
{
  return (((IO_BUFSIZE)>(((0 < (sb).st_blksize && (sb).st_blksize <= ((size_t)-1) / 8 + 1) ? (sb).st_blksize : 512)))?(IO_BUFSIZE):(((0 < (sb).st_blksize && (sb).st_blksize <= ((size_t)-1) / 8 + 1) ? (sb).st_blksize : 512)));
}
# 38 "split.c" 2
# 1 "../lib/quote.h" 1
# 21 "../lib/quote.h"
...
# 49 "../lib/binary-io.h"
inline int
__gl_setmode (int fd __attribute__ ((__unused__)), int mode __attribute__ ((__unused__)))
{
  return 0;
}
# 65 "../lib/binary-io.h"
...
static struct option const longopts[] =
{
  {"bytes", 1, ((void*)0), 'b'},
  {"lines", 1, ((void*)0), 'l'},
  {"line-bytes", 1, ((void*)0), 'C'},
  {"number", 1, ((void*)0), 'n'},
  {"elide-empty-files", 0, ((void*)0), 'e'},
  {"unbuffered", 0, ((void*)0), 'u'},
  {"suffix-length", 1, ((void*)0), 'a'},
  {"additional-suffix", 1, ((void*)0),
   ADDITIONAL_SUFFIX_OPTION},
  {"numeric-suffixes", 2, ((void*)0), 'd'},
  {"hex-suffixes", 2, ((void*)0), 'x'},
  {"filter", 1, ((void*)0), FILTER_OPTION},
  {"verbose", 0, ((void*)0), VERBOSE_OPTION},
  {"separator", 1, ((void*)0), 't'},
  {"-io-blksize", 1, ((void*)0),
   IO_BLKSIZE_OPTION},
  ...
  if (split_type == type_chunk_bytes || split_type == type_chunk_lines
      || split_type == type_rr)
    {
      ...
      if (numeric_suffix_start)
        {
          uintmax_t n_start;
          strtol_error e = xstrtoumax (numeric_suffix_start, ((void*)0), 10,
                                       &n_start, "");
          if (e == LONGINT_OK && n_start <= (18446744073709551615UL) - n_units)
            {
  ...
  if (suffix_length)
    {
      if (suffix_length < suffix_length_needed)
        {
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"the suffix length needs to be at least %\"\"l\" \"u\"), suffix_length_needed), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("the suffix length needs to be at least %""l" "u"), suffix_length_needed), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("the suffix length needs to be at least %""l" "u"), suffix_length_needed), ((0) ? (void) 0 : __builtin_unreachable ()))));
    ...
    suffix_length = (((2)>(suffix_length_needed))?(2):(suffix_length_needed));
}
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (gettext ("Usage: %s [OPTION]... [FILE [PREFIX]]\n"),


              program_name);
      fputs_unlocked (gettext ("Output pieces of FILE to PREFIXaa, PREFIXab, ...;\ndefault size is 1000 lines, and default PREFIX is 'x'.\n"),stdout);
...
input_file_size (int fd, struct stat const *st, char *buf, size_t bufsize)
{
  ...
  size += end - cur;
  if (size == ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))))
    {
...
new_name:
      ...
      if (numeric_suffix_start)
        {
          ((void) sizeof ((! widen) ? 1 : 0), __extension__ ({ if (! widen) ; else __assert_fail ("! widen", "split.c", 408, __extension__ __PRETTY_FUNCTION__); }));
...
# 433 "split.c"
  ...
  else
    {
      ...
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"output file suffixes exhausted\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("output file suffixes exhausted")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("output file suffixes exhausted")), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
}
...
create (const char *name)
{
  if (!filter_command)
    {
      if (verbose)
        fprintf (stdout, gettext ("creating file %s\n"), quotearg_style (shell_escape_always_quoting_style, name));

      int fd = open_safer (name, 01 | 0100 | 0, (0400 | 0200 | (0400 >> 3) | (0200 >> 3) | ((0400 >> 3) >> 3) | ((0200 >> 3) >> 3)));
      if (fd < 0)
        return fd;
      struct stat out_stat_buf;
      if (fstat (fd, &out_stat_buf) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to stat %s\"), quotearg_style (shell_escape_always_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to stat %s"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to stat %s"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      if (((in_stat_buf).st_ino == (out_stat_buf).st_ino && (in_stat_buf).st_dev == (out_stat_buf).st_dev))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s would overwrite input; aborting\"), quotearg_style (shell_escape_always_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s would overwrite input; aborting"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s would overwrite input; aborting"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (ftruncate (fd, 0) != 0
          && (((((out_stat_buf.st_mode)) & 0170000) == (0100000)) || ((&out_stat_buf)->st_mode - (&out_stat_buf)->st_mode)))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"%s: error truncating\"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("%s: error truncating"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("%s: error truncating"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  else
    {
      ...
      if (setenv ("FILE", name, 1) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to set FILE environment variable\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to set FILE environment variable")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to set FILE environment variable")), ((0) ? (void) 0 : __builtin_unreachable ()))));

      if (verbose)
        fprintf (stdout, gettext ("executing with FILE=%s\n"), quotearg_n_style_colon (0, shell_escape_quoting_style, name));
      if (pipe (fd_pair) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to create pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to create pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to create pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      child_pid = fork ();
      if (child_pid == 0)
        {
          ...
          for (j = 0; j < n_open_pipes; ++j)
            if (close (open_pipes[j]) != 0)
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing prior pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("closing prior pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("closing prior pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          if (close (fd_pair[1]))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing output pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("closing output pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("closing output pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          if (fd_pair[0] != 0)
            {
              if (dup2 (fd_pair[0], 0) != 0)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"moving input pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("moving input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("moving input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
              if (close (fd_pair[0]) != 0)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing input pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("closing input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("closing input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
            }
          sigprocmask (2, &oldblocked, ((void*)0));
          execl (shell_prog, last_component (shell_prog), "-c",
                 filter_command, (char *) ((void*)0));
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to run command: \\\"%s -c %s\\\"\"), shell_prog, filter_command), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to run command: \"%s -c %s\""), shell_prog, filter_command), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to run command: \"%s -c %s\""), shell_prog, filter_command), ((0) ? (void) 0 : __builtin_unreachable ()))));

        }
      if (child_pid == -1)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"fork system call failed\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("fork system call failed")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("fork system call failed")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      if (close (fd_pair[0]) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to close input pipe\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to close input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to close input pipe")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
{
  if (fp != ((void*)0) && rpl_fclose (fp) != 0 && ! ignorable ((*__errno_location ())))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (fd >= 0)
    {
      if (fp == ((void*)0) && close (fd) < 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      int j;
      for (j = 0; j < n_open_pipes; ++j)
        {
  ...
  if (pid > 0)
    {
      int wstatus = 0;
      if (waitpid (pid, &wstatus, 0) == -1 && (*__errno_location ()) != 10)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"waiting for child process\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("waiting for child process")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("waiting for child process")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      if ((((signed char) (((wstatus) & 0x7f) + 1) >> 1) > 0))
        {
          int sig = ((wstatus) & 0x7f);
          if (sig != 13)
            {
              char signame[((((sizeof "SIGRTMAX" + (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) - 1))>(((((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1)))?((sizeof "SIGRTMAX" + (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) - 1)):(((((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) + 1)))];
      ...
      else
        {
          ...
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"unknown status from command (0x%X)\"), wstatus + 0u), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("unknown status from command (0x%X)"), wstatus + 0u), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("unknown status from command (0x%X)"), wstatus + 0u), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
static _Bool
cwrite (_Bool new_file_flag, const char *bp, size_t bytes)
{
  if (new_file_flag)
    {
      ...
      if (output_desc < 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, outfile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, outfile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, outfile)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
  ...
  do
    {
      if (initial_read != (18446744073709551615UL))
      ...
      else
        {
          ...
          if (n_read == ((size_t) -1))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));
          eof = n_read == 0;
        }
      char *bp_out = buf;
          ...
          if ((eoc && split_rest) || (!eoc && n_left))
            {
              ...
              if (hold_size - n_hold < n_buf)
                {
                  if (hold_size <= (18446744073709551615UL) - bufsize)
                    hold_size += bufsize;
                  else
                    xalloc_die ();
...
{
  ((void) sizeof ((n && k <= n && n <= file_size) ? 1 : 0), __extension__ ({ if (n && k <= n && n <= file_size) ; else __assert_fail ("n && k <= n && n <= file_size", "split.c", 866, __extension__ __PRETTY_FUNCTION__); }));
  ...
  while (n_written < file_size)
    {
      ...
      if (n_read == 0)
        break;
      n_read = (((n_read)<(file_size - n_written))?(n_read):(file_size - n_written));
      chunk_truncated = 0;
      eob = buf + n_read;
      ...
      while (bp != eob)
        {
          ...
          off_t skip = (((n_read)<((((0)>(chunk_end - n_written))?(0):(chunk_end - n_written))))?(n_read):((((0)>(chunk_end - n_written))?(0):(chunk_end - n_written))));
          ...
          if (k == chunk_no)
            {
              ...
              if (full_write (1, bp, to_write) != to_write)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", gettext (\"write error\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))));
            }
          else if (! k)
                     ...
                     size_t initial_read, off_t file_size)
{
  ...
  ((void) sizeof ((k && n && k <= n && n <= file_size) ? 1 : 0), __extension__ ({ if (k && n && k <= n && n <= file_size) ; else __assert_fail ("k && n && k <= n && n <= file_size", "split.c", 992, __extension__ __PRETTY_FUNCTION__); }));
  ...
  while (start < end)
    {
      ...
      if (full_write (1, buf, n_read) != n_read
        ...
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, \"-\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, "-")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, "-")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      start += n_read;
    }
}
      ...
      while (1)
        {
          if (files[i_check].ofd == OFD_NEW)
            ...
            {
# 1085 "split.c"
              fd = open_safer (files[i_check].of_name,
                         01 | 0 | 02000 | 04000);
            }
          ...
          if (rpl_fclose (files[i_reopen].ofile) != 0)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_reopen].of_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_reopen].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_reopen].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
          files[i_reopen].ofile = ((void*)0);
...
lines_rr (uintmax_t k, uintmax_t n, char *buf, size_t bufsize)
{
  ...
  while (1)
    {
      char *bp = buf, *eob;
      size_t n_read = safe_read (0, buf, bufsize);
      if (n_read == ((size_t) -1))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      else if (n_read == 0)
        break;
          ...
          if (k)
            {
              ...
              else if (line_no == k && fwrite_unlocked (bp,to_write,1,stdout) != 1)
                {
          ...
          else
            {
              ...
              if (unbuffered)
                {
                  ...
                  if (full_write (files[i_file].ofd, bp, to_write) != to_write
                      && ! ignorable ((*__errno_location ())))
                    {
                      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));

                    }
                }
              else if (fwrite_unlocked (bp,to_write,1,files[i_file].ofile) != 1
                       && ! ignorable ((*__errno_location ())))
                {
                  ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
              ...
              if (file_limit)
                {
                  if (rpl_fclose (files[i_file].ofile) != 0)
                    {
                      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, files[i_file].of_name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (slash != optarg)
    {
      ...
      *k_units = xdectoumax (optarg, 1, *n_units, "",
                             gettext ("invalid chunk number"), 0);
    }
}
...
main (int argc, char **argv)
{
  ...
  int c;
  int digits_optind = 0;
  off_t file_size = ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)));
  ...
  while (1)
    {
      ...
      switch (c)
        {
        case 'a':
          suffix_length = xdectoumax (optarg, 0, (18446744073709551615UL) / sizeof (size_t),
                                      "", gettext ("invalid suffix length"), 0);
          break;
        ...
        case ADDITIONAL_SUFFIX_OPTION:
          if (last_component (optarg) != optarg)
            {
              error (0, 0,
                     gettext ("invalid suffix %s, contains directory separator"),
                     quote (optarg));
              usage (1);
            }
        ...
        case 'b':
          if (split_type != type_undef)
            do { error (0, 0, gettext ("cannot split in more than one way")); usage (1); } while (0);
          split_type = type_bytes;



          n_units = xdectoumax (optarg, 1, ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))), multipliers,
        ...
        case 'l':
          ...
          n_units = xdectoumax (optarg, 1, (18446744073709551615UL), "",
                                gettext ("invalid number of lines"), 0);
          break;
        ...
        case 'C':
          ...
          n_units = xdectoumax (optarg, 1, ((((18446744073709551615UL))<(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))?((18446744073709551615UL)):(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))))),
                                multipliers, gettext ("invalid number of bytes"), 0);
          break;
        ...
        case 'n':
          ...
          while (((*__ctype_b_loc ())[(int) ((to_uchar (*optarg)))] & (unsigned short int) _ISspace))
            optarg++;
          if (strncmp (optarg, "" "r/" "", sizeof ("r/") - 1) == 0)
            {
              split_type = type_rr;
              optarg += 2;
            }
          else if (strncmp (optarg, "" "l/" "", sizeof ("l/") - 1) == 0)
            {
        ...
        case 't':
          {
            ...
            if (! neweol)
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"empty record separator\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("empty record separator")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("empty record separator")), ((0) ? (void) 0 : __builtin_unreachable ()))));
            if (optarg[1])
              {
                if ((strcmp (optarg, "\\0") == 0))
                ...
                else
                  {
                    ...
                    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multi-character separator %s\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multi-character separator %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multi-character separator %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
            ...
            if (0 <= eolchar && neweol != eolchar)
              {
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple separator characters specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple separator characters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple separator characters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        ...
        case '9':
          ...
          if (!( (void) (&(n_units) == (uintmax_t *) ((void*)0)), ((!!sizeof (struct { _Static_assert (! (! ((uintmax_t) 0 < (uintmax_t) -1)), "verify_expr (" "! TYPE_SIGNED (uintmax_t)" ", " "(((uintmax_t) -1 / 10 < (n_units) || (uintmax_t) ((n_units) * 10 + (c - '0')) < (n_units)) ? false : (((n_units) = (n_units) * 10 + (c - '0')), true))" ")"); int _gl_dummy; })) ? ((((uintmax_t) -1 / 10 < (n_units) || (uintmax_t) ((n_units) * 10 + (c - '0')) < (n_units)) ? 0 : (((n_units) = (n_units) * 10 + (c - '0')), 1))) : ((((uintmax_t) -1 / 10 < (n_units) || (uintmax_t) ((n_units) * 10 + (c - '0')) < (n_units)) ? 0 : (((n_units) = (n_units) * 10 + (c - '0')), 1)))) ))
            {
              char buffer[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"line count option -%s%c... is too large\"), umaxtostr (n_units, buffer), c), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("line count option -%s%c... is too large"), umaxtostr (n_units, buffer), c), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("line count option -%s%c... is too large"), umaxtostr (n_units, buffer), c), ((0) ? (void) 0 : __builtin_unreachable ()))));
              ...
              if (strlen (optarg) != strspn (optarg, suffix_alphabet))
                {
                  error (0, 0,
                         (c == 'd') ?
                           gettext ("%s: invalid start value for numerical suffix") :
                           gettext ("%s: invalid start value for hexadecimal suffix"),
                         quote (optarg));
                  usage (1);
                }
              else
        ...
        case IO_BLKSIZE_OPTION:
          in_blk_size = xdectoumax (optarg, 1, (18446744073709551615UL) - page_size,
                                    multipliers, gettext ("invalid IO block size"), 0);
          break;
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "split", "GNU coreutils", Version, ("Torbjorn Granlund"), ("Richard M. Stallman"), (char *) ((void*)0)); exit (0); break;;
  ...
  if (k_units != 0 && filter_command)
    {
      error (0, 0, gettext ("--filter does not process a chunk extracted to stdout"));
      usage (1);
    }
  ...
  if (n_units == 0)
    {
      error (0, 0, "%s: %s", gettext ("invalid number of lines"), quote ("0"));
      usage (1);
    }
  ...
  if (numeric_suffix_start && strlen (numeric_suffix_start) > suffix_length)
    {
      error (0, 0, gettext ("numerical suffix start value is too large " "for the suffix length"));
  ...
  if (! (strcmp (infile, "-") == 0)
      && fd_reopen (0, infile, 00, 0) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot open %s for reading\"), quotearg_style (shell_escape_always_quoting_style, infile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot open %s for reading"), quotearg_style (shell_escape_always_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot open %s for reading"), quotearg_style (shell_escape_always_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (fstat (0, &in_stat_buf) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));

  _Bool specified_buf_size = !! in_blk_size;
  ...
  if (split_type == type_chunk_bytes || split_type == type_chunk_lines)
    {
      file_size = input_file_size (0, &in_stat_buf,
                                   buf, in_blk_size);
      if (file_size < 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"%s: cannot determine file size\"), quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("%s: cannot determine file size"), quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("%s: cannot determine file size"), quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));

      initial_read = (((file_size)<(in_blk_size))?(file_size):(in_blk_size));

      if (((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))) < n_units)
        {
          char buffer[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 75, \"%s: %s\", gettext (\"invalid number of chunks\"), quote (umaxtostr (n_units, buffer))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 75, "%s: %s", gettext ("invalid number of chunks"), quote (umaxtostr (n_units, buffer))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 75, "%s: %s", gettext ("invalid number of chunks"), quote (umaxtostr (n_units, buffer))), ((0) ? (void) 0 : __builtin_unreachable ()))));


        }


      file_size = (((file_size)>(n_units))?(file_size):(n_units));
    }
  ...
  if (filter_command)
    {
      ...
      sigaction (13, ((void*)0), &act);
      if (act.__sigaction_handler.sa_handler != ((__sighandler_t) 1))
        sigaddset (&newblocked, 13);
      sigprocmask (0, &newblocked, &oldblocked);
    }
  ...
  switch (split_type)
    ...
    case type_bytes:
      bytes_split (n_units, buf, in_blk_size, (18446744073709551615UL), 0);
      break;
