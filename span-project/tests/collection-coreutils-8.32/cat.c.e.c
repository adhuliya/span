  ...
  while (1)
    {
      ...
      if (n_read == ((size_t) -1))
        {
          error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile));
          return 0;
        }
              ...
              if (use_fionread
                  && ioctl (input_desc, 0x541B, &n_to_read) < 0)
                {
                  ...
                  if ((*__errno_location ()) == 95 || (*__errno_location ()) == 25
                      || (*__errno_location ()) == 22 || (*__errno_location ()) == 19
                      || (*__errno_location ()) == 38)
                    use_fionread = 0;
                  else
                    {
...
main (int argc, char **argv)
{
  ...
  while ((c = getopt_long (argc, argv, "benstuvAET", long_options, ((void*)0)))
         != -1)
    {
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "cat", "GNU coreutils", Version, ("Torbjorn Granlund"), ("Richard M. Stallman"), (char *) ((void*)0)); exit (0); break;;
  ...
  out_isreg = ((((stat_buf.st_mode)) & 0170000) == (0100000)) != 0;
  ...
  do
    {
      ...
      if (out_isreg
          ...
          && lseek (input_desc, 0, 1) < stat_buf.st_size)
        {
...
# 741 "cat.c"
          outbuf = xmalloc (outsize - 1 + insize * 4 + 20
                            + page_size - 1);
  ...
  if (have_read_stdin && close (0) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing standard input\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("closing standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("closing standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
