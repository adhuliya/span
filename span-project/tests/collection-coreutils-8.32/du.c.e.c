...
# 1 "../lib/stdio.h" 1
# 21 "../lib/stdio.h" 3
# 18 "../lib/argv-iter.h" 2



# 1 "../lib/arg-nonnull.h" 1
# 22 "../lib/argv-iter.h" 2
...
int di_set_insert (struct di_set *, dev_t, ino_t) __attribute__ ((__nonnull__ (1)));
void di_set_free (struct di_set *) __attribute__ ((__nonnull__ (1)));
...
struct exclude *new_exclude (void) __attribute__ ((__malloc__));
...
# 37 "du.c" 2
# 1 "../lib/fprintftime.h" 1
# 18 "../lib/fprintftime.h"
# 1 "../lib/stdio.h" 1
# 21 "../lib/stdio.h" 3
# 19 "../lib/fprintftime.h" 2
# 1 "../lib/time.h" 1
# 21 "../lib/time.h" 3
# 20 "../lib/fprintftime.h" 2
...
# 275 "../lib/fts_.h"
FTSENT *rpl_fts_children (FTS *, int) __attribute__ ((__warn_unused_result__));
int rpl_fts_close (FTS *) __attribute__ ((__warn_unused_result__));
FTS *rpl_fts_open (char * const *, int,
                   int (*)(const FTSENT **, const FTSENT **))
          __attribute__ ((__warn_unused_result__));
FTSENT *rpl_fts_read (FTS *) __attribute__ ((__warn_unused_result__));
...
duinfo_init (struct duinfo *a)
{
  a->size = 0;
  a->inodes = 0;
  a->tmax.tv_sec = ((time_t) ~ ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << ((sizeof (time_t) * 8) - 2)) - 1) * 2 + 1))));
  a->tmax.tv_nsec = -1;
}
...
duinfo_add (struct duinfo *a, struct duinfo const *b)
{
  ...
  a->size = a->size <= sum ? sum : (18446744073709551615UL);
...
static _Bool opt_all = 0;



static _Bool apparent_size = 0;


static _Bool opt_count_all = 0;


static _Bool hash_all;


static _Bool opt_nul_terminate_output = 0;


static _Bool print_grand_total = 0;


static _Bool opt_separate_dirs = 0;




static size_t max_depth = (18446744073709551615UL);
...
static _Bool opt_inodes = 0;


static _Bool opt_time = 0;
...
static char const *time_style = ((void*)0);


static char const *time_format = ((void*)0);
...
{
  {"all", 0, ((void*)0), 'a'},
  {"apparent-size", 0, ((void*)0), APPARENT_SIZE_OPTION},
  {"block-size", 1, ((void*)0), 'B'},
  {"bytes", 0, ((void*)0), 'b'},
  {"count-links", 0, ((void*)0), 'l'},

  {"dereference", 0, ((void*)0), 'L'},
  {"dereference-args", 0, ((void*)0), 'D'},
  {"exclude", 1, ((void*)0), EXCLUDE_OPTION},
  {"exclude-from", 1, ((void*)0), 'X'},
  {"files0-from", 1, ((void*)0), FILES0_FROM_OPTION},
  {"human-readable", 0, ((void*)0), 'h'},
  {"inodes", 0, ((void*)0), INODES_OPTION},
  {"si", 0, ((void*)0), HUMAN_SI_OPTION},
  {"max-depth", 1, ((void*)0), 'd'},
  {"null", 0, ((void*)0), '0'},
  {"no-dereference", 0, ((void*)0), 'P'},
  {"one-file-system", 0, ((void*)0), 'x'},
  {"separate-dirs", 0, ((void*)0), 'S'},
  {"summarize", 0, ((void*)0), 's'},
  {"total", 0, ((void*)0), 'c'},
  {"threshold", 1, ((void*)0), 't'},
  {"time", 2, ((void*)0), TIME_OPTION},
...
_Static_assert ((sizeof (time_args) / sizeof *(time_args)) == (sizeof (time_types) / sizeof *(time_types)) + 1, "verify (" "ARRAY_CARDINALITY (time_args) == ARRAY_CARDINALITY (time_types) + 1" ")");
...
{
  "full-iso", "long-iso", "iso", ((void*)0)
};
static enum time_style const time_style_types[] =
{
  full_iso_time_style, long_iso_time_style, iso_time_style
};
_Static_assert ((sizeof (time_style_args) / sizeof *(time_style_args)) == (sizeof (time_style_types) / sizeof *(time_style_types)) + 1, "verify (" "ARRAY_CARDINALITY (time_style_args) == ARRAY_CARDINALITY (time_style_types) + 1" ")");
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("Summarize disk usage of the set of FILEs, recursively for directories.\n"),stdout);
...
# 317 "du.c"
      fputs_unlocked (gettext ("      --files0-from=F   summarize disk usage of the\n                          NUL-terminated file names specified in file F;\n                          if F is -, then read names from standard input\n  -H                    equivalent to --dereference-args (-D)\n  -h, --human-readable  print sizes in human readable format (e.g., 1K 234M 2G)\n      --inodes          list inode usage information instead of block usage\n"),stdout);
# 326 "du.c"
...
show_date (const char *format, struct timespec when, timezone_t tz)
{
  ...
  if (localtime_rz (tz, &when.tv_sec, &tm))
  ...
  else
    {
      ...
      error (0, 0, gettext ("time %s is out of range"), quote (when_str));
...
print_only_size (uintmax_t n_bytes)
{
  ...
  fputs_unlocked ((n_bytes == (18446744073709551615UL) ? gettext ("Infinity") : human_readable (n_bytes, buf, human_output_opts, 1, output_block_size)),stdout);
...
{
  struct mount_entry *mnt_ent = read_file_system_list (0);
  while (mnt_ent)
    {
...
# 504 "du.c"
  ...
  if (info == 4)
    {
      ...
      error (0, ent->fts_errno, gettext ("cannot read directory %s"), quotearg_style (shell_escape_always_quoting_style, file));
      ok = 0;
    }
  else if (info != 6)
    {
      _Bool excluded = excluded_file_name (exclude, file);
      if (! excluded)
        {
          ...
          if (info == 11)
            {
              ...
              FTSENT const *e = rpl_fts_read (fts);
              ((void) sizeof ((e == ent) ? 1 : 0), __extension__ ({ if (e == ent) ; else __assert_fail ("e == ent", "du.c", 527, __extension__ __PRETTY_FUNCTION__); }));
              info = ent->fts_info;
            }

          if (info == 10 || info == 13)
            {
              error (0, ent->fts_errno, gettext ("cannot access %s"), quotearg_style (shell_escape_always_quoting_style, file));
              return 0;
            }
      ...
      if (excluded
          || (! opt_count_all
              && (hash_all || (! ((((sb->st_mode)) & 0170000) == (0040000)) && 1 < sb->st_nlink))
          ...
          if (info == 1)
            {
              ...
              FTSENT const *e = rpl_fts_read (fts);
              ((void) sizeof ((e == ent) ? 1 : 0), __extension__ ({ if (e == ent) ; else __assert_fail ("e == ent", "du.c", 560, __extension__ __PRETTY_FUNCTION__); }));
            }
      ...
      switch (info)
        ...
        case 7:
          ...
          error (0, ent->fts_errno, "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, file));
          ok = 0;
          break;
  ...
  else
    {
      if (level == prev_level)
      ...
      else
        {
          ...
          ((void) sizeof ((level == prev_level - 1) ? 1 : 0), __extension__ ({ if (level == prev_level - 1) ; else __assert_fail ("level == prev_level - 1", "du.c", 638, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (! (opt_separate_dirs && ((info) == 6 || (info) == 4)))
  ...
  if ((((info) == 6 || (info) == 4) && level <= max_depth)
          ...
          if (ent == ((void*)0))
            {
              if ((*__errno_location ()) != 0)
                {
                  error (0, (*__errno_location ()), gettext ("fts_read failed: %s"),
                         quotearg_n_style_colon (0, shell_escape_quoting_style, fts->fts_path));
                  ok = 0;
                }
...
main (int argc, char **argv)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'd':
          {
            uintmax_t tmp;
            if (xstrtoumax (optarg, ((void*)0), 0, &tmp, "") == LONGINT_OK
        ...
        case 't':
          {
            enum strtol_error e;
            e = xstrtoimax (optarg, ((void*)0), 0, &opt_threshold, "kKmMGTPEZY0");
            if (e != LONGINT_OK)
              xstrtol_fatal (e, oi, c, long_options, optarg);
            if (opt_threshold == 0 && *optarg == '-')
              {

                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid --threshold argument '-0'\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid --threshold argument '-0'")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid --threshold argument '-0'")), ((0) ? (void) 0 : __builtin_unreachable ()))));
              }
          }
          break;
        ...
        case 'X':
          if (add_exclude_file (add_exclude, exclude, optarg,
                                (1 << 28), '\n'))
            {
              error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, optarg));
              ok = 0;
            }
          break;
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "du", "GNU coreutils", Version, ("Torbjorn Granlund"), ("David MacKenzie"), ("Paul Eggert"), ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;
      ...
      if (!file_name)
        {
          switch (ai_err)
            ...
            case AI_ERR_EOF:
              goto argv_iter_done;
            case AI_ERR_READ:
              error (0, (*__errno_location ()), gettext ("%s: read error"),
            ...
            case AI_ERR_MEM:
              xalloc_die ();
            default:
              ((void) sizeof ((!"unexpected error code from argv_iter") ? 1 : 0), __extension__ ({ if (!"unexpected error code from argv_iter") ; else __assert_fail ("!\"unexpected error code from argv_iter\"", "du.c", 1081, __extension__ __PRETTY_FUNCTION__); }));
            }
        }
 ...
 argv_iter_done:
  ...
  if (files_from && (ferror_unlocked (stdin) || rpl_fclose (stdin) != 0) && ok)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"error reading %s\"), quotearg_style (shell_escape_always_quoting_style, files_from)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, files_from)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, files_from)), ((0) ? (void) 0 : __builtin_unreachable ()))));
