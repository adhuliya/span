...
{
  "prepend", "append", "separate", "both", ((void*)0)
};
...
static struct option const longopts[] =
{
  {"count", 0, ((void*)0), 'c'},
  {"repeated", 0, ((void*)0), 'd'},
  {"all-repeated", 2, ((void*)0), 'D'},
  {"group", 2, ((void*)0), GROUP_OPTION},
  {"ignore-case", 0, ((void*)0), 'i'},
  {"unique", 0, ((void*)0), 'u'},
  {"skip-fields", 1, ((void*)0), 'f'},
  {"skip-chars", 1, ((void*)0), 's'},
  {"check-chars", 1, ((void*)0), 'w'},
  ...
  if (status != 0)
  ...
  else
    {
      printf (gettext ("Usage: %s [OPTION]... [INPUT [OUTPUT]]\n"),
              ...
              program_name);
      fputs_unlocked (gettext ("Filter adjacent matching lines from INPUT (or standard input),\nwriting to OUTPUT (or standard output).\n\nWith no options, matching lines are merged to the first occurrence.\n"),stdout);
     ...
     fputs_unlocked (gettext ("  -c, --count           prefix lines by the number of occurrences\n  -d, --repeated        only print duplicate lines, one for each group\n"),stdout);



     fputs_unlocked (gettext ("  -D                    print all duplicate lines\n      --all-repeated[=METHOD]  like -D, but allow separating groups\n                                 with an empty line;\n                                 METHOD={none(default),prepend,separate}\n"),stdout);





     fputs_unlocked (gettext ("  -f, --skip-fields=N   avoid comparing the first N fields\n"),stdout);


     fputs_unlocked (gettext ("      --group[=METHOD]  show all items, separating groups with an empty line;\n                          METHOD={separate(default),prepend,append,both}\n"),stdout);



     fputs_unlocked (gettext ("  -i, --ignore-case     ignore differences in case when comparing\n  -s, --skip-chars=N    avoid comparing the first N characters\n  -u, --unique          only print unique lines\n"),stdout);
     ...
     fputs_unlocked (gettext ("  -w, --check-chars=N   compare no more than N characters in lines\n"),stdout);
...
size_opt (char const *opt, char const *msgid)
{
  ...
  switch (xstrtoumax (opt, ((void*)0), 10, &size, ""))
    ...
    default:
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, \"%s: %s\", opt, gettext (msgid)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, "%s: %s", opt, gettext (msgid)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, "%s: %s", opt, gettext (msgid)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }

  return (((size)<((18446744073709551615UL)))?(size):((18446744073709551615UL)));
}
...
find_field (struct linebuffer const *line)
{
  ...
  i += (((skip_chars)<(size - i))?(skip_chars):(size - i));
...
writeline (struct linebuffer const *line,
           _Bool match, uintmax_t linecount)
{
  ...
  if (countmode == count_occurrences)
    printf ("%7" "l" "u" " ", linecount + 1);

  fwrite_unlocked (line->buffer,sizeof (char),line->length,stdout);
}
          ...
          if (new_group || grouping != GM_NONE)
            {
              ...
              do { struct linebuffer *_tmp; _tmp = (prevline); (prevline) = (thisline); (thisline) = _tmp; } while (0);
              prevfield = thisfield;
              prevlen = thislen;
          ...
          if (match_count == (18446744073709551615UL))
            {
              if (count_occurrences)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"too many repeated lines\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("too many repeated lines")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("too many repeated lines")), ((0) ? (void) 0 : __builtin_unreachable ()))));
              match_count--;
            }
...
main (int argc, char **argv)
{
  ...
  skip_chars = 0;
  skip_fields = 0;
  check_chars = (18446744073709551615UL);
  output_unique = output_first_repeated = 1;
  ...
  while (1)
    {
      ...
      if (optc == -1
          ...
          || ((optc = getopt_long (argc, argv,
                                   "-0123456789Dcdf:is:uw:z", longopts, ((void*)0)))
              == -1))
        {
          if (argc <= optind)
            break;
        ...
        case 1:
          {
            ...
            if (optarg[0] == '+'
                && ! strict_posix2 ()
                && xstrtoumax (optarg, ((void*)0), 10, &size, "") == LONGINT_OK
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "uniq", "GNU coreutils", Version, ("Richard M. Stallman"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
