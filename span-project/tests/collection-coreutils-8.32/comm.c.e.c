          ...
          if (0 < order)
            {
              error ((check_input_order == CHECK_ORDER_ENABLED
                      ? 1 : 0),
                     0, gettext ("file %d is not in sorted order"), whatfile);
...
compare_files (char **infiles)
{
  ...
  for (i = 0; i < 2; i++)
    {
      ...
      alt[i][1] = 0;
      alt[i][2] = 0;
      streams[i] = ((strcmp (infiles[i], "-") == 0) ? stdin : fopen_safer (infiles[i], "r"));
      if (!streams[i])
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (!thisline[0])
      ...
      else
        {
          if (hard_LC_COLLATE)
            ...
            {
              size_t len = ((thisline[0]->length) < (thisline[1]->length) ? (thisline[0]->length) : (thisline[1]->length)) - 1;
  ...
  for (i = 0; i < 2; i++)
    if (rpl_fclose (streams[i]) != 0)
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infiles[i])), ((0) ? (void) 0 : __builtin_unreachable ()))));

  if (total_option)
    {

      char buf1[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
      char buf2[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
      char buf3[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
    ...
    switch (c)
      ...
      case OUTPUT_DELIMITER_OPTION:
        if (col_sep_len && !(strcmp (col_sep, optarg) == 0))
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple output delimiters specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple output delimiters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple output delimiters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        col_sep = optarg;
      ...
      case GETOPT_VERSION_CHAR: version_etc (stdout, "comm", "GNU coreutils", Version, ("Richard M. Stallman"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
