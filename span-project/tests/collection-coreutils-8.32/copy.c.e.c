...
_Bool extent_scan_read (struct extent_scan *scan);

static inline void
extent_scan_free (struct extent_scan *scan)
{
  free (scan->ext_info);
  scan->ext_info = ((void*)0);
  scan->ei_count = 0;
}
# 41 "copy.c" 2
# 1 "./die.h" 1
...
# 16 "/usr/include/linux/fs.h" 2 3 4
# 46 "/usr/include/linux/fs.h" 3 4
...
# 158 "/usr/include/linux/fs.h" 3 4
struct fsxattr {
 __u32 fsx_xflags;
 __u32 fsx_extsize;
 __u32 fsx_nextents;
...
# 279 "/usr/include/linux/fs.h" 3 4
...
# 298 "/usr/include/linux/fs.h" 3 4
struct fscrypt_key {
 __u32 mode;
 __u8 raw[64];
 __u32 size;
};
# 366 "/usr/include/linux/fs.h" 3 4
...
static _Bool copy_internal (char const *src_name, char const *dst_name,
                           _Bool new_dst, struct stat const *parent,
...
follow_fstatat (int dirfd, char const *filename, struct stat *st, int flags)
{
  ...
  if (0 && result == 0 && !(flags & 0x100)
      && ((((st->st_mode)) & 0170000) == (0020000)))
    {
      ...
      if (stdin_rdev_status == 0)
        {
          ...
          if (stat ("/dev/stdin", &stdin_st) == 0 && ((((stdin_st.st_mode)) & 0170000) == (0020000))
      ...
      if (0 < stdin_rdev_status && gnu_dev_major (stdin_rdev) == gnu_dev_major (st->st_rdev))
...
punch_hole (int fd, off_t offset, off_t length)
{
  ...
  ret = fallocate (fd, 0x02 | 0x01,
                   offset, length);
  if (ret < 0 && (is_ENOTSUP ((*__errno_location ())) || (*__errno_location ()) == 38))
    ret = 0;
...
create_hole (int fd, char const *name, _Bool punch_holes, off_t size)
{
  ...
  if (file_end < 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot lseek %s"), quotearg_style (shell_escape_always_quoting_style, name));
      return 0;
    }
  ...
  if (punch_holes && punch_hole (fd, file_end - size, size) < 0)
    {
      error (0, (*__errno_location ()), gettext ("error deallocating %s"), quotearg_style (shell_escape_always_quoting_style, name));
      return 0;
    }
...
sparse_copy (int src_fd, int dest_fd, char *buf, size_t buf_size,
             size_t hole_size, _Bool punch_holes,
             ...
             _Bool *last_write_made_hole)
{
  ...
  *total_n_read = 0;
  ...
  while (max_n_read)
    {
      ssize_t n_read = read (src_fd, buf, (((max_n_read)<(buf_size))?(max_n_read):(buf_size)));
      if (n_read < 0)
        {
          if ((*__errno_location ()) == 4)
            continue;
          error (0, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, src_name));
          return 0;
        }
      if (n_read == 0)
        break;
              ...
              if (! prev_hole)
                {
                  if (full_write (dest_fd, pbuf, psize) != psize)
                    {
                      error (0, (*__errno_location ()), gettext ("error writing %s"),
...
clone_file (int dest_fd, int src_fd)
{
  ...
  return ioctl (dest_fd, (((1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((9)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), src_fd);
             ...
             _Bool *require_normal_copy)
{
  ...
  *require_normal_copy = 0;
  _Bool wrote_hole_at_eof = 1;
  do
    {
      _Bool ok = extent_scan_read (&scan);
      if (! ok)
        {
          ...
          if (scan.initial_scan_failed)
            {
              *require_normal_copy = 1;
              return 0;
            }

          error (0, (*__errno_location ()), gettext ("%s: failed to get extents info"),
                 quotearg_n_style_colon (0, shell_escape_quoting_style, src_name));
          return 0;
        }

      _Bool empty_extent = 0;
          ...
          if (ext_hole_size)
            {
              if (lseek (src_fd, ext_start, 0) < 0)
                {
                  error (0, (*__errno_location ()), gettext ("cannot lseek %s"), quotearg_style (shell_escape_always_quoting_style, src_name));
                fail:
              ...
              if ((empty_extent && sparse_mode == SPARSE_ALWAYS)
              ...
              else
                {
                  ...
                  if (empty_extent)
                    nzeros = (((src_total_size - dest_pos)<(ext_hole_size))?(src_total_size - dest_pos):(ext_hole_size));

                  if (! write_zeros (dest_fd, nzeros))
                    {
                      error (0, (*__errno_location ()), gettext ("%s: write failed"),
                             quotearg_n_style_colon (0, shell_escape_quoting_style, dst_name));
                      goto fail;
                    }

                  dest_pos = (((src_total_size)<(ext_start))?(src_total_size):(ext_start));
                }
            }
          ...
          if (0 && (scan.ext_info[i].ext_flags & 0x00000800))
          ...
          else
            {
              ...
              if ( ! sparse_copy (src_fd, dest_fd, buf, buf_size,
                                  ...
                                  1, src_name, dst_name, ext_len, &n_read,
                                  &read_hole))
                goto fail;
...
# 593 "copy.c"
  if ((dest_pos < src_total_size || wrote_hole_at_eof)
    ...
    {
      error (0, (*__errno_location ()), gettext ("failed to extend %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
      return 0;
    }
  ...
  if (sparse_mode == SPARSE_ALWAYS && dest_pos < src_total_size
    ...
    {
      error (0, (*__errno_location ()), gettext ("error deallocating %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
      return 0;
    }
  ...
  if (name_space == ((void*)0))
    {
      ...
      error (0, (*__errno_location ()), gettext ("cannot access %s"), quotearg_style (shell_escape_always_quoting_style, src_name_in));
      return 0;
    }
      ...
      if ((0
          ...
          && qset_acl (dst_name, dest_desc, restrictive_temp_mode) != 0)
        {
          if (! owner_failure_ok (x))
            error (0, (*__errno_location ()), gettext ("clearing permissions for %s"),
                   quotearg_style (shell_escape_always_quoting_style, dst_name));
...
set_process_security_ctx (char const *src_name, char const *dst_name,
                          mode_t mode, _Bool new_dst, const struct cp_options *x)
{
      ...
      if (0 <= lgetfilecon (src_name, &con))
        {
          if (setfscreatecon (con) < 0)
            {
              if (all_errors || (some_errors && !errno_unsupported ((*__errno_location ()))))
...
# 988 "copy.c"
_Bool
set_file_security_ctx (char const *dst_name, _Bool process_local,
                       _Bool recurse, const struct cp_options *x)
{
  _Bool all_errors = (!x->data_copy_required
  ...
  if (! restorecon (dst_name, recurse, process_local))
    {
      if (all_errors || (some_errors && !errno_unsupported ((*__errno_location ()))))
        error (0, (*__errno_location ()), gettext ("failed to set the security context of %s"),
          ...
          struct stat const *src_sb)
{
  ...
  if (source_desc < 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot open %s for reading"), quotearg_style (shell_escape_always_quoting_style, src_name));
      return 0;
    }

  if (fstat (source_desc, &src_open_sb) != 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, src_name));
      return_val = 0;
      goto close_src_desc;
    }
  ...
  if (! *new_dst)
    {
      int open_flags =
        01 | 0 | (x->data_copy_required ? 01000 : 0);
      ...
      if (dest_desc < 0 && x->unlink_dest_after_failed_open)
        {
          if (unlink (dst_name) != 0)
            {
              error (0, (*__errno_location ()), gettext ("cannot remove %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
              return_val = 0;
              goto close_src_desc;
            }
          if (x->verbose)
...
# 1171 "copy.c"
  ...
  if (dest_desc < 0)
    {
# 1216 "copy.c"
      if (dest_errno == 2 && ! *new_dst && ! x->move_mode)
        {
          *new_dst = 1;
  ...
  if (fstat (dest_desc, &sb) != 0)
    {
      error (0, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
      return_val = 0;
      goto close_src_and_dst_desc;
    }
  ...
  if (data_copy_required && x->reflink_mode)
    {
      _Bool clone_ok = clone_file (dest_desc, source_desc) == 0;
  ...
  if (data_copy_required)
    {
      ...
      size_t hole_size = ((0 < (sb).st_blksize && (sb).st_blksize <= ((size_t)-1) / 8 + 1) ? (sb).st_blksize : 512);

      fdadvise (source_desc, 0, 0, FADVISE_SEQUENTIAL);


      _Bool make_holes = 0;
      _Bool sparse_src = is_probably_sparse (&src_open_sb);
      ...
      if (! make_holes)
        {
          ...
          size_t blcm_max = ((((18446744073709551615UL))<(9223372036854775807L))?((18446744073709551615UL)):(9223372036854775807L)) - buf_alignment;
...
preserve_metadata:
  if (x->preserve_timestamps)
    {
      ...
      if (fdutimens (dest_desc, dst_name, timespec) != 0)
        {
          error (0, (*__errno_location ()), gettext ("preserving times for %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
          if (x->require_preserve)
            {
              return_val = 0;
              goto close_src_and_dst_desc;
  ...
  if (x->preserve_xattr)
    {
      _Bool access_changed = 0;

      if (!(sb.st_mode & 0200) && geteuid () != 0)
        {
  ...
  if (x->preserve_mode || x->move_mode)
    ...
    {
      if (set_acl (dst_name, dest_desc, (0400 | 0200 | (0400 >> 3) | (0200 >> 3) | ((0400 >> 3) >> 3) | ((0200 >> 3) >> 3)) & ~cached_umask ()) != 0)
        return_val = 0;
    }
...
close_src_and_dst_desc:
  if (close (dest_desc) < 0)
    {
      error (0, (*__errno_location ()), gettext ("failed to close %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
      return_val = 0;
    }
close_src_desc:
  if (close (source_desc) < 0)
    {
      error (0, (*__errno_location ()), gettext ("failed to close %s"), quotearg_style (shell_escape_always_quoting_style, src_name));
      return_val = 0;
    }
  ...
  if (x->dereference == DEREF_NEVER)
    {
      ...
      if (((((src_sb->st_mode)) & 0170000) == (0120000)) && ((((dst_sb->st_mode)) & 0170000) == (0120000)))
        {
          _Bool sn = same_name (src_name, dst_name);
          if ( ! sn)
            {
...
# 1651 "copy.c"
  if (x->move_mode
      ...
      && 1 < dst_sb_link->st_nlink)
    {
      ...
      if (abs_src)
        {
          _Bool result = ! same_name (abs_src, dst_name);
          free (abs_src);
          return result;
        }
    }
...
abandon_move (const struct cp_options *x,
              ...
              struct stat const *dst_sb)
{
  ((void) sizeof ((x->move_mode) ? 1 : 0), __extension__ ({ if (x->move_mode) ; else __assert_fail ("x->move_mode", "copy.c", 1780, __extension__ __PRETTY_FUNCTION__); }));
...
restore_default_fscreatecon_or_die (void)
{
  if (setfscreatecon (((void*)0)) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to restore the default file creation context\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to restore the default file creation context")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to restore the default file creation context")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
{
  int err = force_linkat (-100, src_name, -100, dst_name,
                          dereference ? 0x400 : 0,
                          replace, -1);
  if (0 < err)
    {
               ...
               _Bool *rename_succeeded)
{
  ...
  *copy_into_self = 0;
  ...
  if (x->move_mode)
    {
      if (rename_errno < 0)
        rename_errno = (renameatu (-100, src_name, -100, dst_name,
                                   (1 << 0))
                        ? (*__errno_location ()) : 0);
  ...
  if (rename_errno == 0
      ...
      : rename_errno != 17 || x->interactive != I_ALWAYS_NO)
    {
      ...
      int fstatat_flags
        = x->dereference == DEREF_NEVER ? 0x100 : 0;
      if (follow_fstatat (-100, name, &src_sb, fstatat_flags) != 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot stat %s"), quotearg_style (shell_escape_always_quoting_style, name));
          return 0;
        }
      ...
      if (! (rename_errno == 17 && x->interactive == I_ALWAYS_NO))
        {
          ...
          if (follow_fstatat (-100, dst_name, &dst_sb, fstatat_flags) == 0)
            {
          ...
          else
            {
              if ((*__errno_location ()) == 40 && x->unlink_dest_after_failed_open)
                ...
                {
                  error (0, (*__errno_location ()), gettext ("cannot stat %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
                  return 0;
                }
              else
                new_dst = 1;
                  ...
                  if (earlier_file)
                    {
                      ...
                      if (! create_hard_link (earlier_file, dst_name, 1,
...
# 2118 "copy.c"
          ...
          if (x->backup_type != no_backups
              ...
              && (x->move_mode || ! ((((dst_sb.st_mode)) & 0170000) == (0040000))))
            {
              ...
              char *tmp_backup = backup_file_rename (-100, dst_name,
                                                     x->backup_type);
              ...
              if (tmp_backup)
                {
                  do { dst_backup = (__extension__ ({ const char *__old = (tmp_backup); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); })); } while (0);
                  free (tmp_backup);
                }
              else if ((*__errno_location ()) != 2)
                {
                  error (0, (*__errno_location ()), gettext ("cannot backup %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
                  return 0;
                }
              new_dst = 1;
            }
...
# 2303 "copy.c"
          ...
          if (same_name (src_name, earlier_file))
          ...
          else
            {
              error (0, 0, gettext ("will not create hard link %s to directory %s"),
                     quotearg_n_style (0, shell_escape_always_quoting_style, dst_name), quotearg_n_style (1, shell_escape_always_quoting_style, earlier_file));
              goto un_backup;
            }
        }
      else
        {
          if (! create_hard_link (earlier_file, dst_name, 1, x->verbose,
                                  dereference))
            goto un_backup;
  ...
  if (x->move_mode)
    {
      if (rename_errno == 17)
        rename_errno = rename (src_name, dst_name) == 0 ? 0 : (*__errno_location ());
          ...
          if (x->set_security_context)
            {
              ...
              (void) set_file_security_ctx (dst_name, 0, 1, x);
            }
...
# 2478 "copy.c"
      ...
      if ((((((src_mode)) & 0170000) == (0040000)) ? rmdir (dst_name) : unlink (dst_name)) != 0
          && (*__errno_location ()) != 2)
        {
          error (0, (*__errno_location ()),
  ...
  if (((((src_mode)) & 0170000) == (0040000)))
      ...
      if (new_dst || !((((dst_sb.st_mode)) & 0170000) == (0040000)))
        {
          ...
          if (lstat (dst_name, &dst_sb) != 0)
          ...
          else if ((dst_sb.st_mode & (0400|0200|0100)) != (0400|0200|0100))
            {
              ...
              if (lchmod (dst_name, dst_mode | (0400|0200|0100)) != 0)
                {
  ...
  else if (x->symbolic_link)
    {
      ...
      int err = force_symlinkat (src_name, -100, dst_name,
...
# 2694 "copy.c"
           ...
           && !(! 1 && ((((src_mode)) & 0170000) == (0120000))
                && x->dereference == DEREF_NEVER))
    {
      _Bool replace = (x->unlink_dest_after_failed_open
                      || x->interactive == I_ASK_USER);
      if (! create_hard_link (src_name, dst_name, replace, 0, dereference))
        goto un_backup;
    }
           ...
           || (x->copy_as_regular && !((((src_mode)) & 0170000) == (0120000))))
    {
      copied_as_regular = 1;
# 2716 "copy.c"
      if (! copy_reg (src_name, dst_name, x, dst_mode_bits & ((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)),
  ...
  else if (((((src_mode)) & 0170000) == (0010000)))
    {
      ...
      if (mknod (dst_name, src_mode & ~omitted_permissions, 0) != 0)
        if (mkfifo (dst_name, src_mode & ~0010000 & ~omitted_permissions) != 0)
          {
            error (0, (*__errno_location ()), gettext ("cannot create fifo %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
            goto un_backup;
          }
    }
  ...
  else if (((((src_mode)) & 0170000) == (0120000)))
    {
      ...
      if (src_link_val == ((void*)0))
        {
          error (0, (*__errno_location ()), gettext ("cannot read symbolic link %s"),
                 quotearg_style (shell_escape_always_quoting_style, src_name));
          goto un_backup;
        }

      int symlink_err = force_symlinkat (src_link_val, -100, dst_name,
                                         x->unlink_dest_after_failed_open, -1);
      if (0 < symlink_err && x->update && !new_dst && ((((dst_sb.st_mode)) & 0170000) == (0120000))
  ...
  if (!new_dst && !x->copy_as_regular && !((((src_mode)) & 0170000) == (0040000))
...
# 2855 "copy.c"
  ...
  if (x->preserve_mode || x->move_mode)
    ...
    {
      int default_permissions = ((((src_mode)) & 0170000) == (0040000)) || ((((src_mode)) & 0170000) == (0140000))
                                ? ((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) : (0400 | 0200 | (0400 >> 3) | (0200 >> 3) | ((0400 >> 3) >> 3) | ((0200 >> 3) >> 3));
  ...
  if (dst_backup)
    {
      if (rename (dst_backup, dst_name) != 0)
        error (0, (*__errno_location ()), gettext ("cannot un-backup %s"), quotearg_style (shell_escape_always_quoting_style, dst_name));
      else
        {
          if (x->verbose)
...
{
  ((void) sizeof ((co != ((void*)0)) ? 1 : 0), __extension__ ({ if (co != ((void*)0)) ; else __assert_fail ("co != NULL", "copy.c", 2986, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((((unsigned int) (co->backup_type) <= numbered_backups)) ? 1 : 0), __extension__ ({ if (((unsigned int) (co->backup_type) <= numbered_backups)) ; else __assert_fail ("VALID_BACKUP_TYPE (co->backup_type)", "copy.c", 2987, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((((co->sparse_mode) == SPARSE_NEVER || (co->sparse_mode) == SPARSE_AUTO || (co->sparse_mode) == SPARSE_ALWAYS)) ? 1 : 0), __extension__ ({ if (((co->sparse_mode) == SPARSE_NEVER || (co->sparse_mode) == SPARSE_AUTO || (co->sparse_mode) == SPARSE_ALWAYS)) ; else __assert_fail ("VALID_SPARSE_MODE (co->sparse_mode)", "copy.c", 2988, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((((co->reflink_mode) == REFLINK_NEVER || (co->reflink_mode) == REFLINK_AUTO || (co->reflink_mode) == REFLINK_ALWAYS)) ? 1 : 0), __extension__ ({ if (((co->reflink_mode) == REFLINK_NEVER || (co->reflink_mode) == REFLINK_AUTO || (co->reflink_mode) == REFLINK_ALWAYS)) ; else __assert_fail ("VALID_REFLINK_MODE (co->reflink_mode)", "copy.c", 2989, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((!(co->hard_link && co->symbolic_link)) ? 1 : 0), __extension__ ({ if (!(co->hard_link && co->symbolic_link)) ; else __assert_fail ("!(co->hard_link && co->symbolic_link)", "copy.c", 2990, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((! (co->reflink_mode == REFLINK_ALWAYS && co->sparse_mode != SPARSE_AUTO)) ? 1 : 0), __extension__ ({ if (! (co->reflink_mode == REFLINK_ALWAYS && co->sparse_mode != SPARSE_AUTO)) ; else __assert_fail ("! (co->reflink_mode == REFLINK_ALWAYS && co->sparse_mode != SPARSE_AUTO)", "copy.c", 2993, __extension__ __PRETTY_FUNCTION__); }));
...
copy (char const *src_name, char const *dst_name,
      ...
      _Bool *copy_into_self, _Bool *rename_succeeded)
{
  ((void) sizeof ((valid_options (options)) ? 1 : 0), __extension__ ({ if (valid_options (options)) ; else __assert_fail ("valid_options (options)", "copy.c", 3011, __extension__ __PRETTY_FUNCTION__); }));
# 3020 "copy.c"
  top_level_src_name = src_name;
  top_level_dst_name = dst_name;

  _Bool first_dir_created_per_command_line_arg = 0;
  return copy_internal (src_name, dst_name, nonexistent_dst, ((void*)0), ((void*)0),
                        options, 1,
                        &first_dir_created_per_command_line_arg,
