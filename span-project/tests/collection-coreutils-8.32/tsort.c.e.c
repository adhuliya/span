...
static struct item *head = ((void*)0);


static struct item *zeros = ((void*)0);


static struct item *loop = ((void*)0);
...
new_item (const char *str)
{
  ...
  k->str = (str ? xstrdup (str): ((void*)0));
  k->left = k->right = ((void*)0);
  k->balance = 0;
...
search_item (struct item *root, const char *str)
{
  ...
  ((void) sizeof ((root) ? 1 : 0), __extension__ ({ if (root) ; else __assert_fail ("root", "tsort.c", 132, __extension__ __PRETTY_FUNCTION__); }));
      ...
      if (q == ((void*)0))
        {
          ...
          ((void) sizeof ((!(strcmp (str, s->str) == 0)) ? 1 : 0), __extension__ ({ if (!(strcmp (str, s->str) == 0)) ; else __assert_fail ("!STREQ (str, s->str)", "tsort.c", 168, __extension__ __PRETTY_FUNCTION__); }));
          ...
          while (p != q)
            {
              ((void) sizeof ((!(strcmp (str, p->str) == 0)) ? 1 : 0), __extension__ ({ if (!(strcmp (str, p->str) == 0)) ; else __assert_fail ("!STREQ (str, p->str)", "tsort.c", 182, __extension__ __PRETTY_FUNCTION__); }));
...
static _Bool
count_items (struct item *unused __attribute__ ((__unused__)))
{
  n_strings++;
  return 0;
}
...
static _Bool
recurse_tree (struct item *root, _Bool (*action) (struct item *))
{
...
static void
walk_tree (struct item *root, _Bool (*action) (struct item *))
{
  if (root->right)
...
tsort (const char *file)
{
  _Bool ok = 1;
  struct item *root;
  struct item *j = ((void*)0);
  struct item *k = ((void*)0);
  token_buffer tokenbuffer;
  _Bool is_stdin = (strcmp (file, "-") == 0);


  root = new_item (((void*)0));

  if (!is_stdin && ! freopen_safer (file, "r", stdin))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  while (1)
    {
      ...
      size_t len = readtoken (stdin, " \t\n", sizeof (" \t\n") - 1, &tokenbuffer);
      if (len == (size_t) -1)
        break;

      ((void) sizeof ((len != 0) ? 1 : 0), __extension__ ({ if (len != 0) ; else __assert_fail ("len != 0", "tsort.c", 461, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (k != ((void*)0))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: input contains an odd number of tokens\"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: input contains an odd number of tokens"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: input contains an odd number of tokens"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (n_strings > 0)
        {
          ...
          error (0, 0, gettext ("%s: input contains a loop:"), quotearg_n_style_colon (0, shell_escape_quoting_style, file));
          ok = 0;
  ...
  if (rpl_fclose (stdin) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", is_stdin ? gettext (\"standard input\") : quotearg_n_style_colon (0, shell_escape_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", is_stdin ? gettext ("standard input") : quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", is_stdin ? gettext ("standard input") : quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
