...
# 21 "../lib/sys/types.h" 3
# 44 "cksum.c" 2
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stdint.h" 1 3
# 52 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stdint.h" 3
...
# 53 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stdint.h" 2 3
# 45 "cksum.c" 2
# 1 "./system.h" 1
# 19 "./system.h"
# 1 "../lib/alloca.h" 1
...
static _Bool
cksum (const char *file, _Bool print_name)
{
  ...
  while ((bytes_read = fread_unlocked (buf,1,(1 << 16),fp)) > 0)
    {
      ...
      if (length + bytes_read < length)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: file too long\"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: file too long"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: file too long"), quotearg_n_style_colon (0, shell_escape_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      length += bytes_read;
      while (bytes_read--)
  ...
  if (!(strcmp (file, "-") == 0) && rpl_fclose (fp) == (-1))
    {
      error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, file));
      return 0;
    }
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("Print CRC checksum and byte counts of each FILE.\n\n"),stdout);
...
main (int argc, char **argv)
{
  ...
  parse_gnu_standard_options_only (argc, argv, "cksum", "coreutils", Version,
                                   1, usage, ("Q. Frank Xia"), (char const *) ((void*)0));
