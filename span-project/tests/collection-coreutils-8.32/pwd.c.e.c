                ...
                size_t parent_height)
{
  ...
  dirp = opendir ("..");
  if (dirp == ((void*)0))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot open directory %s\"), quote (nth_parent (parent_height))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot open directory %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot open directory %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))));


  fd = dirfd (dirp);
  if ((0 <= fd ? fchdir (fd) : chdir ("..")) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to chdir to %s\"), quote (nth_parent (parent_height))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to chdir to %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to chdir to %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if ((0 <= fd ? fstat (fd, &parent_sb) : stat (".", &parent_sb)) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to stat %s\"), quote (nth_parent (parent_height))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to stat %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to stat %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (dirp == ((void*)0) || closedir (dirp) != 0)
    {
      ...
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"reading directory %s\"), quote (nth_parent (parent_height))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("reading directory %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("reading directory %s"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))));

    }

  if ( ! found)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"couldn't find directory entry in %s with matching i-node\"), quote (nth_parent (parent_height))), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("couldn't find directory entry in %s with matching i-node"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("couldn't find directory entry in %s with matching i-node"), quote (nth_parent (parent_height))), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "pwd", "GNU coreutils", Version, ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;
