...
# 108 "uptime.c"
  ...
  if (uptime == 0)
    ...
    {
      if (boot_time == 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"couldn't get boot time\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("couldn't get boot time")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("couldn't get boot time")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
main (int argc, char **argv)
{
  ...
  parse_gnu_standard_options_only (argc, argv, "uptime", "GNU coreutils",
                                   Version, 1, usage, ("Joseph Arceneaux"), ("David MacKenzie"), ("Kaveh Ghazi"),
                                   (char const *) ((void*)0));
