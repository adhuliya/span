...
# 774 "./system.h" 2
# 27 "dd.c" 2
# 1 "../lib/close-stream.h" 1
# 1 "../lib/stdio.h" 1
# 21 "../lib/stdio.h" 3
# 2 "../lib/close-stream.h" 2
...
_Static_assert (O_FULLBLOCK != 0, "verify (" "O_FULLBLOCK != 0" ")");
_Static_assert (O_NOCACHE != 0, "verify (" "O_NOCACHE != 0" ")");
_Static_assert (O_COUNT_BYTES != 0, "verify (" "O_COUNT_BYTES != 0" ")");
_Static_assert (O_SKIP_BYTES != 0, "verify (" "O_SKIP_BYTES != 0" ")");
_Static_assert (O_SEEK_BYTES != 0, "verify (" "O_SEEK_BYTES != 0" ")");




_Static_assert (! (((O_FULLBLOCK) & ((O_FULLBLOCK) - 1)) != 0), "verify (" "! MULTIPLE_BITS_SET (O_FULLBLOCK)" ")");
_Static_assert (! (((O_NOCACHE) & ((O_NOCACHE) - 1)) != 0), "verify (" "! MULTIPLE_BITS_SET (O_NOCACHE)" ")");
_Static_assert (! (((O_COUNT_BYTES) & ((O_COUNT_BYTES) - 1)) != 0), "verify (" "! MULTIPLE_BITS_SET (O_COUNT_BYTES)" ")");
_Static_assert (! (((O_SKIP_BYTES) & ((O_SKIP_BYTES) - 1)) != 0), "verify (" "! MULTIPLE_BITS_SET (O_SKIP_BYTES)" ")");
_Static_assert (! (((O_SEEK_BYTES) & ((O_SEEK_BYTES) - 1)) != 0), "verify (" "! MULTIPLE_BITS_SET (O_SEEK_BYTES)" ")");
...
# 609 "dd.c"
      fputs_unlocked (gettext ("  excl      fail if the output file already exists\n  nocreat   do not create the output file\n  notrunc   do not truncate the output file\n  noerror   continue after read errors\n  fdatasync  physically write output file data before finishing\n  fsync     likewise, but also write metadata\n"),stdout);
      ...
      if (0)
        fputs_unlocked (gettext ("  cio       use concurrent I/O for data\n"),stdout);
      if (040000)
      ...
      fputs_unlocked (gettext ("  fullblock  accumulate full blocks of input (iflag only)\n"),stdout);
      ...
      if (O_NOCACHE)
        fputs_unlocked (gettext ("  nocache   Request to drop cache.  See also oflag=sync\n"),stdout);
      ...
      if (O_COUNT_BYTES)
        fputs_unlocked (gettext ("  count_bytes  treat 'count=N' as a byte count (iflag only)\n"),stdout);

      if (O_SKIP_BYTES)
        fputs_unlocked (gettext ("  skip_bytes  treat 'skip=N' as a byte count (iflag only)\n"),stdout);

      if (O_SEEK_BYTES)
        fputs_unlocked (gettext ("  seek_bytes  treat 'seek=N' as a byte count (oflag only)\n"),stdout);
...
alloc_ibuf (void)
{
  ...
  char *real_buf = malloc (input_blocksize + (2 * 2 + 2 * page_size - 1));
  if (!real_buf)
    {
      uintmax_t ibs = input_blocksize;
      char hbuf[((2 * sizeof (uintmax_t) * 8 * 146 / 485 + 1) * (16 + 1) - 16 + 1 + 3) + 1];
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"memory exhausted by input buffer of size %\"\"l\" \"u\"\" bytes (%s)\"), ibs, human_readable (input_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("memory exhausted by input buffer of size %""l" "u"" bytes (%s)"), ibs, human_readable (input_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("memory exhausted by input buffer of size %""l" "u"" bytes (%s)"), ibs, human_readable (input_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (conversions_mask & C_TWOBUFS)
    {
      ...
      char *real_obuf = malloc (output_blocksize + (page_size - 1));
      if (!real_obuf)
        {
          uintmax_t obs = output_blocksize;
          char hbuf[((2 * sizeof (uintmax_t) * 8 * 146 / 485 + 1) * (16 + 1) - 16 + 1 + 3) + 1];
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"memory exhausted by output buffer of size %\"\"l\" \"u\" \" bytes (%s)\"), obs, human_readable (output_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("memory exhausted by output buffer of size %""l" "u" " bytes (%s)"), obs, human_readable (output_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("memory exhausted by output buffer of size %""l" "u" " bytes (%s)"), obs, human_readable (output_blocksize, hbuf, human_opts | human_base_1024, 1, 1)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
print_xfer_stats (xtime_t progress_time)
{
  ...
  char hbuf[3][((2 * sizeof (uintmax_t) * 8 * 146 / 485 + 1) * (16 + 1) - 16 + 1 + 3) + sizeof slash_s];
  double delta_s;
  ...
  int stats_len
    = (abbreviation_lacks_prefix (si)
       ? fprintf (stderr,
                  ngettext ("%""l" "u"" byte copied, %s, %s",
                            "%""l" "u"" bytes copied, %s, %s",
                            select_plural (w_bytes)),
                  w_bytes, delta_s_buf, bytes_per_second)
       : abbreviation_lacks_prefix (iec)
       ? fprintf (stderr,
                  gettext ("%""l" "u"" bytes (%s) copied, %s, %s"),
                  w_bytes, si, delta_s_buf, bytes_per_second)
       : fprintf (stderr,
                  gettext ("%""l" "u"" bytes (%s, %s) copied, %s, %s"),
...
print_stats (void)
{
  ...
  fprintf (stderr,
           gettext ("%""l" "u""+%""l" "u"" records in\n" "%""l" "u""+%""l" "u"" records out\n"),

           r_full, r_partial, w_full, w_partial);

  if (r_truncate != 0)
    fprintf (stderr,
             ngettext ("%""l" "u"" truncated record\n",
...
{
  if (iclose (0) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing input file %s\"), quotearg_style (shell_escape_always_quoting_style, input_file)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, (*__errno_location ()), gettext ("closing input file %s"), quotearg_style (shell_escape_always_quoting_style, input_file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, (*__errno_location ()), gettext ("closing input file %s"), quotearg_style (shell_escape_always_quoting_style, input_file)), ((0) ? (void) 0 : __builtin_unreachable ()))));




  if (iclose (1) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"closing output file %s\"), quotearg_style (shell_escape_always_quoting_style, output_file)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, (*__errno_location ()), gettext ("closing output file %s"), quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, (*__errno_location ()), gettext ("closing output file %s"), quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (0 < prev_nread && prev_nread < size)
        {
          ...
          if (status_level != STATUS_NONE)
            nl_error (0, 0, ngettext (("warning: partial read (%""l" "u"" byte); "
                                    "suggest iflag=fullblock"),
                                   ("warning: partial read (%""l" "u"" bytes); "
                                    "suggest iflag=fullblock"),
                                   select_plural (prev)),
                   prev);
          warn_partial_read = 0;
  ...
  if ((output_flags & 040000) && size < output_blocksize)
    {
      ...
      if (rpl_fcntl (1, 4, old_flags & ~040000) != 0
        ...
        nl_error (0, (*__errno_location ()), gettext ("failed to turn off O_DIRECT: %s"),
...
write_output (void)
{
  ...
  if (nwritten != output_blocksize)
    {
      nl_error (0, (*__errno_location ()), gettext ("writing to %s"), quotearg_style (shell_escape_always_quoting_style, output_file));
      if (nwritten != 0)
        w_partial++;
      quit (1);
    }
  ...
  if (e == LONGINT_INVALID_SUFFIX_CHAR && *suffix == 'x')
    {
      ...
      if (n == 0 && (strncmp (str, "0x", strlen ("0x")) == 0))
        nl_error (0, 0,
               gettext ("warning: %s is a zero multiplier; " "use %s if that is intended"),
...
scanargs (int argc, char *const *argv)
{
  ...
  for (int i = optind; i < argc; i++)
    {
      ...
      if (val == ((void*)0))
        {
          nl_error (0, 0, gettext ("unrecognized operand %s"),
                 quote (name));
          usage (1);
        }
      val++;
      ...
      if (operand_is (name, "if"))
        ...
        conversions_mask |= parse_symbols (val, conversions, 0,
                                           "invalid conversion");
      else if (operand_is (name, "iflag"))
        input_flags |= parse_symbols (val, flags, 0,
                                      "invalid input flag");
      else if (operand_is (name, "oflag"))
        output_flags |= parse_symbols (val, flags, 0,
                                       "invalid output flag");
      else if (operand_is (name, "status"))
        status_level = parse_symbols (val, statuses, 1,
      ...
      else
        {
          ...
          uintmax_t n_min = 0;
          uintmax_t n_max = (18446744073709551615UL);

          if (operand_is (name, "ibs"))
            {
              n_min = 1;
              n_max = ((((18446744073709551615UL) - ((2 * 2 + 2 * page_size - 1)))<((((9223372036854775807L)<(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))?(9223372036854775807L):(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))))?((18446744073709551615UL) - ((2 * 2 + 2 * page_size - 1))):((((9223372036854775807L)<(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))?(9223372036854775807L):(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))));
              input_blocksize = n;
            }
          else if (operand_is (name, "obs"))
            {
              n_min = 1;
              n_max = ((((18446744073709551615UL) - ((page_size - 1)))<((((9223372036854775807L)<(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))?(9223372036854775807L):(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))))?((18446744073709551615UL) - ((page_size - 1))):((((9223372036854775807L)<(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))?(9223372036854775807L):(((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))))));
              output_blocksize = n;
            }
  ...
  if (output_flags & O_FULLBLOCK)
    {
      nl_error (0, 0, "%s: %s", gettext ("invalid output flag"), quote ("fullblock"));
      usage (1);
    }

  if (input_flags & O_SEEK_BYTES)
    {
      nl_error (0, 0, "%s: %s", gettext ("invalid input flag"), quote ("seek_bytes"));
      usage (1);
    }

  if (output_flags & (O_COUNT_BYTES | O_SKIP_BYTES))
    {
      nl_error (0, 0, "%s: %s", gettext ("invalid output flag"),
  ...
  if (multiple_bits_set (conversions_mask & (C_ASCII | C_EBCDIC | C_IBM)))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine any two of {ascii,ebcdic,ibm}\")), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("cannot combine any two of {ascii,ebcdic,ibm}")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("cannot combine any two of {ascii,ebcdic,ibm}")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (multiple_bits_set (conversions_mask & (C_BLOCK | C_UNBLOCK)))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine block and unblock\")), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("cannot combine block and unblock")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("cannot combine block and unblock")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (multiple_bits_set (conversions_mask & (C_LCASE | C_UCASE)))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine lcase and ucase\")), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("cannot combine lcase and ucase")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("cannot combine lcase and ucase")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (multiple_bits_set (conversions_mask & (C_EXCL | C_NOCREAT)))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine excl and nocreat\")), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("cannot combine excl and nocreat")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("cannot combine excl and nocreat")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (multiple_bits_set (input_flags & (040000 | O_NOCACHE))
      || multiple_bits_set (output_flags & (040000 | O_NOCACHE)))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot combine direct and nocache\")), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("cannot combine direct and nocache")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("cannot combine direct and nocache")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
# 1789 "dd.c"
# 1 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 1 3 4
# 25 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 3 4
# 1 "../lib/sys/types.h" 1 3 4
# 21 "../lib/sys/types.h" 3
# 26 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 2 3 4
# 1 "../lib/sys/ioctl.h" 1 3 4
...
# 27 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 2 3 4
...
# 81 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 3 4
struct mtget
  {
    long int mt_type;
    long int mt_resid;
...
# 127 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 3 4
struct mt_tape_info
  {
    long int t_type;
    char *t_name;
  };
# 157 "/usr/include/x86_64-linux-gnu/sys/mtio.h" 3 4
struct mtpos
  {
    long int mt_blkno;
  };
...
skip_via_lseek (char const *filename, int fdesc, off_t offset, int whence)
{
  ...
  if (0 <= new_position
    ...
    {
      if (status_level != STATUS_NONE)
        nl_error (0, 0, gettext ("warning: working around lseek kernel bug for file " "(%s)\n  of mt_type=0x%0lx -- " "see <sys/mtio.h> for the list of types"),
      ...
      size_t *bytes)
{
  ...
  (*__errno_location ()) = 0;
  if (records <= ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))) / blocksize
      ...
      if (fdesc == 0)
        {
           struct stat st;
           if (ifstat (0, &st) != 0)
             ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot fstat %s\"), quotearg_style (shell_escape_always_quoting_style, file)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  else
    {
      ...
      if ((skip_via_lseek (file, fdesc, 0, 2)) >= 0)
        {
          ...
          if (fdesc == 0)
            nl_error (0, lseek_errno, gettext ("%s: cannot skip"), quotearg_n_style_colon (0, shell_escape_quoting_style, file));
          else
            nl_error (0, lseek_errno, gettext ("%s: cannot seek"), quotearg_n_style_colon (0, shell_escape_quoting_style, file));
          ...
          if (nread < 0)
            {
              if (fdesc == 0)
                {
                  nl_error (0, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, file));
...
advance_input_after_read_error (size_t nbytes)
{
  if (! input_seekable)
  ...
  else
    {
      ...
      input_offset_overflow |= (((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))) < input_offset);
  ...
  nl_error (0, (*__errno_location ()), gettext ("%s: cannot seek"), quotearg_n_style_colon (0, shell_escape_quoting_style, input_file));
  return 0;
}
  ...
  if (add_flags)
    {
      ...
      if (!ok)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"setting flags for %s\"), quotearg_style (shell_escape_always_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, (*__errno_location ()), gettext ("setting flags for %s"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, (*__errno_location ()), gettext ("setting flags for %s"), quotearg_style (shell_escape_always_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
}
...
# 2165 "dd.c"
  if (skip_records != 0 || skip_bytes != 0)
    {
      uintmax_t us_bytes = input_offset + (skip_records * input_blocksize)
                           + skip_bytes;
      uintmax_t us_blocks = skip (0, input_file,
      ...
      if ((us_blocks || (!input_offset_overflow && us_bytes))
        ...
        {
          nl_error (0, 0,
                 gettext ("%s: cannot skip to specified offset"), quotearg_n_style_colon (0, shell_escape_quoting_style, input_file));
        }
    }
      ...
      if (nread > 0)
      ...
      else
        {
          if (!(conversions_mask & C_NOERROR) || status_level != STATUS_NONE)
            nl_error (0, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, input_file));
      ...
      if (ibuf == obuf)
        {
          ...
          if (nwritten != n_bytes_read)
            {
              nl_error (0, (*__errno_location ()), gettext ("error writing %s"), quotearg_style (shell_escape_always_quoting_style, output_file));
              return 1;
            }
  ...
  if (final_op_was_seek)
    {
      ...
      if (ifstat (1, &stdout_stat) != 0)
        {
          nl_error (0, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, output_file));
          return 1;
        }
      if (((((stdout_stat.st_mode)) & 0170000) == (0100000)) || ((&stdout_stat)->st_mode - (&stdout_stat)->st_mode))
        {
              ...
              if (iftruncate (1, output_offset) != 0)
                {
                  nl_error (0, (*__errno_location ()),
                         gettext ("failed to truncate to %" "l" "d" " bytes" " in output file %s"),

                         (intmax_t) output_offset, quotearg_style (shell_escape_always_quoting_style, output_file));
                  return 1;
                }
            }
        }
  ...
  if ((conversions_mask & C_FDATASYNC) && ifdatasync (1) != 0)
    {
      if ((*__errno_location ()) != 38 && (*__errno_location ()) != 22)
        {
          nl_error (0, (*__errno_location ()), gettext ("fdatasync failed for %s"), quotearg_style (shell_escape_always_quoting_style, output_file));
          exit_status = 1;
        }
      conversions_mask |= C_FSYNC;
    }

  if ((conversions_mask & C_FSYNC) && ifsync (1) != 0)
    {
      nl_error (0, (*__errno_location ()), gettext ("fsync failed for %s"), quotearg_style (shell_escape_always_quoting_style, output_file));
      return 1;
    }
...
main (int argc, char **argv)
{
  ...
  parse_gnu_standard_options_only (argc, argv, "dd", "coreutils", Version,
                                   1, usage, ("Paul Rubin"), ("David MacKenzie"), ("Stuart Kemp"), (char const *) ((void*)0));
  ...
  if (output_file == ((void*)0))
  ...
  else
    {
      ...
      if ((! seek_records
           || ifd_reopen (1, output_file, 02 | opts, perms) < 0)
          && (ifd_reopen (1, output_file, 01 | opts, perms)
              < 0))
      ...
      if (seek_records != 0 && !(conversions_mask & C_NOTRUNC))
        {
          ...
          if (((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))) / output_blocksize < seek_records)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"offset too large: \" \"cannot truncate to a length of seek=%\"\"l\" \"u\"\"\" \" (%lu-byte) blocks\"), seek_records, obs), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, 0, gettext ("offset too large: " "cannot truncate to a length of seek=%""l" "u""" " (%lu-byte) blocks"), seek_records, obs), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, 0, gettext ("offset too large: " "cannot truncate to a length of seek=%""l" "u""" " (%lu-byte) blocks"), seek_records, obs), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          if (iftruncate (1, size) != 0)
            {
              ...
              struct stat stdout_stat;
              if (ifstat (1, &stdout_stat) != 0)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot fstat %s\"), quotearg_style (shell_escape_always_quoting_style, output_file)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))));

              if (((((stdout_stat.st_mode)) & 0170000) == (0100000))
                  || ((((stdout_stat.st_mode)) & 0170000) == (0040000))
                  || ((&stdout_stat)->st_mode - (&stdout_stat)->st_mode))
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, ftruncate_errno, gettext (\"failed to truncate to %\"\"l\" \"u\"\" bytes\" \" in output file %s\"), size, quotearg_style (shell_escape_always_quoting_style, output_file)), assume (false))" ")"); int _gl_dummy; })) ? ((nl_error (1, ftruncate_errno, gettext ("failed to truncate to %""l" "u"" bytes" " in output file %s"), size, quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((nl_error (1, ftruncate_errno, gettext ("failed to truncate to %""l" "u"" bytes" " in output file %s"), size, quotearg_style (shell_escape_always_quoting_style, output_file)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (max_records == 0 && max_bytes == 0)
    {
      ...
      if (i_nocache && !invalidate_cache (0, 0))
        {
          nl_error (0, (*__errno_location ()), gettext ("failed to discard cache for: %s"),
