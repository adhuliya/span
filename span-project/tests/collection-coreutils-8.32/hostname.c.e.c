...
main (int argc, char **argv)
{
  ...
  parse_gnu_standard_options_only (argc, argv, "hostname", "GNU coreutils",
                                   Version, 1, usage, ("Jim Meyering"),
                                   (char const *) ((void*)0));
  ...
  if (argc == optind + 1)
    {
      ...
      if (sethostname (name, strlen (name)) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot set name to %s\"), quote (name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot set name to %s"), quote (name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot set name to %s"), quote (name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (argc <= optind)
    {
      ...
      if (hostname == ((void*)0))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot determine hostname\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot determine hostname")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot determine hostname")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      printf ("%s\n", hostname);
    }
