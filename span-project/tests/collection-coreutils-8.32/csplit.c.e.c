...
# 538 "../lib/regex.h"
extern const char *rpl_re_compile_pattern (const char *__pattern, size_t __length,
...
extern size_t rpl_regerror (int __errcode, const regex_t *__restrict __preg,
...
static void delete_all_files (_Bool);
static void save_line_to_file (const struct cstring *line);


static struct buffer_record *head = ((void*)0);


static char *hold_area = ((void*)0);
...
static _Bool have_read_eof = 0;


static char *volatile filename_space = ((void*)0);


static char const *volatile prefix = ((void*)0);


static char *volatile suffix = ((void*)0);
...
static FILE *output_stream = ((void*)0);


static char *output_filename = ((void*)0);
...
static struct option const longopts[] =
{
  ...
  {"quiet", 0, ((void*)0), 'q'},
  {"silent", 0, ((void*)0), 's'},
  {"keep-files", 0, ((void*)0), 'k'},
  {"elide-empty-files", 0, ((void*)0), 'z'},
  {"prefix", 1, ((void*)0), 'f'},
  {"suffix-format", 1, ((void*)0), 'b'},
  {"suppress-matched", 0, ((void*)0), SUPPRESS_MATCHED_OPTION},
...
static void cleanup_fatal (void) __attribute__ ((__noreturn__));
static void
cleanup_fatal (void)
{
  cleanup ();
...
read_input (char *dest, size_t max_n_bytes)
{
  ...
  bytes_read = safe_read (0, dest, max_n_bytes);
...
get_new_buffer (size_t min_size)
{
  ...
  if (alloc_size < min_size)
    {
      size_t s = min_size - alloc_size + 2048 - 1;
      alloc_size += s - s % 2048;
    }
  ...
  while (1)
    {
      ...
      if (((size_t) ((9223372036854775807L) < (18446744073709551615UL) ? (9223372036854775807L) : (18446744073709551615UL) - 1) / (b->bytes_alloc) < (2)))
        xalloc_die ();
...
get_first_line_in_buffer (void)
{
  if (head == ((void*)0) && !load_buffer ())
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"input disappeared\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("input disappeared")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("input disappeared")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
remove_line (void)
{
  ...
  static struct buffer_record *prev_buf = ((void*)0);
  ...
  if (++l->retrieve_index == l->used)
    {
      ...
      if (head->curr_line == ((void*)0) || head->curr_line->used == 0)
        {
...
find_line (uintmax_t linenum)
{
  ...
  for (b = head;;)
    {
      ((void) sizeof ((b) ? 1 : 0), __extension__ ({ if (b) ; else __assert_fail ("b", "csplit.c", 618, __extension__ __PRETTY_FUNCTION__); }));
...
static void
write_to_file (uintmax_t last_line, _Bool ignore, int argnum)
{
  struct cstring *line;
  ...
  if (first_line > last_line)
    {
      error (0, 0, gettext ("%s: line number out of range"),
...
static void regexp_error (struct control *, uintmax_t, _Bool) __attribute__ ((__noreturn__));
static void
regexp_error (struct control *p, uintmax_t repetition, _Bool ignore)
{
      ...
      while (1)
        {
          ...
          if (line->str[line_len - 1] == '\n')
            line_len--;
          ret = rpl_re_search (&p->re_compiled, line->str, line_len,
                           0, line_len, ((void*)0));
          if (ret == -2)
            {
...
create_output_file (void)
{
  ...
  if (files_created == (2147483647 *2U +1U))
    {
      fopen_ok = 0;
      fopen_errno = 75;
    }
  ...
  if (! fopen_ok)
    {
      error (0, fopen_errno, "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, output_filename));
      cleanup_fatal ();
    }
  bytes_written = 0;
}
...
static void
delete_all_files (_Bool in_signal_handler)
{
  if (! remove_files)
    return;
  ...
  if (output_stream)
    {
      ...
      if (rpl_fclose (output_stream) != 0)
        {
          error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, output_filename));
          output_stream = ((void*)0);
          cleanup_fatal ();
        }
...
{
  size_t l = fwrite_unlocked (line->str,sizeof (char),line->len,output_stream);
  if (l != line->len)
    {
      error (0, (*__errno_location ()), gettext ("write error for %s"), quotearg_style (shell_escape_always_quoting_style, output_filename));
      output_stream = ((void*)0);
      cleanup_fatal ();
    }
...
{
  static size_t control_allocated = 0;
  struct control *p;

  if (control_used == control_allocated)
    controls = ((!!sizeof (struct { _Static_assert (sizeof *(controls) != 1, "verify_expr (" "sizeof *(controls) != 1" ", " "x2nrealloc (controls, &control_allocated, sizeof *(controls))" ")"); int _gl_dummy; })) ? (x2nrealloc (controls, &control_allocated, sizeof *(controls))) : (x2nrealloc (controls, &control_allocated, sizeof *(controls))));
...
{
  if (xstrtoimax (num, ((void*)0), 10, &p->offset, "") != LONGINT_OK)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: integer expected after delimiter\"), quote (str)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: integer expected after delimiter"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: integer expected after delimiter"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
parse_repeat_count (int argnum, struct control *p, char *str)
{
  ...
  if (*end != '}')
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: '}' is required in repeat count\"), quote (str)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: '}' is required in repeat count"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: '}' is required in repeat count"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  *end = '\0';
  ...
  if (str+1 == end-1 && *(str+1) == '*')
    ...
    {
      if (xstrtoumax (str + 1, ((void*)0), 10, &val, "") != LONGINT_OK)
        {
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s}: integer required between '{' and '}'\"), quote (global_argv[argnum])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s}: integer required between '{' and '}'"), quote (global_argv[argnum])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s}: integer required between '{' and '}'"), quote (global_argv[argnum])), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
static struct control *
extract_regexp (int argnum, _Bool ignore, char const *str)
{
  size_t len;
  char delim = *str;
  ...
  if (closing_delim == ((void*)0))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: closing delimiter '%c' missing\"), str, delim), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: closing delimiter '%c' missing"), str, delim), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: closing delimiter '%c' missing"), str, delim), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  p->re_compiled.fastmap = xmalloc ((127*2 +1) + 1);
  ...
  err = rpl_re_compile_pattern (str + 1, len, &p->re_compiled);
  if (err)
    {
  ...
  for (int i = start; i < argc; i++)
    {
      if (*argv[i] == '/' || *argv[i] == '%')
      ...
      else
        {
          ...
          if (xstrtoumax (argv[i], ((void*)0), 10, &val, "") != LONGINT_OK)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: invalid pattern\"), quote (argv[i])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: invalid pattern"), quote (argv[i])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: invalid pattern"), quote (argv[i])), ((0) ? (void) 0 : __builtin_unreachable ()))));
          if (val == 0)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s: line number must be greater than zero\"), argv[i]), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s: line number must be greater than zero"), argv[i]), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: line number must be greater than zero"), argv[i]), ((0) ? (void) 0 : __builtin_unreachable ()))));

          if (val < last_val)
            {
              char buf[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"line number %s is smaller than preceding line number, %s\"), quote (argv[i]), umaxtostr (last_val, buf)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("line number %s is smaller than preceding line number, %s"), quote (argv[i]), umaxtostr (last_val, buf)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("line number %s is smaller than preceding line number, %s"), quote (argv[i]), umaxtostr (last_val, buf)), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          if (val == last_val)
            error (0, 0,
           gettext ("warning: line number %s is the same as preceding line number"),
                   quote (argv[i]));
...
max_out (char *format)
{
  ...
  for (char *f = format; *f; f++)
    if (*f == '%' && *++f != '%')
      {
        if (percent)
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"too many %% conversion specifications in suffix\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("too many %% conversion specifications in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("too many %% conversion specifications in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (! percent)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"missing %% conversion specification in suffix\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("missing %% conversion specification in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("missing %% conversion specification in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))));


  int maxlen = snprintf (((void*)0), 0, format, (2147483647 *2U +1U));
  if (! (0 <= maxlen && maxlen <= (18446744073709551615UL)))
    xalloc_die ();
  return maxlen;
}
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, "f:b:kn:sqz", longopts, ((void*)0))) != -1)
    switch (optc)
      ...
      case 'n':
        digits = xdectoimax (optarg, 0, (((2147483647)<((18446744073709551615UL)))?(2147483647):((18446744073709551615UL))), "",
      ...
      case GETOPT_VERSION_CHAR: version_etc (stdout, "csplit", "GNU coreutils", Version, ("Stuart Kemp"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
  ...
  size_t max_digit_string_len
    = (suffix
       ? max_out (suffix)
       : ((((((((sizeof (unsigned int) * 8) - (! ((__typeof__ (unsigned int)) 0 < (__typeof__ (unsigned int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (unsigned int)) 0 < (__typeof__ (unsigned int)) -1))))>(digits))?((((((sizeof (unsigned int) * 8) - (! ((__typeof__ (unsigned int)) 0 < (__typeof__ (unsigned int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (unsigned int)) 0 < (__typeof__ (unsigned int)) -1)))):(digits)));
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (gettext ("Usage: %s [OPTION]... FILE PATTERN...\n"),


              program_name);
      fputs_unlocked (gettext ("Output pieces of FILE separated by PATTERN(s) to files 'xx00', 'xx01', ...,\nand output byte counts of each piece to standard output.\n"),stdout);
      ...
      fputs_unlocked (gettext ("  -b, --suffix-format=FORMAT  use sprintf FORMAT instead of %02d\n  -f, --prefix=PREFIX        use PREFIX instead of 'xx'\n  -k, --keep-files           do not remove output files on errors\n"),stdout);




      fputs_unlocked (gettext ("      --suppress-matched     suppress the lines matching PATTERN\n"),stdout);


      fputs_unlocked (gettext ("  -n, --digits=DIGITS        use specified number of digits instead of 2\n  -s, --quiet, --silent      do not print counts of output file sizes\n  -z, --elide-empty-files    remove empty output files\n"),stdout);
