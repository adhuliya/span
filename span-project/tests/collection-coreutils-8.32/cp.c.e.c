            ...
            struct dir_attr *attr_list, const struct cp_options *x)
{
  ...
  do { dst_name = (__extension__ ({ const char *__old = (const_dst_name); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); })); } while (0);
      ...
      if (x->preserve_timestamps)
        {
          ...
          if (utimens (dst_name, timespec))
            {
              error (0, (*__errno_location ()), gettext ("failed to preserve times for %s"),
          ...
          if (lchown (dst_name, p->st.st_uid, p->st.st_gid) != 0)
            {
              ...
              (__extension__ ({ __typeof__ (lchown (dst_name, -1, p->st.st_gid)) __x = (lchown (dst_name, -1, p->st.st_gid)); (void) __x; }));
            }
        }
      ...
      if (x->preserve_mode)
      ...
      else if (p->restore_mode)
        {
          if (lchmod (dst_name, p->st.st_mode) != 0)
            {
              error (0, (*__errno_location ()), gettext ("failed to preserve permissions for %s"),
                     quotearg_style (shell_escape_always_quoting_style, dst_name));
              return 0;
            }
        }
                          ...
                          const struct cp_options *x)
{
  ...
  do { dir = (__extension__ ({ const char *__old = (const_dir); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); })); } while (0);
          ...
          if (missing_dir)
            {
              ...
              *new_dst = 1;
              ...
              mkdir_mode = x->explicit_no_preserve_mode ? ((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) : src_mode;
              mkdir_mode &= (04000 | 02000 | 01000 | (0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)) & ~omitted_permissions;
              ...
              if (lstat (dir, &stats))
                {
                  error (0, (*__errno_location ()), gettext ("failed to get attributes of %s"),
                         quotearg_style (shell_escape_always_quoting_style, dir));
                  return 0;
                }
              ...
              if ((stats.st_mode & (0400|0200|0100)) != (0400|0200|0100))
                {



                  if (lchmod (dir, stats.st_mode | (0400|0200|0100)) != 0)
                    {
         ...
         _Bool no_target_directory, struct cp_options *x)
{
  ...
  _Bool new_dst = 0;
  _Bool ok = 1;
  _Bool forcing = x->unlink_dest_before_opening
  ...
  if (no_target_directory)
    {
      ...
      (__extension__ ({ __typeof__ (target_directory_operand (file[n_files -1], &sb, &new_dst, forcing)) __x = (target_directory_operand (file[n_files -1], &sb, &new_dst, forcing)); (void) __x; }));
  ...
  if (target_directory)
      ...
      for (int i = 0; i < n_files; i++)
        {
          ...
          if (parents_option)
            {
              ...
              do { arg_no_trailing_slash = (__extension__ ({ const char *__old = (arg); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); })); } while (0);
          ...
          else
            {
              ...
              do { arg_base = (__extension__ ({ const char *__old = (last_component (arg)); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); })); } while (0);
              strip_trailing_slashes (arg_base);

              dst_name = ((strcmp (arg_base, "..") == 0)
          ...
          if (!parent_exists)
          ...
          else
            {
              ...
              ok &= copy (arg, dst_name, new_dst, x, &copy_into_self, ((void*)0));
  ...
  else
    {
      ...
      if (x->unlink_dest_after_failed_open
          ...
          && !new_dst && ((((sb.st_mode)) & 0170000) == (0100000)))
        {
          static struct cp_options x_tmp;

          new_dest = find_backup_file_name (-100, dest, x->backup_type);
      ...
      ok = copy (source, new_dest, 0, x, &unused, ((void*)0));
    }
...
static void
decode_preserve_arg (char const *arg, struct cp_options *x, _Bool on_off)
{
  enum File_attribute
    {
      PRESERVE_MODE,
  ...
  static char const* const preserve_args[] =
    {
      "mode", "timestamps",
      "ownership", "links", "context", "xattr", "all", ((void*)0)
    };
...
main (int argc, char **argv)
{
  ...
  while ((c = getopt_long (argc, argv, "abdfHilLnprst:uvxPRS:TZ",
         ...
         != -1)
    {
      switch (c)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "cp", "GNU coreutils", Version, ("Torbjorn Granlund"), ("David MacKenzie"), ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;
  ...
  if (x.require_preserve_context && ! selinux_enabled)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot preserve security context \" \"without an SELinux-enabled kernel\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot preserve security context " "without an SELinux-enabled kernel")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot preserve security context " "without an SELinux-enabled kernel")), ((0) ? (void) 0 : __builtin_unreachable ()))));
# 1203 "cp.c"
  ...
  if (x.require_preserve_xattr)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot preserve extended attributes, cp is \" \"built without xattr support\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot preserve extended attributes, cp is " "built without xattr support")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot preserve extended attributes, cp is " "built without xattr support")), ((0) ? (void) 0 : __builtin_unreachable ()))));
