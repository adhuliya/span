...
# 40 "tail.c" 2
# 1 "../lib/cl-strtod.h" 1
double cl_strtod (char const *, char **__restrict);
long double cl_strtold (char const *, char **__restrict);
# 41 "tail.c" 2
# 1 "./die.h" 1
# 22 "./die.h"
# 1 "../lib/error.h" 1
...
# 24 "/usr/include/x86_64-linux-gnu/sys/inotify.h" 3 4
...
is_local_fs_type (unsigned long int magic)
{
  switch (magic)
    {
      case 0x5A3C69F0: return 1;
      case 0x61636673: return 0;
...
{
  {"bytes", 1, ((void*)0), 'c'},
  {"follow", 2, ((void*)0), LONG_FOLLOW_OPTION},
  {"lines", 1, ((void*)0), 'n'},
  {"max-unchanged-stats", 1, ((void*)0), MAX_UNCHANGED_STATS_OPTION},
  {"-disable-inotify", 0, ((void*)0),
   DISABLE_INOTIFY_OPTION},
  {"pid", 1, ((void*)0), PID_OPTION},
  {"-presume-input-pipe", 0, ((void*)0),
   PRESUME_INPUT_PIPE_OPTION},
  {"quiet", 0, ((void*)0), 'q'},
  {"retry", 0, ((void*)0), RETRY_OPTION},
  {"silent", 0, ((void*)0), 'q'},
  {"sleep-interval", 1, ((void*)0), 's'},
  {"verbose", 0, ((void*)0), 'v'},
...
# 363 "tail.c"
  ...
  fd_set rfd;
  do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&rfd)->fds_bits)[0]) : "memory"); } while (0);
  ((void) (((&rfd)->fds_bits)[((1) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((1) % (8 * (int) sizeof (__fd_mask)))))));



  if (select (1 + 1, &rfd, ((void*)0), ((void*)0), &delay) == 1)
    die_pipe ();
...
{
  return ((strcmp (f->name, "-") == 0) ? gettext ("standard input") : f->name);
}
...
close_fd (int fd, const char *filename)
{
  if (fd != -1 && fd != 0 && close (fd))
    {
      error (0, (*__errno_location ()), gettext ("closing %s (fd=%d)"), quotearg_style (shell_escape_always_quoting_style, filename), fd);
    }
}
...
static uintmax_t
dump_remainder (_Bool want_header, const char *pretty_filename, int fd,
                uintmax_t n_bytes)
{
  uintmax_t n_written;
      ...
      if (bytes_read == ((size_t) -1))
        {
          if ((*__errno_location ()) != 11)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"error reading %s\"), quotearg_style (shell_escape_always_quoting_style, pretty_filename)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, pretty_filename)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, pretty_filename)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
xlseek (int fd, off_t offset, int whence, char const *filename)
{
  ...
  switch (whence)
    ...
    case 0:
      ...
      break;
    case 1:
      error (0, (*__errno_location ()), gettext ("%s: cannot seek to relative offset %s"),
             quotearg_n_style_colon (0, shell_escape_quoting_style, filename), s);
      break;
    case 2:
      error (0, (*__errno_location ()), gettext ("%s: cannot seek to end-relative offset %s"),
             quotearg_n_style_colon (0, shell_escape_quoting_style, filename), s);
      break;
    default:
      abort ();
            ...
            off_t start_pos, off_t end_pos, uintmax_t *read_pos)
{
  ...
  if (bytes_read == ((size_t) -1))
    {
      error (0, (*__errno_location ()), gettext ("error reading %s"), quotearg_style (shell_escape_always_quoting_style, pretty_filename));
      return 0;
    }
          ...
          if (n_lines-- == 0)
            {
              ...
              *read_pos += dump_remainder (0, pretty_filename, fd,
      ...
      if (pos == start_pos)
        {
          ...
          *read_pos = start_pos + dump_remainder (0, pretty_filename, fd,
                                                  end_pos);
          return 1;
        }
      pos -= 8192;
        ...
        for (j = total_lines - n_lines; j; --j)
          {
            ...
            ((void) sizeof ((beg) ? 1 : 0), __extension__ ({ if (beg) ; else __assert_fail ("beg", "tail.c", 736, __extension__ __PRETTY_FUNCTION__); }));
            ++beg;
          }
      }
  ...
  if (err != 0)
    {
      ...
      if ((*__errno_location ()) != 38)
        error (0, (*__errno_location ()), gettext ("cannot determine location of %s. " "reverting to polling"), quotearg_style (shell_escape_always_quoting_style, name));
  ...
  else
    {
      switch (is_local_fs_type (buf.f_type))
        ...
        case 1:
          ...
          break;
        default:
          ((void) sizeof ((!"unexpected return value from is_local_fs_type") ? 1 : 0), __extension__ ({ if (!"unexpected return value from is_local_fs_type") ; else __assert_fail ("!\"unexpected return value from is_local_fs_type\"", "tail.c", 969, __extension__ __PRETTY_FUNCTION__); }));
        }
    }
...
static void
recheck (struct File_spec *f, _Bool blocking)
{
  struct stat new_stats;
  _Bool ok = 1;
  _Bool is_stdin = ((strcmp (f->name, "-") == 0));
  _Bool was_tailable = f->tailable;
  int prev_errnum = f->errnum;
  _Bool new_file;
  int fd = (is_stdin
            ? 0
            : open_safer (f->name, 00 | (blocking ? 0 : 04000)));

  ((void) sizeof ((valid_file_spec (f)) ? 1 : 0), __extension__ ({ if (valid_file_spec (f)) ; else __assert_fail ("valid_file_spec (f)", "tail.c", 991, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (! disable_inotify && ! lstat (f->name, &new_stats)
      && ((((new_stats.st_mode)) & 0170000) == (0120000)))
    {
  ...
  else if (fd == -1 || fstat (fd, &new_stats) < 0)
    {
      ...
      if (!f->tailable)
          ...
          if (was_tailable)
            {
              ...
              error (0, f->errnum, gettext ("%s has become inaccessible"),
                     quotearg_style (shell_escape_always_quoting_style, pretty_name (f)));
            }
          else
            {
        ...
        error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, pretty_name (f)));
    }
  else if (!(((((new_stats.st_mode)) & 0170000) == (0100000)) || ((((new_stats.st_mode)) & 0170000) == (0010000)) || ((((new_stats.st_mode)) & 0170000) == (0140000)) || ((((new_stats.st_mode)) & 0170000) == (0020000))))
    {
      ok = 0;
      f->errnum = -1;
      f->tailable = 0;
  ...
  if (!ok)
  ...
  else if (prev_errnum && prev_errnum != 2)
    {
      new_file = 1;
      ((void) sizeof ((f->fd == -1) ? 1 : 0), __extension__ ({ if (f->fd == -1) ; else __assert_fail ("f->fd == -1", "tail.c", 1068, __extension__ __PRETTY_FUNCTION__); }));
      error (0, 0, gettext ("%s has become accessible"), quotearg_style (shell_escape_always_quoting_style, pretty_name (f)));
    }
  else if (f->fd == -1)
    {
      ...
      error (0, 0,
             gettext ("%s has appeared;  following new file"),
             quotearg_style (shell_escape_always_quoting_style, pretty_name (f)));
    }
  else if (f->ino != new_stats.st_ino || f->dev != new_stats.st_dev)
    {
      ...
      error (0, 0,
             gettext ("%s has been replaced;  following new file"),
             quotearg_style (shell_escape_always_quoting_style, pretty_name (f)));
...
tail_forever (struct File_spec *f, size_t n_files, double sleep_interval)
{
  ...
  _Bool blocking = (pid == 0 && follow_mode == Follow_descriptor
                   && n_files == 1 && f[0].fd != -1 && ! ((((f[0].mode)) & 0170000) == (0100000)));
  size_t last;
  ...
  while (1)
    {
          ...
          if (f[i].blocking != blocking)
            {
              ...
              if (old_flags < 0
                  || (new_flags != old_flags
                      && rpl_fcntl (fd, 4, new_flags) == -1))
                {

                  if (((((f[i].mode)) & 0170000) == (0100000)) && (*__errno_location ()) == 1)
                    {


                    }
                  else
                    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"%s: cannot change nonblocking mode\"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("%s: cannot change nonblocking mode"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("%s: cannot change nonblocking mode"), quotearg_n_style_colon (0, shell_escape_quoting_style, name)), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          if (!f[i].blocking)
            {
              ...
              if (f[i].mode == stats.st_mode
                  && (! ((((stats.st_mode)) & 0170000) == (0100000)) || f[i].size == stats.st_size)
              ...
              if (((((mode)) & 0170000) == (0100000)) && stats.st_size < f[i].size)
                {
                  error (0, 0, gettext ("%s: file truncated"), quotearg_n_style_colon (0, shell_escape_quoting_style, name));
      ...
      if ((!any_input || blocking) && fflush_unlocked (stdout) != 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"write error\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (!any_input)
        {
          ...
          if (!writer_is_dead && xnanosleep (sleep_interval))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot read realtime clock\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot read realtime clock")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot read realtime clock")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
any_symlinks (const struct File_spec *f, size_t n_files)
{
  struct stat st;
  for (size_t i = 0; i < n_files; i++)
    if (lstat (f[i].name, &st) == 0 && ((((st.st_mode)) & 0170000) == (0120000)))
      return 1;
  return 0;
}
...
{
  for (size_t i = 0; i < n_files; i++)
    if (0 <= f[i].fd && ! ((((f[i].mode)) & 0170000) == (0100000)) && ! ((((f[i].mode)) & 0170000) == (0010000)))
      return 1;
  return 0;
}
...
{
  for (size_t i = 0; i < n_files; i++)
    if (!f[i].ignore && (strcmp (f[i].name, "-") == 0))
      return 1;
  return 0;
}
...
check_fspec (struct File_spec *fspec, struct File_spec **prev_fspec)
{
  ...
  if (((((fspec->mode)) & 0170000) == (0100000)) && stats.st_size < fspec->size)
    {
      error (0, 0, gettext ("%s: file truncated"), quotearg_n_style_colon (0, shell_escape_quoting_style, name));
      xlseek (fspec->fd, 0, 0, name);
      fspec->size = 0;
    }
  else if (((((fspec->mode)) & 0170000) == (0100000)) && stats.st_size == fspec->size
           && timespec_cmp (fspec->mtime, get_stat_mtime (&stats)) == 0)
    return;

  _Bool want_header = print_headers && (fspec != *prev_fspec);
                      ...
                      double sleep_interval)
{
  ...
  _Bool found_watchable_file = 0;
  _Bool tailed_but_unwatchable = 0;
  _Bool found_unwatchable_dir = 0;
  _Bool no_inotify_resources = 0;
  _Bool writer_is_dead = 0;
  ...
  wd_to_name = hash_initialize (n_files, ((void*)0), wd_hasher, wd_comparator, ((void*)0));
  if (! wd_to_name)
    xalloc_die ();


  uint32_t inotify_wd_mask = 0x00000002;


  if (follow_mode == Follow_name)
    inotify_wd_mask |= (0x00000004 | 0x00000400 | 0x00000800);
      ...
      if (!f[i].ignore)
        {
              ...
              if (f[i].parent_wd < 0)
                {
                  if ((*__errno_location ()) != 28)
                    error (0, (*__errno_location ()), gettext ("cannot watch parent directory of %s"),
                           quotearg_style (shell_escape_always_quoting_style, f[i].name));
                  else
                    error (0, 0, gettext ("inotify resources exhausted"));
                  found_unwatchable_dir = 1;
          ...
          if (f[i].wd < 0)
            {
              if (f[i].fd != -1)
                tailed_but_unwatchable = 1;
              if ((*__errno_location ()) == 28 || (*__errno_location ()) == 12)
                {
                  no_inotify_resources = 1;
                  error (0, 0, gettext ("inotify resources exhausted"));
                  break;
                }
              else if ((*__errno_location ()) != f[i].errnum)
                error (0, (*__errno_location ()), gettext ("cannot watch %s"), quotearg_style (shell_escape_always_quoting_style, f[i].name));
              continue;
            }

          if (hash_insert (wd_to_name, &(f[i])) == ((void*)0))
            xalloc_die ();

          found_watchable_file = 1;
        }
    }
          ...
          if (follow_mode == Follow_name)
          ...
          else if (f[i].fd != -1)
            {
              ...
              if (stat (f[i].name, &stats) == 0
                ...
                {
                  error (0, (*__errno_location ()), gettext ("%s was replaced"),
                         quotearg_style (shell_escape_always_quoting_style, pretty_name (&(f[i]))));
                  hash_free (wd_to_name);
  ...
  while (1)
    {
          ...
          if (pid)
            {
              ...
              writer_is_dead = (kill (pid, 0) != 0 && (*__errno_location ()) != 1);
           ...
           fd_set rfd;
           do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&rfd)->fds_bits)[0]) : "memory"); } while (0);
           ((void) (((&rfd)->fds_bits)[((wd) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((wd) % (8 * (int) sizeof (__fd_mask)))))));
           if (monitor_output)
             ((void) (((&rfd)->fds_bits)[((1) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((1) % (8 * (int) sizeof (__fd_mask)))))));

           int file_change = select ((((wd)>(1))?(wd):(1)) + 1,
                                     &rfd, ((void*)0), ((void*)0), pid ? &delay: ((void*)0));

           if (file_change == 0)
             continue;
           else if (file_change == -1)
             ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"error waiting for inotify and output events\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("error waiting for inotify and output events")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("error waiting for inotify and output events")), ((0) ? (void) 0 : __builtin_unreachable ()))));

           else if (((((&rfd)->fds_bits)[((1) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((1) % (8 * (int) sizeof (__fd_mask)))))) != 0))
             {
      ...
      if (len <= evbuf_off)
        {
          ...
          if ((len == 0 || (len == ((size_t) -1) && (*__errno_location ()) == 22))
              && max_realloc--)
            {
              len = 0;
              evlen *= 2;
          ...
          if (len == 0 || len == ((size_t) -1))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"error reading inotify event\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("error reading inotify event")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("error reading inotify event")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
              ...
              if (ev->wd == f[i].parent_wd)
                {
                  hash_free (wd_to_name);
                  error (0, 0,
                      gettext ("directory containing watched file was removed"));
                  (*__errno_location ()) = 0;
                  return 1;
                }
            }
      ...
      if (ev->len)
        {
          ...
          for (j = 0; j < n_files; j++)
            {
              ...
              if (f[j].parent_wd == ev->wd
                  && (strcmp (ev->name, f[j].name + f[j].basename_start) == 0))
                break;
            }
          ...
          int new_wd = -1;
          _Bool deleting = !! (ev->mask & 0x00000200);
          ...
          if (! deleting && new_wd < 0)
            {
              if ((*__errno_location ()) == 28 || (*__errno_location ()) == 12)
              ...
              else
                {
                  ...
                  error (0, (*__errno_location ()), gettext ("cannot watch %s"), quotearg_style (shell_escape_always_quoting_style, f[j].name));
                }
          ...
          if (new_watch)
            {
              ...
              if (hash_insert (wd_to_name, fspec) == ((void*)0))
                xalloc_die ();
            }
      ...
      if (ev->mask & (0x00000004 | 0x00000200 | 0x00000400 | 0x00000800))
        {




          if (ev->mask & 0x00000400)
            {
              inotify_rm_watch (wd, fspec->wd);
              hash_delete (wd_to_name, fspec);
            }
            ...
            uintmax_t *read_pos)
{
  ...
  if (fstat (fd, &stats))
    {
      error (0, (*__errno_location ()), gettext ("cannot fstat %s"), quotearg_style (shell_escape_always_quoting_style, pretty_filename));
      return 0;
    }

  if (from_start)
    {
      if (! presume_input_pipe && n_bytes <= ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)))
          && ((((((stats.st_mode)) & 0170000) == (0100000))
               && xlseek (fd, n_bytes, 1, pretty_filename) >= 0)
              || lseek (fd, n_bytes, 1) != -1))
        *read_pos += n_bytes;
      else
        {
      ...
      n_bytes = (18446744073709551615UL);
    }
  else
    {
      off_t end_pos = -1;
      ...
      if (! presume_input_pipe && n_bytes <= ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1))))
        {
          ...
          else if ((current_pos = lseek (fd, -n_bytes, 2)) != -1)
            end_pos = current_pos + n_bytes;
        }
      if (end_pos <= (off_t) ((0 < (stats).st_blksize && (stats).st_blksize <= ((size_t)-1) / 8 + 1) ? (stats).st_blksize : 512))
        return pipe_bytes (pretty_filename, fd, n_bytes, read_pos);
      if (current_pos == -1)
        current_pos = xlseek (fd, 0, 1, pretty_filename);
          ...
          if (n_bytes < bytes_remaining)
            {
              ...
              xlseek (fd, current_pos, 0, pretty_filename);
            }
        }
      *read_pos = current_pos;
    }

  *read_pos += dump_remainder (0, pretty_filename, fd, n_bytes);
  return 1;
}
  ...
  if (from_start)
    {
      ...
      if (t)
        return t < 0;
      *read_pos += dump_remainder (0, pretty_filename, fd, (18446744073709551615UL));
    }
  else
    {
      off_t start_pos = -1;
      ...
      if ( ! presume_input_pipe
           && ((((stats.st_mode)) & 0170000) == (0100000))
           && (start_pos = lseek (fd, 0, 1)) != -1
           && start_pos < (end_pos = lseek (fd, 0, 2)))
        {
          *read_pos = end_pos;
          if (end_pos != 0
      ...
      if (forever)
        {
          ...
          else if (!(((((stats.st_mode)) & 0170000) == (0100000)) || ((((stats.st_mode)) & 0170000) == (0010000)) || ((((stats.st_mode)) & 0170000) == (0140000)) || ((((stats.st_mode)) & 0170000) == (0020000))))
            {
              ok = 0;
              f->errnum = -1;
              f->tailable = 0;
...
parse_obsolete_option (int argc, char * const *argv, uintmax_t *n_units)
{
  ...
  switch (*p)
    {
    case 'b': default_count *= 512; ((void) 0);
    case 'c': t_count_lines = 0; ((void) 0);
    case 'l': p++; break;
    }
  ...
  if (n_string == n_string_end)
    *n_units = default_count;
           ...
           != LONGINT_OK)
    {
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s: %s\", gettext (\"invalid number\"), quote (argv[1])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s: %s", gettext ("invalid number"), quote (argv[1])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s: %s", gettext ("invalid number"), quote (argv[1])), ((0) ? (void) 0 : __builtin_unreachable ()))));
               ...
               double *sleep_interval)
{
         ...
         != -1)
    {
      switch (c)
        ...
        case 'n':
          ...
          *n_units = xdectoumax (optarg, 0, (18446744073709551615UL), "bkKmMGTPEZY0",
                                 count_lines
                                 ? gettext ("invalid number of lines")
        ...
        case LONG_FOLLOW_OPTION:
          ...
          if (optarg == ((void*)0))
            ...
            follow_mode = ((follow_mode_map) [__xargmatch_internal ("--follow", optarg, follow_mode_string, (void const *) (follow_mode_map), sizeof *(follow_mode_map), argmatch_die)]);
        ...
        case MAX_UNCHANGED_STATS_OPTION:
          ...
          max_n_unchanged_stats_between_opens =
            xdectoumax (optarg, 0, (18446744073709551615UL), "",
              gettext ("invalid maximum number of unchanged stats between opens"), 0);
          break;
        ...
        case PID_OPTION:
          pid = xdectoumax (optarg, 0, ((pid_t) (! (! ((pid_t) 0 < (pid_t) -1)) ? (pid_t) -1 : ((((pid_t) 1 << ((sizeof (pid_t) * 8) - 2)) - 1) * 2 + 1))), "", gettext ("invalid PID"), 0);
          break;
        ...
        case 's':
          {
            double s;
            if (! (xstrtod (optarg, ((void*)0), &s, cl_strtod) && 0 <= s))
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid number of seconds: %s\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid number of seconds: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid number of seconds: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "tail", "GNU coreutils", Version, ("Paul Rubin"), ("David MacKenzie"), ("Ian Lance Taylor"), ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;

        case '0': case '1': case '2': case '3': case '4':
        case '5': case '6': case '7': case '8': case '9':
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"option used in invalid context -- %c\"), c), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("option used in invalid context -- %c"), c), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("option used in invalid context -- %c"), c), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (pid && !forever)
    error (0, 0,
           gettext ("warning: PID ignored; --pid=PID is useful only when following"));
  else if (pid && kill (pid, 0) != 0 && (*__errno_location ()) == 38)
    {
  ...
  if (forever && ignore_fifo_and_pipe (F, n_files))
    {
      ...
      if (fstat (1, &out_stat) < 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"standard output\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("standard output")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("standard output")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
# 2490 "tail.c"
      ...
      if (!disable_inotify)
        {
          ...
          error (0, (*__errno_location ()), gettext ("inotify cannot be used, reverting to polling"));
  ...
  if (have_read_stdin && close (0) < 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"-\"), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "-"), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "-"), ((0) ? (void) 0 : __builtin_unreachable ()))));
  return ok ? 0 : 1;
}
