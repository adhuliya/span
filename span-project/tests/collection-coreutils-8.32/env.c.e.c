...
{
  {"ignore-environment", 0, ((void*)0), 'i'},
  {"null", 0, ((void*)0), '0'},
  {"unset", 1, ((void*)0), 'u'},
  {"chdir", 1, ((void*)0), 'C'},
  {"default-signal", 2, ((void*)0), DEFAULT_SIGNAL_OPTION},
  {"ignore-signal", 2, ((void*)0), IGNORE_SIGNAL_OPTION},
  {"block-signal", 2, ((void*)0), BLOCK_SIGNAL_OPTION},
  {"list-signal-handling", 0, ((void*)0), LIST_SIGNAL_HANDLING_OPTION},
  {"debug", 0, ((void*)0), 'v'},
  {"split-string", 1, ((void*)0), 'S'},
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (gettext ("Usage: %s [OPTION]... [-] [NAME=VALUE]... [COMMAND [ARG]...]\n"),

              program_name);
      fputs_unlocked (gettext ("Set each NAME to VALUE in the environment and run COMMAND.\n"),stdout);



      emit_mandatory_arg_note ();

      fputs_unlocked (gettext ("  -i, --ignore-environment  start with an empty environment\n  -0, --null           end each output line with NUL, not newline\n  -u, --unset=NAME     remove variable from the environment\n"),stdout);




      fputs_unlocked (gettext ("  -C, --chdir=DIR      change working directory to DIR\n"),stdout);


      fputs_unlocked (gettext ("  -S, --split-string=S  process and split S into separate arguments;\n                        used to pass multiple arguments on shebang lines\n"),stdout);



      fputs_unlocked (gettext ("      --block-signal[=SIG]    block delivery of SIG signal(s) to COMMAND\n"),stdout);


      fputs_unlocked (gettext ("      --default-signal[=SIG]  reset handling of SIG signal(s) to the default\n"),stdout);


      fputs_unlocked (gettext ("      --ignore-signal[=SIG]   set handling of SIG signals(s) to do nothing\n"),stdout);


      fputs_unlocked (gettext ("      --list-signal-handling  list non default signal handling to stderr\n"),stdout);


      fputs_unlocked (gettext ("  -v, --debug          print verbose information for each processing step\n"),stdout);
...
unset_envvars (void)
{
  for (size_t i = 0; i < usvars_used; ++i)
    {
      do { if (dev_debug) fprintf (stderr, "unset:    %s\n", usvars[i]); } while (0);

      if (unsetenv (usvars[i]))
        ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"cannot unset %s\"), quote (usvars[i])), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot unset %s"), quote (usvars[i])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot unset %s"), quote (usvars[i])), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
{
  return (c == 'c' || c == 'f' || c == 'n' || c == 'r' || c == 't' || c == 'v' || c == '#' || c == '$' || c == '_' || c == '"' || c == '\'' || c == '\\');
...
escape_char (const char c)
{
  switch (c)
    ...
    case 't': return '\t';
    case 'v': return '\v';
    default: ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "env.c", 210, __extension__ __PRETTY_FUNCTION__); }));
    }
}
...
static const char* __attribute__ ((__pure__))
scan_varname (const char* str)
{
  ((void) sizeof ((str && *str == '$') ? 1 : 0), __extension__ ({ if (str && *str == '$') ; else __assert_fail ("str && *str == '$'", "env.c", 221, __extension__ __PRETTY_FUNCTION__); }));
...
# 271 "env.c"
static void
validate_split_str (const char* str, size_t* bufsize,
                    int* maxargc)
{
  _Bool dq, sq, sp;
  const char *pch;
  ...
  ((void) sizeof ((str && str[0] && !((*__ctype_b_loc ())[(int) ((str[0]))] & (unsigned short int) _ISspace)) ? 1 : 0), __extension__ ({ if (str && str[0] && !((*__ctype_b_loc ())[(int) ((str[0]))] & (unsigned short int) _ISspace)) ; else __assert_fail ("str && str[0] && !isspace (str[0])", "env.c", 280, __extension__ __PRETTY_FUNCTION__); }));
  ...
  while (*str)
    {
      ...
      if (((*__ctype_b_loc ())[(int) ((*str))] & (unsigned short int) _ISspace) && !dq && !sq)
        {
          sp = 1;
        }
      else
      ...
      switch (*str)
        {
        case '\'':
          ((void) sizeof ((!(sq && dq)) ? 1 : 0), __extension__ ({ if (!(sq && dq)) ; else __assert_fail ("!(sq && dq)", "env.c", 303, __extension__ __PRETTY_FUNCTION__); }));
          sq = !sq && !dq;
          break;

        case '"':
          ((void) sizeof ((!(sq && dq)) ? 1 : 0), __extension__ ({ if (!(sq && dq)) ; else __assert_fail ("!(sq && dq)", "env.c", 308, __extension__ __PRETTY_FUNCTION__); }));
          dq = !sq && !dq;
          break;

        case '\\':
          if (dq && next == 'c')
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, 0, gettext (\"'\\\\c' must not appear in double-quoted -S string\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, 0, gettext ("'\\c' must not appear in double-quoted -S string")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, 0, gettext ("'\\c' must not appear in double-quoted -S string")), ((0) ? (void) 0 : __builtin_unreachable ()))));


          if (next == '\0')
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, 0, gettext (\"invalid backslash at end of string in -S\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, 0, gettext ("invalid backslash at end of string in -S")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, 0, gettext ("invalid backslash at end of string in -S")), ((0) ? (void) 0 : __builtin_unreachable ()))));


          if (!valid_escape_sequence (next))
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, 0, gettext (\"invalid sequence '\\\\%c' in -S\"), next), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, 0, gettext ("invalid sequence '\\%c' in -S"), next), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, 0, gettext ("invalid sequence '\\%c' in -S"), next), ((0) ? (void) 0 : __builtin_unreachable ()))));
        ...
        case '$':
          ...
          if (!(pch = extract_varname (str)))
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, 0, gettext (\"only ${VARNAME} expansion is supported,\" \" error at: %s\"), str), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, 0, gettext ("only ${VARNAME} expansion is supported," " error at: %s"), str), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, 0, gettext ("only ${VARNAME} expansion is supported," " error at: %s"), str), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (dq || sq)
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, 0, gettext (\"no terminating quote in -S string\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, 0, gettext ("no terminating quote in -S string")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, 0, gettext ("no terminating quote in -S string")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
build_argv (const char* str, int extra_argc)
{
  ...
  size_t buflen = 0;
# 395 "env.c"
  ((void) sizeof ((str && str[0] && !((*__ctype_b_loc ())[(int) ((str[0]))] & (unsigned short int) _ISspace)) ? 1 : 0), __extension__ ({ if (str && str[0] && !((*__ctype_b_loc ())[(int) ((str[0]))] & (unsigned short int) _ISspace)) ; else __assert_fail ("str && str[0] && !isspace (str[0])", "env.c", 395, __extension__ __PRETTY_FUNCTION__); }));
      ...
      switch (*str)
        ...
        case '\'':
          if (dq)
            break;
          sq = !sq;
          do { if (sep) { *dest++ = '\0'; *nextargv++ = dest; sep = 0; } } while (0);
          ++str;
          continue;
        ...
        case '$':
...

          {
            ...
            if (v)
              {
                do { if (sep) { *dest++ = '\0'; *nextargv++ = dest; sep = 0; } } while (0);
                do { if (dev_debug) fprintf (stderr, "expanding ${%s} into %s\n", n, quote (v)); } while (0);
                dest = stpcpy (dest, v);
              }
            else
              do { if (dev_debug) fprintf (stderr, "replacing ${%s} with null string\n", n); } while (0);
                    ...
                    int *orig_argc, char*** orig_argv)
{
  ...
  while (((*__ctype_b_loc ())[(int) ((*str))] & (unsigned short int) _ISspace))
    str++;
  if (*str == '\0')
    return;
  ...
  *newargv = (*orig_argv)[0];
  ...
  if (dev_debug && *nextargv)
    {
      do { if (dev_debug) fprintf (stderr, "split -S:  %s\n", quote (str)); } while (0);
      do { if (dev_debug) fprintf (stderr, " into:    %s\n", quote (*nextargv++)); } while (0);
      while (*nextargv)
        do { if (dev_debug) fprintf (stderr, "     &    %s\n", quote (*nextargv++)); } while (0);
    }
  else
    {
...
static void
parse_signal_action_params (const char* optarg, _Bool set_default)
{
  ...
  for (int i = 1; i <= ((64 + 1) - 1); i++)
    {
      ...
      _Bool ignore_errors = (signals[i] == DEFAULT_NOERR
                            || signals[i] == IGNORE_NOERR);

      _Bool set_to_default = (signals[i] == DEFAULT
                             || signals[i] == DEFAULT_NOERR);

      int sig_err = sigaction (i, ((void*)0), &act);

      if (sig_err && !ignore_errors)
        ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to get signal action for signal %d\"), i), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get signal action for signal %d"), i), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get signal action for signal %d"), i), ((0) ? (void) 0 : __builtin_unreachable ()))));


      if (! sig_err)
        {
          act.__sigaction_handler.sa_handler = set_to_default ? ((__sighandler_t) 0) : ((__sighandler_t) 1);

          if ((sig_err = sigaction (i, &act, ((void*)0))) && !ignore_errors)
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to set signal action for signal %d\"), i), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set signal action for signal %d"), i), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set signal action for signal %d"), i), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (dev_debug)
        {
          char signame[(sizeof "SIGRTMAX" + (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) - 1)];
          sig2str (i, signame);
          do { if (dev_debug) fprintf (stderr, "Reset signal %s (%d) to %s%s\n", signame, i, set_to_default ? "DEFAULT" : "IGNORE", sig_err ? " (failure ignored)" : ""); } while (0);
...
static void
parse_block_signal_params (const char* optarg, _Bool block)
{
  char signame[(sizeof "SIGRTMAX" + (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) - 1)];
  char *opt_sig;
  char *optarg_writable;
...
set_signal_proc_mask (void)
{
  ...
  if (sigprocmask (0, ((void*)0), &set))
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to get signal process mask\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get signal process mask")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get signal process mask")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      if (dev_debug && debug_act)
        {
          char signame[(sizeof "SIGRTMAX" + (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) - 1)];
          sig2str (i, signame);
          do { if (dev_debug) fprintf (stderr, "signal %s (%d) mask set to %s\n", signame, i, debug_act); } while (0);

        }
    }

  if (sigprocmask (2, &set, ((void*)0)))
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to set signal process mask\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set signal process mask")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set signal process mask")), ((0) ? (void) 0 : __builtin_unreachable ()))));
}
...
list_signal_handling (void)
{
  ...
  for (int i = 1; i <= ((64 + 1) - 1); i++)
    {
      struct sigaction act;
      if (sigaction (i, ((void*)0), &act))
        continue;

      char const* ignored = act.__sigaction_handler.sa_handler == ((__sighandler_t) 1) ? "IGNORE" : "";
...
{
  signals = xmalloc ((sizeof *signals) * (((64 + 1) - 1) + 1));
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, shortopts, longopts, ((void*)0))) != -1)
    {
      switch (optc)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "env", "GNU coreutils", Version, ("Richard Mlynarik"), ("David MacKenzie"), ("Assaf Gordon"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (EXIT_CANCELED);
        }
    }
  ...
  if (ignore_environment)
    {
      do { if (dev_debug) fprintf (stderr, "cleaning environ\n"); } while (0);
      static char *dummy_environ[] = { ((void*)0) };
  ...
  while (optind < argc && (eq = strchr (argv[optind], '=')))
    {
      do { if (dev_debug) fprintf (stderr, "setenv:   %s\n", argv[optind]); } while (0);

      if (putenv (argv[optind]))
        {
          *eq = '\0';
          ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"cannot set %s\"), quote (argv[optind])), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot set %s"), quote (argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot set %s"), quote (argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))));

        }
      optind++;
    }

  _Bool program_specified = optind < argc;
  ...
  if (newdir)
    {
      do { if (dev_debug) fprintf (stderr, "chdir:    %s\n", quotearg_style (shell_escape_always_quoting_style, newdir)); } while (0);

      if (chdir (newdir) != 0)
        ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"cannot change directory to %s\"), quotearg_style (shell_escape_always_quoting_style, newdir)), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot change directory to %s"), quotearg_style (shell_escape_always_quoting_style, newdir)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot change directory to %s"), quotearg_style (shell_escape_always_quoting_style, newdir)), ((0) ? (void) 0 : __builtin_unreachable ()))));

    }

  if (dev_debug)
    {
      do { if (dev_debug) fprintf (stderr, "executing: %s\n", argv[optind]); } while (0);
      for (int i=optind; i<argc; ++i)
        do { if (dev_debug) fprintf (stderr, "   arg[%d]= %s\n", i-optind, quote (argv[i])); } while (0);
    }
