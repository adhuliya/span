                  ...
                  if (convert)
                    {
                      if (next_tab_column < column)
                        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"input line is too long\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("input line is too long")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("input line is too long")), ((0) ? (void) 0 : __builtin_unreachable ()))));
         ...
         != -1)
    {
      switch (c)
        ...
        default:
          ...
          if (!( (void) (&(tabval) == (uintmax_t *) ((void*)0)), ((!!sizeof (struct { _Static_assert (! (! ((uintmax_t) 0 < (uintmax_t) -1)), "verify_expr (" "! TYPE_SIGNED (uintmax_t)" ", " "(((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (c - '0')) < (tabval)) ? false : (((tabval) = (tabval) * 10 + (c - '0')), true))" ")"); int _gl_dummy; })) ? ((((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (c - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (c - '0')), 1))) : ((((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (c - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (c - '0')), 1)))) ))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"tab stop value is too large\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("tab stop value is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("tab stop value is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          break;
        }
    }
