...
# 30 "join.c" 2
# 1 "../lib/linebuffer.h" 1
# 22 "../lib/linebuffer.h"
# 1 "../lib/stdio.h" 1
# 21 "../lib/stdio.h" 3
# 23 "../lib/linebuffer.h" 2
...
# 31 "join.c" 2
# 1 "../lib/memcasecmp.h" 1
# 20 "../lib/memcasecmp.h"
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stddef.h" 1 3
# 21 "../lib/memcasecmp.h" 2
...
static struct line *prevline[2] = {((void*)0), ((void*)0)};
...
static struct line *spareline[2] = {((void*)0), ((void*)0)};


static _Bool hard_LC_COLLATE;


static _Bool print_unpairables_1, print_unpairables_2;
...
static size_t join_field_1 = (18446744073709551615UL);
static size_t join_field_2 = (18446744073709551615UL);
...
static struct option const longopts[] =
{
  ...
  {"check-order", 0, ((void*)0), CHECK_ORDER_OPTION},
  {"nocheck-order", 0, ((void*)0), NOCHECK_ORDER_OPTION},
  {"zero-terminated", 0, ((void*)0), 'z'},
  {"header", 0, ((void*)0), HEADER_LINE_OPTION},
  ...
  if (status != 0)
  ...
  else
    {
      printf (gettext ("Usage: %s [OPTION]... FILE1 FILE2\n"),
              ...
              program_name);
      fputs_unlocked (gettext ("For each pair of input lines with identical join fields, write a line to\nstandard output.  The default join field is the first, delimited by blanks.\n"),stdout);
      ...
      fputs_unlocked (gettext ("  -i, --ignore-case  ignore differences in case when comparing fields\n  -j FIELD          equivalent to '-1 FIELD -2 FIELD'\n  -o FORMAT         obey FORMAT while constructing output line\n  -t CHAR           use CHAR as input and output field separator\n"),stdout);





      fputs_unlocked (gettext ("  -v FILENUM        like -a FILENUM, but suppress joined output lines\n  -1 FIELD          join on this FIELD of file 1\n  -2 FIELD          join on this FIELD of file 2\n  --check-order     check that the input is correctly sorted, even\n                      if all input lines are pairable\n  --nocheck-order   do not check that the input is correctly sorted\n  --header          treat the first line in each file as field headers,\n                      print them without trying to pair them\n"),stdout);
# 227 "join.c"
...
extract_field (struct line *line, char *field, size_t len)
{
  if (line->nfields >= line->nfields_allocated)
    {
      line->fields = ((!!sizeof (struct { _Static_assert (sizeof *(line->fields) != 1, "verify_expr (" "sizeof *(line->fields) != 1" ", " "x2nrealloc (line->fields, &line->nfields_allocated, sizeof *(line->fields))" ")"); int _gl_dummy; })) ? (x2nrealloc (line->fields, &line->nfields_allocated, sizeof *(line->fields))) : (x2nrealloc (line->fields, &line->nfields_allocated, sizeof *(line->fields))));
    }
  ...
  if (ignore_case)
    {
      ...
      diff = memcasecmp (beg1, beg2, (((len1)<(len2))?(len1):(len2)));
    }
  else
    {
      if (hard_LC_COLLATE)
        return xmemcoll (beg1, len1, beg2, len2);
      diff = memcmp (beg1, beg2, (((len1)<(len2))?(len1):(len2)));
    }
          ...
          if (keycmp (prev, current, join_field, join_field) > 0)
            {
              ...
              len = (((2147483647)<(len))?(2147483647):(len));

              error ((check_input_order == CHECK_ORDER_ENABLED
                      ? 1 : 0),
                     0, gettext ("%s:%""l" "u"": is not sorted: %.*s"),
...
get_line (FILE *fp, struct line **linep, int which)
{
  ...
  if (line == prevline[which - 1])
    {
      do { struct line *tmp = line; line = spareline[which - 1]; spareline[which - 1] = tmp; } while (0);;
      *linep = line;
    }
...
free_spareline (void)
{
  for (size_t i = 0; i < (sizeof (spareline) / sizeof *(spareline)); i++)
    {
      if (spareline[i])
        {
  ...
  if (n < line->nfields)
    {
      ...
      if (len)
        fwrite_unlocked (line->fields[n].beg,1,len,stdout);
  ...
  if (join_header_lines && (seq1.count || seq2.count))
    {
      ...
      prevline[1] = ((void*)0);
      if (seq1.count)
        advance_seq (fp1, &seq1, 1, 1);
      if (seq2.count)
        advance_seq (fp2, &seq2, 1, 2);
    }
...
add_field (int file, size_t field)
{
  ...
  ((void) sizeof ((file == 0 || file == 1 || file == 2) ? 1 : 0), __extension__ ({ if (file == 0 || file == 1 || file == 2) ; else __assert_fail ("file == 0 || file == 1 || file == 2", "join.c", 819, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((file != 0 || field == 0) ? 1 : 0), __extension__ ({ if (file != 0 || field == 0) ; else __assert_fail ("file != 0 || field == 0", "join.c", 820, __extension__ __PRETTY_FUNCTION__); }));
...
string_to_join_field (char const *str)
{
  ...
  if (s_err == LONGINT_OVERFLOW || (s_err == LONGINT_OK && (18446744073709551615UL) < val))
    val = (18446744073709551615UL);
  else if (s_err != LONGINT_OK || val == 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid field number: %s\"), quote (str)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid field number: %s"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid field number: %s"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
decode_field_spec (const char *s, int *file_index, size_t *field_index)
{
  ...
  switch (s[0])
      ...
      if (s[1])
        {
          ...
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid field specifier: %s\"), quote (s)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid field specifier: %s"), quote (s)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid field specifier: %s"), quote (s)), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
      *file_index = 0;
      *field_index = 0;
      break;
    ...
    default:
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid file number in field spec: %s\"), quote (s)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid file number in field spec: %s"), quote (s)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid file number in field spec: %s"), quote (s)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
{
  if (*var != (18446744073709551615UL) && *var != val)
    {
      unsigned long int var1 = *var + 1;
      unsigned long int val1 = val + 1;
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"incompatible join fields %lu, %lu\"), var1, val1), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("incompatible join fields %lu, %lu"), var1, val1), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("incompatible join fields %lu, %lu"), var1, val1), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
main (int argc, char **argv)
{
      ...
      switch (optc)
        ...
        case 'a':
          {
            ...
            if (xstrtoul (optarg, ((void*)0), 10, &val, "") != LONGINT_OK
                || (val != 1 && val != 2))
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid field number: %s\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid field number: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid field number: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
        ...
        case 'e':
          if (empty_filler && ! (strcmp (empty_filler, optarg) == 0))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"conflicting empty-field replacement strings\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("conflicting empty-field replacement strings")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("conflicting empty-field replacement strings")), ((0) ? (void) 0 : __builtin_unreachable ()))));
            ...
            if (! newtab)
            ...
            else if (optarg[1])
              {
                if ((strcmp (optarg, "\\0") == 0))
                  ...
                  ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multi-character tab %s\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multi-character tab %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multi-character tab %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));

              }
            if (0 <= tab && tab != newtab)
              ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"incompatible tabs\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("incompatible tabs")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("incompatible tabs")), ((0) ? (void) 0 : __builtin_unreachable ()))));
            tab = newtab;
          }
          break;
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "join", "GNU coreutils", Version, ("Mike Haertel"), (char *) ((void*)0)); exit (0); break;;
  ...
  if (!fp1)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[0])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[0])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[0])), ((0) ? (void) 0 : __builtin_unreachable ()))));
  fp2 = (strcmp (g_names[1], "-") == 0) ? stdin : fopen_safer (g_names[1], "r");
  if (!fp2)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[1])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[1])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, g_names[1])), ((0) ? (void) 0 : __builtin_unreachable ()))));
  if (fp1 == fp2)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"both files cannot be standard input\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("both files cannot be standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("both files cannot be standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  system_join (fp1, fp2);
  ...
  if (issued_disorder_warning[0] || issued_disorder_warning[1])
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"input is not in sorted order\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("input is not in sorted order")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("input is not in sorted order")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  else
    return 0;
}
