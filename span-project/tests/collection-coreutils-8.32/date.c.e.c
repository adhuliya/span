...
static _Bool show_date (const char *, struct timespec, timezone_t);
...
_Static_assert ((sizeof (time_spec_string) / sizeof *(time_spec_string)) == (sizeof (time_spec) / sizeof *(time_spec)) + 1, "verify (" "ARRAY_CARDINALITY (time_spec_string) == ARRAY_CARDINALITY (time_spec) + 1" ")");
...
{
  {"date", 1, ((void*)0), 'd'},
  {"debug", 0, ((void*)0), DEBUG_DATE_PARSING},
  {"file", 1, ((void*)0), 'f'},
  {"iso-8601", 2, ((void*)0), 'I'},
  {"reference", 1, ((void*)0), 'r'},
  {"rfc-email", 0, ((void*)0), 'R'},
  {"rfc-822", 0, ((void*)0), 'R'},
  {"rfc-2822", 0, ((void*)0), 'R'},
  {"rfc-3339", 1, ((void*)0), RFC_3339_OPTION},
  {"set", 1, ((void*)0), 's'},
  {"uct", 0, ((void*)0), 'u'},
  {"utc", 0, ((void*)0), 'u'},
  {"universal", 0, ((void*)0), 'u'},
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("      --debug                annotate the parsed date,\n                              and warn about questionable usage to stderr\n"),stdout);
               ...
               timezone_t tz, char const *tzstring)
{
  ...
  if ((strcmp (input_filename, "-") == 0))
  ...
  else
    {
      ...
      if (in_stream == ((void*)0))
        {
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename)), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
    }
  ...
  while (1)
    {
      ...
      if (! parse_datetime2 (&when, line, ((void*)0),
...
{
  int optc;
  const char *datestr = ((void*)0);
  const char *set_datestr = ((void*)0);
  struct timespec when;
  _Bool set_date = 0;
  char const *format = ((void*)0);
  ...
  while ((optc = getopt_long (argc, argv, short_options, long_options, ((void*)0)))
         != -1)
    {
      char const *new_format = ((void*)0);
      ...
      switch (optc)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "date", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
        }
      ...
      if (new_format)
        {
          if (format)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple output formats specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple output formats specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple output formats specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          format = new_format;
        }
    }
  ...
  if (batch_file != ((void*)0))
  ...
  else
    {
          ...
          if (reference != ((void*)0))
            {
              if (stat (reference, &refstats) != 0)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, reference)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, reference)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, reference)), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          else
            {
              if (set_datestr)
                datestr = set_datestr;
              valid_date = parse_datetime2 (&when, datestr, ((void*)0),
      ...
      if (! valid_date)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid date %s\"), quote (datestr)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid date %s"), quote (datestr)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid date %s"), quote (datestr)), ((0) ? (void) 0 : __builtin_unreachable ()))));
