...
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stddef.h" 1 3
# 3 "../lib/randperm.h" 2
size_t randperm_bound (size_t, size_t) __attribute__ ((__const__));
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("Write a random permutation of the input lines to standard output.\n"),stdout);
      ...
      fputs_unlocked (gettext ("  -e, --echo                treat each ARG as an input line\n  -i, --input-range=LO-HI   treat each number LO through HI as an input line\n  -n, --head-count=COUNT    output at most COUNT lines\n  -o, --output=FILE         write result to FILE instead of standard output\n      --random-source=FILE  get random bytes from FILE\n  -r, --repeat              output lines can be repeated\n"),stdout);
...
enum
{
  RANDOM_SOURCE_OPTION = 127 + 1
};

static struct option const long_opts[] =
{
  {"echo", 0, ((void*)0), 'e'},
  {"input-range", 1, ((void*)0), 'i'},
  {"head-count", 1, ((void*)0), 'n'},
  {"output", 1, ((void*)0), 'o'},
...
input_size (void)
{
  ...
  if (fstat (0, &stat_buf) != 0)
    return ((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << ((sizeof (off_t) * 8) - 2)) - 1) * 2 + 1)));
...
{
  randint n_lines = 0;
  size_t n_alloc_lines = (((k)<(RESERVOIR_LINES_INCREMENT))?(k):(RESERVOIR_LINES_INCREMENT));
  struct linebuffer *line = ((void*)0);
  ...
  while (n_lines < k
         && (line =
             readlinebuffer_delim (&rsrv[n_lines], in, eolbyte)) != ((void*)0))
    {
      n_lines++;
...
# 218 "shuf.c"
      ...
      while (readlinebuffer_delim (line, in, eolbyte) != ((void*)0) && n_lines++);

      if (! n_lines)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 75, gettext (\"too many input lines\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 75, gettext ("too many input lines")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 75, gettext ("too many input lines")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  for (size_t i = 0; i < n_lines; i++)
    {
      ...
      if (fwrite_unlocked (p->buffer,sizeof (char),p->length,stdout) != p->length)
        return -1;
    }
  ...
  for (size_t i = 0; i < n_lines; i++)
    {
      ...
      size_t len = p[1] - p[0];
      if (fwrite_unlocked (p[0],sizeof *p[0],len,stdout) != len)
        return -1;
    }
...
main (int argc, char **argv)
{
  _Bool echo = 0;
  _Bool input_range = 0;
  size_t lo_input = (18446744073709551615UL);
  size_t hi_input = 0;
  size_t head_lines = (18446744073709551615UL);
  char const *outfile = ((void*)0);
  char *random_source = ((void*)0);
  char eolbyte = '\n';
  char **input_lines = ((void*)0);
  _Bool use_reservoir_sampling = 0;
  _Bool repeat = 0;
  ...
  size_t n_lines;
  char **line = ((void*)0);
  struct linebuffer *reservoir = ((void*)0);
  struct randint_source *randint_source;
  size_t *permutation = ((void*)0);
  int i;
  ...
  while ((optc = getopt_long (argc, argv, "ei:n:o:rz", long_opts, ((void*)0))) != -1)
    switch (optc)
      ...
      case 'i':
        {
          ...
          if (input_range)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple -i options specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple -i options specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple -i options specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          input_range = 1;

          if (p)
            {
              *p = '\0';
              lo_input = xdectoumax (optarg, 0, (18446744073709551615UL), "",
                                     gettext ("invalid input range"), 0);
              *p = '-';
              hi_optarg = p + 1;
            }

          hi_input = xdectoumax (hi_optarg, 0, (18446744073709551615UL), "",
                                 gettext ("invalid input range"), 0);

          n_lines = hi_input - lo_input + 1;
          invalid |= ((lo_input <= hi_input) == (n_lines == 0));
          if (invalid)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s: %s\", gettext (\"invalid input range\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s: %s", gettext ("invalid input range"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s: %s", gettext ("invalid input range"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      case 'n':
        {
          uintmax_t argval;
          strtol_error e = xstrtoumax (optarg, ((void*)0), 10, &argval, "");

          if (e == LONGINT_OK)
            head_lines = (((head_lines)<(argval))?(head_lines):(argval));
          else if (e != LONGINT_OVERFLOW)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid line count: %s\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid line count: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid line count: %s"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      case 'o':
        if (outfile && !(strcmp (outfile, optarg) == 0))
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple output files specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple output files specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple output files specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        outfile = optarg;
        break;

      case RANDOM_SOURCE_OPTION:
        if (random_source && !(strcmp (random_source, optarg) == 0))
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"multiple random sources specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("multiple random sources specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple random sources specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      case GETOPT_VERSION_CHAR: version_etc (stdout, "shuf", "GNU coreutils", Version, ("Paul Eggert"), (char *) ((void*)0)); exit (0); break;;
      default:
        usage (1);
      }
  ...
  if (input_range ? 0 < n_operands : !echo && 1 < n_operands)
    {
      error (0, 0, gettext ("extra operand %s"), quote (operand[!input_range]));
      usage (1);
    }
  ...
  if (head_lines == 0)
  ...
  else
    {
      ...
      if (n_operands == 1
          && ! ((strcmp (operand[0], "-") == 0)
                || freopen_safer (operand[0], "r", stdin)))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, operand[0])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, operand[0])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, operand[0])), ((0) ? (void) 0 : __builtin_unreachable ()))));

      fadvise (stdin, FADVISE_SEQUENTIAL);

      if (repeat || head_lines == (18446744073709551615UL)
  ...
  if (! randint_source)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, random_source)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, random_source)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, random_source)), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (! (head_lines == 0 || echo || input_range || rpl_fclose (stdin) == 0))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"read error\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("read error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("read error")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  if (!repeat)
    permutation = randperm_new (randint_source, ahead_lines, n_lines);

  if (outfile && ! freopen_safer (outfile, "w", stdout))
  ...
  if (repeat)
    {
      if (head_lines == 0)
        ...
        {
          if (n_lines == 0)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"no lines to repeat\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("no lines to repeat")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("no lines to repeat")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          if (input_range)
