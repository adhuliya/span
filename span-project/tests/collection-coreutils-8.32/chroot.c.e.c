...
# 32 "chroot.c" 2
# 1 "../lib/root-dev-ino.h" 1
# 21 "../lib/root-dev-ino.h"
# 1 "../lib/dev-ino.h" 1
...
# 35 "chroot.c" 2
# 45 "chroot.c"
static inline _Bool uid_unset (uid_t uid) { return uid == (uid_t) -1; }
static inline _Bool gid_unset (gid_t gid) { return gid == (gid_t) -1; }
...
static struct option const long_opts[] =
{
  ...
  {"skip-chdir", 0, ((void*)0), SKIP_CHDIR},
  ...
  for (tmp = strtok (buffer, ","); tmp; tmp = strtok (((void*)0), ","))
    {
      ...
      if (xstrtoumax (tmp, ((void*)0), 10, &value, "") == LONGINT_OK
        ...
        {
          while (((*__ctype_b_loc ())[(int) ((to_uchar (*tmp)))] & (unsigned short int) _ISspace))
            tmp++;
          if (*tmp != '+')
            {
...
is_root (const char* dir)
{
  ...
  _Bool is_res_root = resolved && (strcmp ("/", resolved) == 0);
  free (resolved);
  return is_res_root;
}
...
main (int argc, char **argv)
{
  ...
  if (! is_oldroot)
    {
      ...
      if (userspec)
        (__extension__ ({ __typeof__ (parse_user_spec (userspec, &uid, &gid, ((void*)0), ((void*)0))) __x = (parse_user_spec (userspec, &uid, &gid, ((void*)0), ((void*)0))); (void) __x; }));
      ...
      if (groups && *groups)
        (__extension__ ({ __typeof__ (parse_additional_groups (groups, &out_gids, &n_gids, 0)) __x = (parse_additional_groups (groups, &out_gids, &n_gids, 0)); (void) __x; }));
  ...
  if (chroot (newroot) != 0)
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"cannot change root directory to %s\"), quotearg_style (shell_escape_always_quoting_style, newroot)), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot change root directory to %s"), quotearg_style (shell_escape_always_quoting_style, newroot)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot change root directory to %s"), quotearg_style (shell_escape_always_quoting_style, newroot)), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (! skip_chdir && chdir ("/"))
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"cannot chdir to root directory\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot chdir to root directory")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("cannot chdir to root directory")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (userspec)
    {
      char const *err = parse_user_spec (userspec, &uid, &gid, ((void*)0), ((void*)0));

      if (err && uid_unset (uid) && gid_unset (gid))
        ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), \"%s\", (err)), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), "%s", (err)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), "%s", (err)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
  ...
  if ((!uid_unset (uid)) && (! groups || gid_unset (gid)))
    {
      ...
      if ((pwd = getpwuid (uid)))
        ...
        {
          ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"no group specified for unknown uid: %d\"), (int) uid), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("no group specified for unknown uid: %d"), (int) uid), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("no group specified for unknown uid: %d"), (int) uid), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (groups && *groups)
  ...
  else if (! groups && (!gid_unset (gid)) && username)
    {
      ...
      if (ngroups <= 0)
        {
          if (! n_gids)
            ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to get supplemental groups\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get supplemental groups")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to get supplemental groups")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  if (((!uid_unset (uid)) || groups) && setgroups (n_gids, gids) != 0)
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to set supplemental groups\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set supplemental groups")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set supplemental groups")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  free (in_gids);
  free (out_gids);

  if ((!gid_unset (gid)) && setgid (gid))
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to set group-ID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set group-ID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set group-ID")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  if ((!uid_unset (uid)) && setuid (uid))
    ((!!sizeof (struct { _Static_assert (EXIT_CANCELED, "verify_expr (" "EXIT_CANCELED" ", " "(error (EXIT_CANCELED, (*__errno_location ()), gettext (\"failed to set user-ID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set user-ID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (EXIT_CANCELED, (*__errno_location ()), gettext ("failed to set user-ID")), ((0) ? (void) 0 : __builtin_unreachable ()))));
