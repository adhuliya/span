...
# 1 "../lib/mgetgroups.h" 1
# 17 "../lib/mgetgroups.h"
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
# 18 "../lib/mgetgroups.h" 2
...
# 1 "./group-list.h" 1
# 18 "./group-list.h"
_Bool print_group (gid_t, _Bool);
_Bool print_group_list (const char *, uid_t, gid_t, gid_t, _Bool, char);
# 34 "id.c" 2
# 1 "../lib/smack.h" 1
# 20 "../lib/smack.h"
# 1 "../lib/config.h" 1
...
# 36 "id.c" 2
# 45 "id.c"
static _Bool just_context = 0;

static _Bool opt_zero = 0;

static _Bool just_group_list = 0;

static _Bool just_group = 0;

static _Bool use_real = 0;

static _Bool just_user = 0;

static _Bool ok = 1;

static _Bool multiple_users = 0;

static _Bool use_name = 0;
...
main (int argc, char **argv)
{
  ...
  while ((optc = getopt_long (argc, argv, "agnruzGZ", longopts, ((void*)0))) != -1)
    {
      switch (optc)
        ...
        case 'Z':
          ...
          if (!selinux_enabled)
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"--context (-Z) works only on an SELinux-enabled kernel\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("--context (-Z) works only on an SELinux-enabled kernel")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("--context (-Z) works only on an SELinux-enabled kernel")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "id", "GNU coreutils", Version, ("Arnold Robbins"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
        }
    }
  ...
  if (n_ids && just_context)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot print security context when user specified\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot print security context when user specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot print security context when user specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (just_user + just_group + just_group_list + just_context > 1)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot print \\\"only\\\" of more than one choice\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot print \"only\" of more than one choice")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot print \"only\" of more than one choice")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  _Bool default_format = ! (just_user
                           || just_group
                           || just_group_list
                           || just_context);

  if (default_format && (use_real || use_name))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot print only names or real IDs in default format\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot print only names or real IDs in default format")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot print only names or real IDs in default format")), ((0) ? (void) 0 : __builtin_unreachable ()))));


  if (default_format && opt_zero)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"option --zero not permitted in default format\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("option --zero not permitted in default format")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("option --zero not permitted in default format")), ((0) ? (void) 0 : __builtin_unreachable ()))));
          ...
          || (default_format && ! getenv ("POSIXLY_CORRECT"))))
    {
      ...
      if ((selinux_enabled && getcon (&context) && just_context)
          || (smack_enabled
              ...
              && just_context))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"can't get process context\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("can't get process context")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("can't get process context")), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
      ...
      for (; optind < n_ids; optind++)
        {
          ...
          if (*spec)
            {
              if (parse_user_spec (spec, &euid, ((void*)0), ((void*)0), ((void*)0)) == ((void*)0))
                {
          ...
          if (pwd == ((void*)0))
            {
              error (0, (*__errno_location ()), gettext ("%s: no such user"), quote (argv[optind]));
              ok &= 0;
              continue;
            }
      ...
      if (just_user ? !use_real
          : !just_group && !just_group_list && !just_context)
        {
          ...
          if (euid == NO_UID && (*__errno_location ()))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot get effective UID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot get effective UID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot get effective UID")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
      ...
      if (just_user ? use_real
          : !just_group && (just_group_list || !just_context))
        {
          ...
          if (ruid == NO_UID && (*__errno_location ()))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot get real UID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot get real UID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot get real UID")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
      ...
      if (!just_user && (just_group || just_group_list || !just_context))
        {
          ...
          if (egid == NO_GID && (*__errno_location ()))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot get effective GID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot get effective GID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot get effective GID")), ((0) ? (void) 0 : __builtin_unreachable ()))));

          (*__errno_location ()) = 0;
          rgid = getgid ();
          if (rgid == NO_GID && (*__errno_location ()))
            ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot get real GID\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot get real GID")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot get real GID")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
        print_stuff (pw_name);
    }
  ...
  if (use_name)
    {
      ...
      if (pwd == ((void*)0))
        {
          error (0, 0, gettext ("cannot find name for user ID %s"),
                 uidtostr_ptr (&(uid)));
          ok &= 0;
        }
    }

  char *s = pwd ? pwd->pw_name : uidtostr_ptr (&(uid));
...
print_full_info (const char *username)
{
...

  {
    ...
    if (n_groups < 0)
      {
        if (username)
          error (0, (*__errno_location ()), gettext ("failed to get groups for user %s"),
                 quote (username));
        else
