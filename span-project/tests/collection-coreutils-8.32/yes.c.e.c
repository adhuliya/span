...
main (int argc, char **argv)
{
  ...
  parse_gnu_standard_options_only (argc, argv, "yes", "GNU coreutils",
                                   Version, 1, usage, ("David MacKenzie"),
                                   (char const *) ((void*)0));
  ...
  while (full_write (1, buf, bufused) == bufused)
    continue;
