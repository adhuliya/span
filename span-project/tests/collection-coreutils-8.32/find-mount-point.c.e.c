...
find_mount_point (char const *file, struct stat const *file_stat)
{
  ...
  if (((((file_stat->st_mode)) & 0170000) == (0040000)))

    {
      ...
      if (chdir (file) < 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, file));
          return ((void*)0);
        }
    }
  else

    {
      ...
      if (chdir (dir) < 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, dir));
          return ((void*)0);
        }
  ...
  while (1)
    {
      ...
      if (stat ("..", &st) < 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot stat %s"), quotearg_style (shell_escape_always_quoting_style, ".."));
          goto done;
        }
      ...
      if (chdir ("..") < 0)
        {
          error (0, (*__errno_location ()), gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, ".."));
          goto done;
        }
      last_stat = st;
    }
...

  {
    ...
    if (restore_cwd (&cwd) != 0)
      ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to return to initial working directory\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("failed to return to initial working directory")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("failed to return to initial working directory")), ((0) ? (void) 0 : __builtin_unreachable ()))));
