...
# 1882 "../lib/stdio.h" 3
extern int _gl_cxxalias_dummy;
# 21 "expand-common.c" 2
# 1 "../lib/sys/types.h" 1
# 21 "../lib/sys/types.h" 3
# 22 "expand-common.c" 2
# 1 "./system.h" 1
# 19 "./system.h"
# 1 "../lib/alloca.h" 1
# 20 "./system.h" 2
...
# 28 "expand-common.c" 2

# 1 "./expand-common.h" 1
# 20 "./expand-common.h"
extern _Bool convert_entire_line;
...
# 30 "expand-common.c" 2



_Bool convert_entire_line = 0;
...
static uintmax_t *tab_list = ((void*)0);
...
add_tab_stop (uintmax_t tabval)
{
  ...
  if (first_free_tab == n_tabs_allocated)
    tab_list = ((!!sizeof (struct { _Static_assert (sizeof *(tab_list) != 1, "verify_expr (" "sizeof *(tab_list) != 1" ", " "x2nrealloc (tab_list, &n_tabs_allocated, sizeof *(tab_list))" ")"); int _gl_dummy; })) ? (x2nrealloc (tab_list, &n_tabs_allocated, sizeof *(tab_list))) : (x2nrealloc (tab_list, &n_tabs_allocated, sizeof *(tab_list))));
  tab_list[first_free_tab++] = tabval;

  if (max_column_width < column_width)
    {
      if ((18446744073709551615UL) < column_width)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"tabs are too far apart\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("tabs are too far apart")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("tabs are too far apart")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
parse_tab_stops (char const *stops)
{
  _Bool have_tabval = 0;
  uintmax_t tabval = 0;
  _Bool extend_tabval = 0;
  _Bool increment_tabval = 0;
  char const *num_start = ((void*)0);
  _Bool ok = 1;

  for (; *stops; stops++)
    {
      if (*stops == ',' || ((*__ctype_b_loc ())[(int) ((to_uchar (*stops)))] & (unsigned short int) _ISblank))
        {
          if (have_tabval)
            {
              if (extend_tabval)
      ...
      else if (*stops == '/')
        {
          if (have_tabval)
            {
              error (0, 0, gettext ("'/' specifier not at start of number: %s"),
                     quote (stops));
              ok = 0;
            }
          extend_tabval = 1;
      ...
      else if (((unsigned int) (*stops) - '0' <= 9))
        {
          if (!have_tabval)
            {
              tabval = 0;
          ...
          if (!( (void) (&(tabval) == (uintmax_t *) ((void*)0)), ((!!sizeof (struct { _Static_assert (! (! ((uintmax_t) 0 < (uintmax_t) -1)), "verify_expr (" "! TYPE_SIGNED (uintmax_t)" ", " "(((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (*stops - '0')) < (tabval)) ? false : (((tabval) = (tabval) * 10 + (*stops - '0')), true))" ")"); int _gl_dummy; })) ? ((((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (*stops - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (*stops - '0')), 1))) : ((((uintmax_t) -1 / 10 < (tabval) || (uintmax_t) ((tabval) * 10 + (*stops - '0')) < (tabval)) ? 0 : (((tabval) = (tabval) * 10 + (*stops - '0')), 1)))) ))
            {
        ...
        {
          error (0, 0, gettext ("tab size contains invalid character(s): %s"),
                 quote (stops));
          ok = 0;
          break;
        }
...
validate_tab_stops (uintmax_t const *tabs, size_t entries)
{
  ...
  for (size_t i = 0; i < entries; i++)
    {
      if (tabs[i] == 0)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"tab size cannot be 0\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("tab size cannot be 0")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("tab size cannot be 0")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      if (tabs[i] <= prev_tab)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"tab sizes must be ascending\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("tab sizes must be ascending")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("tab sizes must be ascending")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      prev_tab = tabs[i];
    }

  if (increment_size && extend_size)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"'/' specifier is mutually exclusive with '+'\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("'/' specifier is mutually exclusive with '+'")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("'/' specifier is mutually exclusive with '+'")), ((0) ? (void) 0 : __builtin_unreachable ()))));
}
# 262 "expand-common.c"
extern void
finalize_tab_stops (void)
...
next_file (FILE *fp)
{
  ...
  if (fp)
    {
      ((void) sizeof ((prev_file) ? 1 : 0), __extension__ ({ if (prev_file) ; else __assert_fail ("prev_file", "expand-common.c", 341, __extension__ __PRETTY_FUNCTION__); }));
      if (ferror_unlocked (fp))
        {
          error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, prev_file));
          exit_status = 1;
        }
      if ((strcmp (prev_file, "-") == 0))
...
emit_tab_list_info (void)
{
  ...
  fputs_unlocked (gettext ("                     The last specified position can be prefixed with '/'\n                     to specify a tab size to use after the last\n                     explicitly specified tab stop.  Also a prefix of '+'\n                     can be used to align remaining tab stops relative to\n                     the last specified tab stop instead of the first column\n"),stdout);
