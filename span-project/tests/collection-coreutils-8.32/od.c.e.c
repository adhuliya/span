...
# 1 "../lib/ftoastr.h" 1
# 23 "../lib/ftoastr.h"
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/float.h" 1 3
# 24 "../lib/ftoastr.h" 2
# 1 "/home/codeman/.itsoflife/mydata/local/packages-live/llvm-clang9.0.0/build/lib/clang/9.0.0/include/stddef.h" 1 3
# 25 "../lib/ftoastr.h" 2
# 47 "../lib/ftoastr.h"
...
extern int xvprintf (char const *__restrict format, va_list args)
  __attribute__ ((__format__ (__printf__, 1, 0)));
extern int xfprintf (FILE *__restrict stream, char const *__restrict format, ...)
  __attribute__ ((__format__ (__printf__, 2, 3)));
extern int xvfprintf (FILE *__restrict stream, char const *__restrict format,
                      va_list args)
  __attribute__ ((__format__ (__printf__, 2, 0)));
# 34 "od.c" 2
# 1 "../lib/xstrtol.h" 1
...
enum
  {
    FMT_BYTES_ALLOCATED =
           (sizeof "%*.99" - 1
            + (((sizeof "ld")>((((sizeof "l" "d")>((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))))?(sizeof "l" "d"):((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))))))?(sizeof "ld"):((((sizeof "l" "d")>((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))))?(sizeof "l" "d"):((((sizeof "l" "o")>((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x"))))?(sizeof "l" "o"):((((sizeof "l" "u")>(sizeof "l" "x"))?(sizeof "l" "u"):(sizeof "l" "x")))))))))
...
_Static_assert (sizeof (unsigned_long_long_int) * 8 / 3 <= 99, "verify (" "MAX_INTEGRAL_TYPE_SIZE * CHAR_BIT / 3 <= 99" ")");
...
_Static_assert (sizeof (unsigned_long_long_int) < (sizeof (bytes_to_hex_digits) / sizeof *(bytes_to_hex_digits)), "verify (" "MAX_INTEGRAL_TYPE_SIZE < ARRAY_CARDINALITY (bytes_to_hex_digits)" ")");


_Static_assert (sizeof bytes_to_oct_digits == sizeof bytes_to_signed_dec_digits, "verify (" "sizeof bytes_to_oct_digits == sizeof bytes_to_signed_dec_digits" ")");
_Static_assert (sizeof bytes_to_oct_digits == sizeof bytes_to_unsigned_dec_digits, "verify (" "sizeof bytes_to_oct_digits == sizeof bytes_to_unsigned_dec_digits" ")");
_Static_assert (sizeof bytes_to_oct_digits == sizeof bytes_to_hex_digits, "verify (" "sizeof bytes_to_oct_digits == sizeof bytes_to_hex_digits" ")");
...
_Static_assert ((sizeof (width_bytes) / sizeof *(width_bytes)) == N_SIZE_SPECS, "verify (" "ARRAY_CARDINALITY (width_bytes) == N_SIZE_SPECS" ")");
...
# 471 "od.c"
static void print_s_char (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { signed char const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; signed char x; if (input_swap && sizeof (signed char) > 1) { size_t j; union { signed char x; char b[sizeof (signed char)]; } u; for (j = 0; j < sizeof (signed char); j++) u.b[j] = ((const char *) p)[sizeof (signed char) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_char (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { unsigned char const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; unsigned char x; if (input_swap && sizeof (unsigned char) > 1) { size_t j; union { unsigned char x; char b[sizeof (unsigned char)]; } u; for (j = 0; j < sizeof (unsigned char); j++) u.b[j] = ((const char *) p)[sizeof (unsigned char) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_s_short (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { short int const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; short int x; if (input_swap && sizeof (short int) > 1) { size_t j; union { short int x; char b[sizeof (short int)]; } u; for (j = 0; j < sizeof (short int); j++) u.b[j] = ((const char *) p)[sizeof (short int) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_short (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { unsigned short int const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; unsigned short int x; if (input_swap && sizeof (unsigned short int) > 1) { size_t j; union { unsigned short int x; char b[sizeof (unsigned short int)]; } u; for (j = 0; j < sizeof (unsigned short int); j++) u.b[j] = ((const char *) p)[sizeof (unsigned short int) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_int (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { unsigned int const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; unsigned int x; if (input_swap && sizeof (unsigned int) > 1) { size_t j; union { unsigned int x; char b[sizeof (unsigned int)]; } u; for (j = 0; j < sizeof (unsigned int); j++) u.b[j] = ((const char *) p)[sizeof (unsigned int) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_long (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { unsigned long int const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; unsigned long int x; if (input_swap && sizeof (unsigned long int) > 1) { size_t j; union { unsigned long int x; char b[sizeof (unsigned long int)]; } u; for (j = 0; j < sizeof (unsigned long int); j++) u.b[j] = ((const char *) p)[sizeof (unsigned long int) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }
static void print_long_long (size_t fields, size_t blank, void const *block, char const *fmt_string, int width, int pad) { unsigned_long_long_int const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; unsigned_long_long_int x; if (input_swap && sizeof (unsigned_long_long_int) > 1) { size_t j; union { unsigned_long_long_int x; char b[sizeof (unsigned_long_long_int)]; } u; for (j = 0; j < sizeof (unsigned_long_long_int); j++) u.b[j] = ((const char *) p)[sizeof (unsigned_long_long_int) - 1 - j]; x = u.x; } else x = *p; p++; xprintf (fmt_string, adjusted_width, x); pad_remaining = next_pad; } }

static void print_float (size_t fields, size_t blank, void const *block, char const *fmt_string __attribute__ ((__unused__)), int width, int pad) { float const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; float x; if (input_swap && sizeof (float) > 1) { size_t j; union { float x; char b[sizeof (float)]; } u; for (j = 0; j < sizeof (float); j++) u.b[j] = ((const char *) p)[sizeof (float) - 1 - j]; x = u.x; } else x = *p; p++; char buf[( (1 + (((((24) * 1) * 146 + 484) / 485) + 1) + 16 + 1 + ( -100 < ((-37)) && (38) < 100 ? 3 : -1000 < ((-37)) && (38) < 1000 ? 4 : -10000 < ((-37)) && (38) < 10000 ? 5 : -100000 < ((-37)) && (38) < 100000 ? 6 : -1000000 < ((-37)) && (38) < 1000000 ? 7 : (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) )) + 1)]; ftoastr (buf, sizeof buf, 0, 0, x); xprintf ("%*s", adjusted_width, buf); pad_remaining = next_pad; } }
static void print_double (size_t fields, size_t blank, void const *block, char const *fmt_string __attribute__ ((__unused__)), int width, int pad) { double const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; double x; if (input_swap && sizeof (double) > 1) { size_t j; union { double x; char b[sizeof (double)]; } u; for (j = 0; j < sizeof (double); j++) u.b[j] = ((const char *) p)[sizeof (double) - 1 - j]; x = u.x; } else x = *p; p++; char buf[( (1 + (((((53) * 1) * 146 + 484) / 485) + 1) + 16 + 1 + ( -100 < ((-307)) && (308) < 100 ? 3 : -1000 < ((-307)) && (308) < 1000 ? 4 : -10000 < ((-307)) && (308) < 10000 ? 5 : -100000 < ((-307)) && (308) < 100000 ? 6 : -1000000 < ((-307)) && (308) < 1000000 ? 7 : (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) )) + 1)]; dtoastr (buf, sizeof buf, 0, 0, x); xprintf ("%*s", adjusted_width, buf); pad_remaining = next_pad; } }
static void print_long_double (size_t fields, size_t blank, void const *block, char const *fmt_string __attribute__ ((__unused__)), int width, int pad) { long double const *p = block; uintmax_t i; int pad_remaining = pad; for (i = fields; blank < i; i--) { int next_pad = pad * (i - 1) / fields; int adjusted_width = pad_remaining - next_pad + width; long double x; if (input_swap && sizeof (long double) > 1) { size_t j; union { long double x; char b[sizeof (long double)]; } u; for (j = 0; j < sizeof (long double); j++) u.b[j] = ((const char *) p)[sizeof (long double) - 1 - j]; x = u.x; } else x = *p; p++; char buf[((1 + (((((64) * 1) * 146 + 484) / 485) + 1) + 16 + 1 + ( -100 < ((-4931)) && (4932) < 100 ? 3 : -1000 < ((-4931)) && (4932) < 1000 ? 4 : -10000 < ((-4931)) && (4932) < 10000 ? 5 : -100000 < ((-4931)) && (4932) < 100000 ? 6 : -1000000 < ((-4931)) && (4932) < 1000000 ? 7 : (((((sizeof (int) * 8) - (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (int)) 0 < (__typeof__ (int)) -1))) )) + 1)]; ldtoastr (buf, sizeof buf, 0, 0, x); xprintf ("%*s", adjusted_width, buf); pad_remaining = next_pad; } }
  ...
  for (size_t i = n_bytes; i > 0; i--)
    {
      ...
      unsigned char c2 = (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISprint) ? c : '.');
      putchar_unlocked (c2);
    }
  putchar_unlocked ('<');
}
...
print_named_ascii (size_t fields, size_t blank, void const *block,
                   const char *unused_fmt_string __attribute__ ((__unused__)),
                   int width, int pad)
{
...
print_ascii (size_t fields, size_t blank, void const *block,
             const char *unused_fmt_string __attribute__ ((__unused__)), int width,
             int pad)
{
  unsigned char const *p = block;
  uintmax_t i;
  ...
  for (i = fields; blank < i; i--)
    {
      ...
      switch (c)
        ...
        default:
          sprintf (buf, (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISprint) ? "%c" : "%03o"), c);
          s = buf;
        }
...
simple_strtoul (const char *s, const char **p, unsigned long int *val)
{
  ...
  while (((unsigned int) (*s) - '0' <= 9))
    {
      int c = *s++ - '0';
      if (sum > ((9223372036854775807L *2UL+1UL) - c) / 10)
        return 0;
      sum = sum * 10 + c;
    }
  *p = s;
                   ...
                   struct tspec *tspec)
{
  ...
  ((void) sizeof ((tspec != ((void*)0)) ? 1 : 0), __extension__ ({ if (tspec != ((void*)0)) ; else __assert_fail ("tspec != NULL", "od.c", 647, __extension__ __PRETTY_FUNCTION__); }));
  ...
  switch (*s)
    ...
    case 'x':
      ...
      switch (c)
        ...
        case 'd':
          ...
          sprintf (tspec->fmt_string, "%%*%s",
                   ((size_spec) == LONG_LONG ? ("l" "d") : ((size_spec) == LONG ? ("ld") : ("d"))));
          break;
        ...
        case 'o':
          ...
          sprintf (tspec->fmt_string, "%%*.%d%s",
                   ...
                   ((size_spec) == LONG_LONG ? ("l" "o") : ((size_spec) == LONG ? ("lo") : ("o"))));
          break;
        ...
        case 'u':
          ...
          sprintf (tspec->fmt_string, "%%*%s",
                   ((size_spec) == LONG_LONG ? ("l" "u") : ((size_spec) == LONG ? ("lu") : ("u"))));
          break;
        ...
        case 'x':
          ...
          sprintf (tspec->fmt_string, "%%*.%d%s",
                   ...
                   ((size_spec) == LONG_LONG ? ("l" "x") : ((size_spec) == LONG ? ("lx") : ("x"))));
          break;
      ...
      ((void) sizeof ((strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED) ? 1 : 0), __extension__ ({ if (strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED) ; else __assert_fail ("strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED", "od.c", 746, __extension__ __PRETTY_FUNCTION__); }));
  ...
  do
    {
      ...
      if ((strcmp (input_filename, "-") == 0))
      ...
      else
        {
          ...
          if (in_stream == ((void*)0))
            {
              error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename));
              ok = 0;
            }
        }
    }
  ...
  if (in_stream != ((void*)0))
    {
      if (ferror_unlocked (in_stream))
        {
          error (0, in_errno, gettext ("%s: read error"), quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename));
          if (! (strcmp (file_list[-1], "-") == 0))
            rpl_fclose (in_stream);
          ok = 0;
        }
      else if (! (strcmp (file_list[-1], "-") == 0) && rpl_fclose (in_stream) != 0)
        {
          error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, input_filename));
          ok = 0;
        }
...
{
  const char *s_orig = s;
  ((void) sizeof ((s != ((void*)0)) ? 1 : 0), __extension__ ({ if (s != ((void*)0)) ; else __assert_fail ("s != NULL", "od.c", 985, __extension__ __PRETTY_FUNCTION__); }));
  ...
  while (*s != '\0')
    {
      ...
      if (n_specs_allocated <= n_specs)
        spec = ((!!sizeof (struct { _Static_assert (sizeof *(spec) != 1, "verify_expr (" "sizeof *(spec) != 1" ", " "x2nrealloc (spec, &n_specs_allocated, sizeof *(spec))" ")"); int _gl_dummy; })) ? (x2nrealloc (spec, &n_specs_allocated, sizeof *(spec))) : (x2nrealloc (spec, &n_specs_allocated, sizeof *(spec))));

      if (! decode_one_format (s_orig, s, &next, &spec[n_specs]))
        return 0;

      ((void) sizeof ((s != next) ? 1 : 0), __extension__ ({ if (s != next) ; else __assert_fail ("s != next", "od.c", 997, __extension__ __PRETTY_FUNCTION__); }));
      s = next;
      ++n_specs;
    }
...
# 1046 "od.c"
          if (usable_size && ((0 < (file_stats).st_blksize && (file_stats).st_blksize <= ((size_t)-1) / 8 + 1) ? (file_stats).st_blksize : 512) < file_stats.st_size)
            {
  ...
  if (n_skip != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"cannot skip past end of combined input\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("cannot skip past end of combined input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot skip past end of combined input")), ((0) ? (void) 0 : __builtin_unreachable ()))));

  return ok;
}

static void
format_address_none (uintmax_t address __attribute__ ((__unused__)),
...
read_block (size_t n, char *block, size_t *n_bytes_in_buffer)
{
  ...
  ((void) sizeof ((0 < n && n <= bytes_per_block) ? 1 : 0), __extension__ ({ if (0 < n && n <= bytes_per_block) ; else __assert_fail ("0 < n && n <= bytes_per_block", "od.c", 1293, __extension__ __PRETTY_FUNCTION__); }));
      ...
      while (1)
        {
          ...
          n_needed = (((end_offset - current_offset)<((uintmax_t) bytes_per_block))?(end_offset - current_offset):((uintmax_t) bytes_per_block));

          ok &= read_block (n_needed, block[idx], &n_bytes_read);
          if (n_bytes_read < bytes_per_block)
            break;
          ((void) sizeof ((n_bytes_read == bytes_per_block) ? 1 : 0), __extension__ ({ if (n_bytes_read == bytes_per_block) ; else __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1403, __extension__ __PRETTY_FUNCTION__); }));
      ...
      while (1)
        {
          ...
          if (n_bytes_read < bytes_per_block)
            break;
          ((void) sizeof ((n_bytes_read == bytes_per_block) ? 1 : 0), __extension__ ({ if (n_bytes_read == bytes_per_block) ; else __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1417, __extension__ __PRETTY_FUNCTION__); }));
          write_block (current_offset, n_bytes_read,
                       block[!idx], block[idx]);
          current_offset += n_bytes_read;
          idx = !idx;
      ...
      while (!limit_bytes_to_format || address < end_offset)
        {
          if (i == bufsize)
            {
              buf = ((!!sizeof (struct { _Static_assert (sizeof *(buf) == 1, "verify_expr (" "sizeof *(buf) == 1" ", " "x2realloc (buf, &bufsize)" ")"); int _gl_dummy; })) ? (x2realloc (buf, &bufsize)) : (x2realloc (buf, &bufsize)));
            }
          ok &= read_char (&c);
          address++;
          if (c < 0)
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'N':
          ...
          s_err = xstrtoumax (optarg, ((void*)0), 0, &max_bytes_to_format,
                              multipliers);
          if (s_err != LONGINT_OK)
            xstrtol_fatal (s_err, oi, c, long_options, optarg);
          break;
          ...
          if (optarg == ((void*)0))
          ...
          else
            {
              ...
              if ((18446744073709551615UL) < tmp)
                ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"%s is too large\"), quote (optarg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
# 1742 "od.c"
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "od", "GNU coreutils", Version, ("Jim Meyering"), (char *) ((void*)0)); exit (0); break;;
  ...
  if (limit_bytes_to_format)
    {
      ...
      if (end_offset < n_bytes_to_skip)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"skip-bytes + read-bytes is too large\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("skip-bytes + read-bytes is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("skip-bytes + read-bytes is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
