...
# 36 "nl.c" 2
# 48 "nl.c"
static char const FORMAT_RIGHT_NOLZ[] = "%*" "l" "d" "%s";


static char const FORMAT_RIGHT_LZ[] = "%0*" "l" "d" "%s";


static char const FORMAT_LEFT[] = "%-*" "l" "d" "%s";
...
static char body_fastmap[(127*2 +1) + 1];
static char header_fastmap[(127*2 +1) + 1];
static char footer_fastmap[(127*2 +1) + 1];


static struct re_pattern_buffer *current_regex = ((void*)0);
...
static char *header_del = ((void*)0);


static size_t header_del_len;


static char *body_del = ((void*)0);


static size_t body_del_len;


static char *footer_del = ((void*)0);
...
static char *print_no_line_fmt = ((void*)0);
...
{
  {"header-numbering", 1, ((void*)0), 'h'},
  {"body-numbering", 1, ((void*)0), 'b'},
  {"footer-numbering", 1, ((void*)0), 'f'},
  {"starting-line-number", 1, ((void*)0), 'v'},
  {"line-increment", 1, ((void*)0), 'i'},
  {"no-renumber", 0, ((void*)0), 'p'},
  {"join-blank-lines", 1, ((void*)0), 'l'},
  {"number-separator", 1, ((void*)0), 's'},
  {"number-width", 1, ((void*)0), 'w'},
  {"number-format", 1, ((void*)0), 'n'},
  {"section-delimiter", 1, ((void*)0), 'd'},
                ...
                struct re_pattern_buffer *regexp, char *fastmap)
{
  ...
  switch (*optarg)
    ...
    case 'p':
      *typep = optarg++;
      regexp->buffer = ((void*)0);
      regexp->allocated = 0;
      regexp->fastmap = fastmap;
      regexp->translate = ((void*)0);
      ...
      if (errmsg)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, \"%s\", (errmsg)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, "%s", (errmsg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, "%s", (errmsg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      break;
    default:
      rval = 0;
      break;
...
print_lineno (void)
{
  ...
  if (__builtin_add_overflow (line_no, page_incr, &line_no))
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"line number overflow\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("line number overflow")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("line number overflow")), ((0) ? (void) 0 : __builtin_unreachable ()))));
}
...
proc_text (void)
{
  ...
  switch (*current_type)
    ...
    case 'n':
      ...
      break;
    case 'p':
      switch (rpl_re_search (current_regex, line_buf.buffer, line_buf.length - 1,
                         0, line_buf.length - 1, ((void*)0)))
        {
        case -2:
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"error in regular expression search\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("error in regular expression search")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("error in regular expression search")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  fwrite_unlocked (line_buf.buffer,sizeof (char),line_buf.length,stdout);
}
      ...
      switch (c)
        ...
        case 'h':
          if (! build_type_arg (&header_type, &header_regex, header_fastmap))
            {
              error (0, 0, gettext ("invalid header numbering style: %s"),
                     quote (optarg));
              ok = 0;
            }
          break;
        case 'b':
          if (! build_type_arg (&body_type, &body_regex, body_fastmap))
            {
              error (0, 0, gettext ("invalid body numbering style: %s"),
                     quote (optarg));
              ok = 0;
            }
          break;
        case 'f':
          if (! build_type_arg (&footer_type, &footer_regex, footer_fastmap))
            {
              error (0, 0, gettext ("invalid footer numbering style: %s"),
                     quote (optarg));
              ok = 0;
            }
          break;
        case 'v':
          starting_line_number = xdectoimax (optarg, (-9223372036854775807L -1), (9223372036854775807L), "",
                                             gettext ("invalid starting line number"),
                                             0);
          break;
        case 'i':
          page_incr = xdectoimax (optarg, 1, (9223372036854775807L), "",
                                  gettext ("invalid line number increment"), 0);
          break;
        case 'p':
          reset_numbers = 0;
          break;
        case 'l':
          blank_join = xdectoimax (optarg, 1, (9223372036854775807L), "",
                                   gettext ("invalid line number of blank lines"), 0);
          break;
        case 's':
          separator_str = optarg;
          break;
        case 'w':
          lineno_width = xdectoimax (optarg, 1, 2147483647, "",
                                     gettext ("invalid line number field width"), 0);
          break;
        case 'n':
          if ((strcmp (optarg, "ln") == 0))
            ...
            {
              error (0, 0, gettext ("invalid line numbering format: %s"),
                     quote (optarg));
              ok = 0;
            }
          break;
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "nl", "GNU coreutils", Version, ("Scott Bartram"), ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          ok = 0;
          break;
        }
