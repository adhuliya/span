...
enum
{
  RELATIVE_TO_OPTION = 127 + 1,
  RELATIVE_BASE_OPTION
};

static _Bool verbose = 1;
...
{
  {"canonicalize-existing", 0, ((void*)0), 'e'},
  {"canonicalize-missing", 0, ((void*)0), 'm'},
  {"relative-to", 1, ((void*)0), RELATIVE_TO_OPTION},
  {"relative-base", 1, ((void*)0), RELATIVE_BASE_OPTION},
  {"quiet", 0, ((void*)0), 'q'},
  {"strip", 0, ((void*)0), 's'},
  {"no-symlinks", 0, ((void*)0), 's'},
  {"zero", 0, ((void*)0), 'z'},
  {"logical", 0, ((void*)0), 'L'},
  {"physical", 0, ((void*)0), 'P'},
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (gettext ("  -e, --canonicalize-existing  all components of the path must exist\n  -m, --canonicalize-missing   no path components need exist or be a directory\n  -L, --logical                resolve '..' components before symlinks\n  -P, --physical               resolve symlinks as encountered (default)\n  -q, --quiet                  suppress most error messages\n      --relative-to=DIR        print the resolved path relative to DIR\n      --relative-base=DIR      print absolute paths unless paths below DIR\n  -s, --strip, --no-symlinks   don't expand symlinks\n  -z, --zero                   end each output line with NUL, not newline\n\n"),stdout);
# 90 "realpath.c"
...
process_path (const char *fname, int can_mode)
{
  ...
  if (!can_fname)
    {
      if (verbose)
        error (0, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, fname));
      return 0;
    }

  if (!can_relative_to
      || (can_relative_base && !path_prefix (can_relative_base, can_fname))
      || (can_relative_to && !relpath (can_fname, can_relative_to, ((void*)0), 0)))
...
main (int argc, char **argv)
{
  ...
  const char *relative_to = ((void*)0);
  const char *relative_base = ((void*)0);
  ...
  while (1)
    {
      int c = getopt_long (argc, argv, "eLmPqsz", longopts, ((void*)0));
      if (c == -1)
        break;
      switch (c)
        {
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "realpath", "GNU coreutils", Version, ("Padraig Brady"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
        }
    }
  ...
  _Bool need_dir = (can_mode & (CAN_EXISTING | CAN_ALL_BUT_LAST | CAN_MISSING)) == CAN_EXISTING;
  if (relative_to)
    {
      can_relative_to = realpath_canon (relative_to, can_mode);
      if (!can_relative_to)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), ((0) ? (void) 0 : __builtin_unreachable ()))));
      if (need_dir && !isdir (can_relative_to))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 20, \"%s\", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 20, "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 20, "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, relative_to)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
  if (relative_base == relative_to)
