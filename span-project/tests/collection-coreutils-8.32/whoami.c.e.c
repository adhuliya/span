...
main (int argc, char **argv)
{
  ...
  if (!pw)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot find name for user ID %lu\"), (unsigned long int) uid), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot find name for user ID %lu"), (unsigned long int) uid), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot find name for user ID %lu"), (unsigned long int) uid), ((0) ? (void) 0 : __builtin_unreachable ()))));
