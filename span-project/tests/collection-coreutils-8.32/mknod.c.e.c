...
{
  mode_t newmode;
  char const *specified_mode = ((void*)0);
  int optc;
  size_t expected_operands;
  mode_t node_type;
  char const *scontext = ((void*)0);
  _Bool set_security_context = 0;
  ...
  while ((optc = getopt_long (argc, argv, "m:Z", longopts, ((void*)0))) != -1)
    {
      switch (optc)
        ...
        case GETOPT_VERSION_CHAR: version_etc (stdout, "mknod", "GNU coreutils", Version, ("David MacKenzie"), (char *) ((void*)0)); exit (0); break;;
        default:
          usage (1);
        }
    }

  newmode = (0400 | 0200 | (0400 >> 3) | (0200 >> 3) | ((0400 >> 3) >> 3) | ((0200 >> 3) >> 3));
  if (specified_mode)
    {
      mode_t umask_value;
      struct mode_change *change = mode_compile (specified_mode);
      if (!change)
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid mode\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid mode")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid mode")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      umask_value = umask (0);
      umask (umask_value);
      newmode = mode_adjust (newmode, 0, umask_value, change, ((void*)0));
      free (change);
      if (newmode & ~((0400|0200|0100) | ((0400|0200|0100) >> 3) | (((0400|0200|0100) >> 3) >> 3)))
        ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"mode must specify only file permission bits\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("mode must specify only file permission bits")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("mode must specify only file permission bits")), ((0) ? (void) 0 : __builtin_unreachable ()))));
  ...
  switch (argv[optind + 1][0])
    ...
    block_or_character:
      {
        ...
        if (xstrtoumax (s_major, ((void*)0), 0, &i_major, "") != LONGINT_OK
            || i_major != (unsigned int) i_major)
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid major device number %s\"), quote (s_major)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid major device number %s"), quote (s_major)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid major device number %s"), quote (s_major)), ((0) ? (void) 0 : __builtin_unreachable ()))));


        if (xstrtoumax (s_minor, ((void*)0), 0, &i_minor, "") != LONGINT_OK
            || i_minor != (unsigned int) i_minor)
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid minor device number %s\"), quote (s_minor)), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid minor device number %s"), quote (s_minor)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid minor device number %s"), quote (s_minor)), ((0) ? (void) 0 : __builtin_unreachable ()))));


        device = gnu_dev_makedev (i_major, i_minor);

        if (device == ((dev_t) -1))
          ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, 0, gettext (\"invalid device %s %s\"), s_major, s_minor), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, 0, gettext ("invalid device %s %s"), s_major, s_minor), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid device %s %s"), s_major, s_minor), ((0) ? (void) 0 : __builtin_unreachable ()))));
    ...
    case 'p':
      if (set_security_context)
        defaultcon (argv[optind], 0010000);
  ...
  if (specified_mode && lchmod (argv[optind], newmode) != 0)
    ((!!sizeof (struct { _Static_assert (1, "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"cannot set permissions of %s\"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), assume (false))" ")"); int _gl_dummy; })) ? ((error (1, (*__errno_location ()), gettext ("cannot set permissions of %s"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("cannot set permissions of %s"), quotearg_style (shell_escape_always_quoting_style, argv[optind])), ((0) ? (void) 0 : __builtin_unreachable ()))));
