...
#include <stdlib.h>
 ...
 void calculate_outputm15(int input) {
    ...
    if((((((a347 <=  -166 && ((98 == a381[4]) && ((a376 <=  121 && (45 == a234[3])) && (31 == a11[2])))) && a304 == 7) && a324 == a341[0]) && a232 == 33) && (((((64 < a78) && (257 >= a78)) &&  cf==1 ) && input == inputs[3]) && (85 == a42[5])))) {
    	a4 += (a4 + 20) > a4 ? 1 : 0;
    	a167 -= (a167 - 20) < a167 ? 4 : 0;
    	a111 += (a111 + 20) > a111 ? 2 : 0;
...
int main()
{
    ...
    while(1)
    {
        ...
        scanf("%d", &input);        
        // operate eca engine
        if((input != 2) && (input != 1) && (input != 4) && (input != 5) && (input != 3))
          return -2;
