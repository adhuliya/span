...
project_root_dir = os.path.join("/", "workspaces", "span");
...
if not os.path.exists(span_bin):
    lit_config.fatal(f"Tool not found: {span_bin}")

# Set up path to slang test directory
slang_test_dir_path = os.path.join(project_root_dir, 'slang', 'test')
