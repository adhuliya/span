...
const (
	...
	K_IK_IASGN_SELF   K_IK = 4
	K_IK_IASGN_SIMPLE K_IK = 5  // Simple assignment (no operator) -> x = y
	K_IK_IASGN_RHS_OP K_IK = 6  // RHS operator assignment -> x = y + z, ...
	K_IK_IASGN_LHS_OP K_IK = 7  // LHS operator assignment -> *x = y, x[i] = y, ...
	K_IK_IASGN_CALL   K_IK = 8  // Call assignment -> x = f(a, b, c)
	K_IK_IASGN_PHI    K_IK = 9  // Phi assignment. -> x = φ(a, b, c)
	K_IK_ICALL        K_IK = 10 // Call instruction
	K_IK_IGOTO        K_IK = 11 // Goto instruction
	K_IK_ICOND        K_IK = 12 // IF-THEN-ELSE instruction
	K_IK_ILABEL       K_IK = 13 // Label instruction (names a location in the code)
	K_IK_IRETURN      K_IK = 14 // Return instruction
)
...
const file_span_pkg_spir_spir_proto_rawDesc = "" +
	...
	"\aISELECT\x10\x03\x12\x0e\n" +
	"\n" +
	"IASGN_SELF\x10\x04\x12\x10\n" +
	"\fIASGN_SIMPLE\x10\x05\x12\x10\n" +
	"\fIASGN_RHS_OP\x10\x06\x12\x10\n" +
	"\fIASGN_LHS_OP\x10\a\x12\x0e\n" +
	"\n" +
	"IASGN_CALL\x10\b\x12\r\n" +
	"\tIASGN_PHI\x10\t\x12\t\n" +
	"\x05ICALL\x10\n" +
	"\x12\t\n" +
	"\x05IGOTO\x10\v\x12\t\n" +
