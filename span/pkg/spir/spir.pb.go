...
// Entity names are compound names.
// Simple names are names without any prefixes.
// Compound names are formed from simple names with prefixes separated by a colon (':').
// Some special prefixes are:
//   v: local variable
//   f: function
//   g: global variable
//   s: struct
//   u: union
// E.g. "v:main:x" represents the local variable "x" in the function "main".
// E.g. "f:main" represents the function "main".
// E.g. "g:arr" represents global variable "arr".
// E.g. "s:node" represents struct "node".
// E.g. "u:node" represents union "node".
...
const (
	...
	K_EK_ENIL             K_EK = 0  // It represents that the entity id is not present.
...
const (
	...
	K_IK_ISELECT   K_IK = 3 // Holds pointer to a list of instructions ('may' execute in parallel)
	K_IK_IUSE_KILL K_IK = 4 // Unconditional use of upto three entities
	K_IK_IUSE      K_IK = 5 // Unconditional use of upto three entities
	// IASGN_SELF: Self assignment (upto 3 variable sequences) (no operator) -> x = x, y = y, z = z
	// This instruction can also represent TOP value assignment (no operator) -> x = TOP
	// This instruction type is only generated by SPAN internally, not by the conversion tools like slang.
	K_IK_IASGN_SELF   K_IK = 6
	K_IK_IASGN_SIMPLE K_IK = 7  // Simple assignment (no operator) -> x = y
	K_IK_IASGN_RHS_OP K_IK = 8  // RHS operator assignment -> x = y + z, ...
	K_IK_IASGN_LHS_OP K_IK = 9  // LHS operator assignment -> *x = y, x[i] = y, ...
	K_IK_IASGN_CALL   K_IK = 10 // Call assignment -> x = f(a, b, c)
	K_IK_IASGN_PHI    K_IK = 11 // Phi assignment. -> x = φ(a, b, c)
	K_IK_ICALL        K_IK = 12 // Call instruction
	K_IK_IGOTO        K_IK = 13 // Goto instruction
	K_IK_ICOND        K_IK = 14 // IF-THEN-ELSE instruction
	K_IK_ILABEL       K_IK = 15 // Label instruction (names a location in the code)
	K_IK_IRETURN      K_IK = 16 // Return instruction
)
...
// BitDataType with typeId 0 (zero) is reserved for the INT32 type.
type BitDataType struct {
	...
	SubTypeEid *uint64 `protobuf:"varint,7,opt,name=subTypeEid,proto3,oneof" json:"subTypeEid,omitempty"` // Entity id of the subtype
	// Used to name the record or other special types
	TypeName      *string `protobuf:"bytes,8,opt,name=typeName,proto3,oneof" json:"typeName,omitempty"`             // Entity name of the type
...
func (x *BitDataType) GetSubTypeEid() uint64 {
	if x != nil && x.SubTypeEid != nil {
		return *x.SubTypeEid
	}
	return 0
}
...
func (x *BitDataType) GetFuncPrototype() bool {
	if x != nil && x.FuncPrototype != nil {
		return *x.FuncPrototype
	}
	return false
}
...
func (x *BitDataType) GetFopTypeEids() []uint64 {
	if x != nil {
		return x.FopTypeEids
	}
	return nil
}

func (x *BitDataType) GetLocLine() uint32 {
	if x != nil && x.LocLine != nil {
		return *x.LocLine
	}
	return 0
}

func (x *BitDataType) GetLocCol() uint32 {
	if x != nil && x.LocCol != nil {
		return *x.LocCol
	}
	return 0
}
...
func (x *BitEntityInfo) GetParentEid() uint64 {
	if x != nil && x.ParentEid != nil {
		return *x.ParentEid
	}
	return 0
}

func (x *BitEntityInfo) GetDataTypeEid() uint64 {
	if x != nil && x.DataTypeEid != nil {
		return *x.DataTypeEid
	}
	return 0
}
...
func (x *BitEntityInfo) GetLocLine() uint32 {
	if x != nil && x.LocLine != nil {
		return *x.LocLine
	}
	return 0
...
func (x *BitEntityInfo) GetLocCol() uint32 {
	if x != nil && x.LocCol != nil {
		return *x.LocCol
	}
	return 0
...
// BitSrcLoc is the source location of an entity.
// It may not be used during serialization, but it is useful to pass (line, col) together
// between functions. It is also kept here for future use.
...
// Not used directly in proto, but is useful during IR translation.
...
func (x *BitEntity) GetLine() uint32 {
	if x != nil {
		return x.Line
	}
	return 0
...
func (x *BitEntity) GetCol() uint32 {
	if x != nil {
		return x.Col
	}
	return 0
...
type BitExpr struct {
	...
	LocLine    *uint32                `protobuf:"varint,2,opt,name=loc_line,json=locLine,proto3,oneof" json:"loc_line,omitempty"` // Line number of the expression's operator in the source file
	LocCol     *uint32                `protobuf:"varint,3,opt,name=loc_col,json=locCol,proto3,oneof" json:"loc_col,omitempty"`    // Column number of the expression's operator in the source file
	Oprnd1Eid  *uint64                `protobuf:"varint,4,opt,name=oprnd1eid,proto3,oneof" json:"oprnd1eid,omitempty"`
	Oprnd1Line *uint32                `protobuf:"varint,5,opt,name=oprnd1_line,json=oprnd1Line,proto3,oneof" json:"oprnd1_line,omitempty"`
	Oprnd1Col  *uint32                `protobuf:"varint,6,opt,name=oprnd1_col,json=oprnd1Col,proto3,oneof" json:"oprnd1_col,omitempty"`
	Oprnd2Eid  *uint64                `protobuf:"varint,7,opt,name=oprnd2eid,proto3,oneof" json:"oprnd2eid,omitempty"`
	Oprnd2Line *uint32                `protobuf:"varint,8,opt,name=oprnd2_line,json=oprnd2Line,proto3,oneof" json:"oprnd2_line,omitempty"`
	Oprnd2Col  *uint32                `protobuf:"varint,9,opt,name=oprnd2_col,json=oprnd2Col,proto3,oneof" json:"oprnd2_col,omitempty"`
	// More expressions, e.g. call arguments, array subscript, etc.
	Oprnds        []uint64 `protobuf:"varint,10,rep,packed,name=oprnds,proto3" json:"oprnds,omitempty"`
	OprndsLine    []uint32 `protobuf:"varint,11,rep,packed,name=oprnds_line,json=oprndsLine,proto3" json:"oprnds_line,omitempty"`
	OprndsCol     []uint32 `protobuf:"varint,12,rep,packed,name=oprnds_col,json=oprndsCol,proto3" json:"oprnds_col,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BitExpr) GetLocLine() uint32 {
	if x != nil && x.LocLine != nil {
		return *x.LocLine
	}
	return 0
...
func (x *BitExpr) GetLocCol() uint32 {
	if x != nil && x.LocCol != nil {
		return *x.LocCol
	}
	return 0
...
func (x *BitExpr) GetOprnd1Eid() uint64 {
	if x != nil && x.Oprnd1Eid != nil {
		return *x.Oprnd1Eid
	}
	return 0
}

func (x *BitExpr) GetOprnd1Line() uint32 {
	if x != nil && x.Oprnd1Line != nil {
		return *x.Oprnd1Line
	}
	return 0
}

func (x *BitExpr) GetOprnd1Col() uint32 {
	if x != nil && x.Oprnd1Col != nil {
		return *x.Oprnd1Col
	}
	return 0
}

func (x *BitExpr) GetOprnd2Eid() uint64 {
	if x != nil && x.Oprnd2Eid != nil {
		return *x.Oprnd2Eid
	}
	return 0
}

func (x *BitExpr) GetOprnd2Line() uint32 {
	if x != nil && x.Oprnd2Line != nil {
		return *x.Oprnd2Line
	}
	return 0
}

func (x *BitExpr) GetOprnd2Col() uint32 {
	if x != nil && x.Oprnd2Col != nil {
		return *x.Oprnd2Col
	}
	return 0
}

func (x *BitExpr) GetOprnds() []uint64 {
	if x != nil {
		return x.Oprnds
	}
	return nil
...
func (x *BitExpr) GetOprndsLine() []uint32 {
	if x != nil {
		return x.OprndsLine
	}
	return nil
...
func (x *BitExpr) GetOprndsCol() []uint32 {
	if x != nil {
		return x.OprndsCol
	}
	return nil
...
type BitInsn struct {
	...
	LocLine       *uint32                `protobuf:"varint,4,opt,name=loc_line,json=locLine,proto3,oneof" json:"loc_line,omitempty"` // Line number of the instruction in the source file
	LocCol        *uint32                `protobuf:"varint,5,opt,name=loc_col,json=locCol,proto3,oneof" json:"loc_col,omitempty"`    // Column number of the instruction in the source file
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BitInsn) GetLocLine() uint32 {
	if x != nil && x.LocLine != nil {
		return *x.LocLine
	}
	return 0
...
func (x *BitInsn) GetLocCol() uint32 {
	if x != nil && x.LocCol != nil {
		return *x.LocCol
	}
	return 0
...
type BitTU struct {
	...
	Origin  *string                `protobuf:"bytes,3,opt,name=origin,proto3,oneof" json:"origin,omitempty"`   // Origin, e.g. "Clang AST", "SPAN IR (MEM)"
	// Information about the entities
	NamesToIds map[string]uint64         `protobuf:"bytes,4,rep,name=namesToIds,proto3" json:"namesToIds,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // entity name to entity id mapping
	DataTypes  map[uint64]*BitDataType   `protobuf:"bytes,5,rep,name=dataTypes,proto3" json:"dataTypes,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`   // Information about data types
	EntityInfo map[uint64]*BitEntityInfo `protobuf:"bytes,6,rep,name=entityInfo,proto3" json:"entityInfo,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Information about entities
	// Functions with definition
	Functions     []*BitFunc `protobuf:"bytes,7,rep,name=functions,proto3" json:"functions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BitTU) GetDataTypes() map[uint64]*BitDataType {
	if x != nil {
		return x.DataTypes
	}
	return nil
...
const file_span_pkg_spir_spir_proto_rawDesc = "" +
	...
	"\x03col\x18\x02 \x01(\rR\x03col\"C\n" +
	"\tBitEntity\x12\x10\n" +
	"\x03eid\x18\x01 \x01(\x04R\x03eid\x12\x12\n" +
	"\x04line\x18\x02 \x01(\rR\x04line\x12\x10\n" +
	"\x03col\x18\x03 \x01(\rR\x03col\"\x8e\x04\n" +
	"\aBitExpr\x12 \n" +
	"\x05xkind\x18\x01 \x01(\x0e2\n" +
	".spir.K_XKR\x05xkind\x12\x1e\n" +
	"\bloc_line\x18\x02 \x01(\rH\x00R\alocLine\x88\x01\x01\x12\x1c\n" +
	"\aloc_col\x18\x03 \x01(\rH\x01R\x06locCol\x88\x01\x01\x12!\n" +
	"\toprnd1eid\x18\x04 \x01(\x04H\x02R\toprnd1eid\x88\x01\x01\x12$\n" +
	"\voprnd1_line\x18\x05 \x01(\rH\x03R\n" +
	"oprnd1Line\x88\x01\x01\x12\"\n" +
	"\n" +
	"oprnd1_col\x18\x06 \x01(\rH\x04R\toprnd1Col\x88\x01\x01\x12!\n" +
	"\toprnd2eid\x18\a \x01(\x04H\x05R\toprnd2eid\x88\x01\x01\x12$\n" +
	"\voprnd2_line\x18\b \x01(\rH\x06R\n" +
	"oprnd2Line\x88\x01\x01\x12\"\n" +
	"\n" +
	"oprnd2_col\x18\t \x01(\rH\aR\toprnd2Col\x88\x01\x01\x12\x16\n" +
	"\x06oprnds\x18\n" +
	" \x03(\x04R\x06oprnds\x12\x1f\n" +
	"\voprnds_line\x18\v \x03(\rR\n" +
	"oprndsLine\x12\x1d\n" +
	"\n" +
	"oprnds_col\x18\f \x03(\rR\toprndsColB\v\n" +
	"\t_loc_lineB\n" +
	"\n" +
	"\b_loc_colB\f\n" +
	"\n" +
	...
	"_oprnd2eidB\x0e\n" +
	"\f_oprnd2_lineB\r\n" +
	"\v_oprnd2_col\"\xea\x01\n" +
	"\aBitInsn\x12 \n" +
	"\x05ikind\x18\x01 \x01(\x0e2\n" +
	".spir.K_IKR\x05ikind\x12(\n" +
	"\x05expr1\x18\x02 \x01(\v2\r.spir.BitExprH\x00R\x05expr1\x88\x01\x01\x12(\n" +
	"\x05expr2\x18\x03 \x01(\v2\r.spir.BitExprH\x01R\x05expr2\x88\x01\x01\x12\x1e\n" +
	"\bloc_line\x18\x04 \x01(\rH\x02R\alocLine\x88\x01\x01\x12\x1c\n" +
	"\aloc_col\x18\x05 \x01(\rH\x03R\x06locCol\x88\x01\x01B\b\n" +
	"\x06_expr1B\b\n" +
	"\x06_expr2B\v\n" +
	"\t_loc_lineB\n" +
	"\n" +
	...
	"namesToIds\x128\n" +
	"\tdataTypes\x18\x05 \x03(\v2\x1a.spir.BitTU.DataTypesEntryR\tdataTypes\x12;\n" +
	"\n" +
	"entityInfo\x18\x06 \x03(\v2\x1b.spir.BitTU.EntityInfoEntryR\n" +
	"entityInfo\x12+\n" +
	"\tfunctions\x18\a \x03(\v2\r.spir.BitFuncR\tfunctions\x1a=\n" +
	"\x0fNamesToIdsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value:\x028\x01\x1aO\n" +
	"\x0eDataTypesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x04R\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.spir.BitDataTypeR\x05value:\x028\x01\x1aR\n" +
	...
	"\x03ETU\x10\x16\x12\r\n" +
	"\tESRC_FILE\x10\x17*\xed\x01\n" +
	"\x04K_IK\x12\b\n" +
	"\x04INIL\x10\x00\x12\b\n" +
	"\x04INOP\x10\x01\x12\f\n" +
	"\bIBARRIER\x10\x02\x12\v\n" +
	"\aISELECT\x10\x03\x12\r\n" +
	"\tIUSE_KILL\x10\x04\x12\b\n" +
	"\x04IUSE\x10\x05\x12\x0e\n" +
	"\n" +
	"IASGN_SELF\x10\x06\x12\x10\n" +
	"\fIASGN_SIMPLE\x10\a\x12\x10\n" +
	"\fIASGN_RHS_OP\x10\b\x12\x10\n" +
	"\fIASGN_LHS_OP\x10\t\x12\x0e\n" +
	"\n" +
	"IASGN_CALL\x10\n" +
	"\x12\r\n" +
	"\tIASGN_PHI\x10\v\x12\t\n" +
	"\x05ICALL\x10\f\x12\t\n" +
	"\x05IGOTO\x10\r\x12\t\n" +
	"\x05ICOND\x10\x0e\x12\n" +
	"\n" +
	"\x06ILABEL\x10\x0f\x12\v\n" +
	"\aIRETURN\x10\x10*\x80\x03\n" +
	"\x04K_XK\x12\b\n" +
...
var file_span_pkg_spir_spir_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_span_pkg_spir_spir_proto_goTypes = []any{
	...
	(K_VK)(0),             // 3: spir.K_VK
	(K_QK)(0),             // 4: spir.K_QK
	(*BitDataType)(nil),   // 5: spir.BitDataType
	(*BitEntityInfo)(nil), // 6: spir.BitEntityInfo
	(*BitSrcLoc)(nil),     // 7: spir.BitSrcLoc
	...
	nil,                   // 14: spir.BitTU.DataTypesEntry
	nil,                   // 15: spir.BitTU.EntityInfoEntry
}
var file_span_pkg_spir_spir_proto_depIdxs = []int32{
	3,  // 0: spir.BitDataType.vkind:type_name -> spir.K_VK
	0,  // 1: spir.BitEntityInfo.ekind:type_name -> spir.K_EK
	3,  // 2: spir.BitEntityInfo.vkind:type_name -> spir.K_VK
	2,  // 3: spir.BitExpr.xkind:type_name -> spir.K_XK
	1,  // 4: spir.BitInsn.ikind:type_name -> spir.K_IK
	9,  // 5: spir.BitInsn.expr1:type_name -> spir.BitExpr
	9,  // 6: spir.BitInsn.expr2:type_name -> spir.BitExpr
	10, // 7: spir.BitFunc.insns:type_name -> spir.BitInsn
	13, // 8: spir.BitTU.namesToIds:type_name -> spir.BitTU.NamesToIdsEntry
	14, // 9: spir.BitTU.dataTypes:type_name -> spir.BitTU.DataTypesEntry
	15, // 10: spir.BitTU.entityInfo:type_name -> spir.BitTU.EntityInfoEntry
	11, // 11: spir.BitTU.functions:type_name -> spir.BitFunc
	5,  // 12: spir.BitTU.DataTypesEntry.value:type_name -> spir.BitDataType
	6,  // 13: spir.BitTU.EntityInfoEntry.value:type_name -> spir.BitEntityInfo
...
func file_span_pkg_spir_spir_proto_init() {
	...
	file_span_pkg_spir_spir_proto_msgTypes[0].OneofWrappers = []any{}
