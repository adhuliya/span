...
type BitEntityInfo struct {
	...
	Dt       *BitDataType `protobuf:"bytes,6,opt,name=dt,proto3,oneof" json:"dt,omitempty"` // Sufficient for non-basic types
	...
	HighVal       *uint64    `protobuf:"varint,8,opt,name=highVal,proto3,oneof" json:"highVal,omitempty"` // Used for >64 bit and <=128 bit numeric literals
